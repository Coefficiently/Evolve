            ...
            return (
              ...
              (f.prototype.doXHR = function (a, d, e, f) {
                ...
                "function" == typeof h.overrideMimeType &&
                  ...
                  h.setRequestHeader(
                    "Accept",
                    d || "text/x-less, text/css; q=0.9, */*; q=0.5"
                  ),
                  h.send(null),
                  ...
                  if (c.useFileCache && e[g])
                    try {
                      ...
                      return b({
                        filename: g,
                        message:
                          "Error loading file " + g + " error was " + f.message,
                      });
                    }
                  h.doXHR(
                    g,
      ...
      8: [
        function (a, b, c) {
          ...
          b.exports = function (b, c) {
            ...
            function h(a) {
              for (
                var b, d = l.getElementsByTagName("style"), e = 0;
                e < d.length;
                e++
              )
            ...
            function i(a, b, e, g, h) {
              function i(c) {
                ...
                if (
                  ...
                  if (!e && k)
                    return (h.local = !0), void b(null, k, d, a, h, f);
                }
                q.remove(f),
                  (j.rootFileInfo = i),
            ...
            a("./image-size")(m.environment),
              c.functions &&
                m.functions.functionRegistry.addMultiple(c.functions);
            var s = /^text\/(x-)?less$/;
            return (
              (m.watch = function () {
                return (
                  m.watchMode || ((m.env = "development"), k()),
                  (this.watchMode = !0),
                  !0
                );
              }),
          ...
          (f.prototype.evalPlugin = function (a, b, c, f, g) {
            ...
            if (m && (j = l.get(m))) {
              ...
              try {
                ...
                return (
                  (p.message = p.message || "Error during @plugin call"),
                  new e(p, c, m)
                );
              }
              return j;
            ...
            if (
              ...
              (j.filename = m),
              (!j.minVersion ||
                this.compareVersion("3.0.0", j.minVersion) < 0) &&
            ...
            (f.prototype.validatePlugin = function (a, b, c) {
              return a
                ? ("function" == typeof a && (a = new a()),
                  a.minVersion &&
                  this.compareVersion(a.minVersion, this.less.version) < 0
                    ? new e({
                        message:
                          "Plugin " +
                          c +
                          " requires version " +
                          this.versionToString(a.minVersion),
                      })
                    : a)
                : null;
            }),
            (f.prototype.compareVersion = function (a, b) {
              "string" == typeof a &&
                ((a = a.match(/^(\d+)\.?(\d+)?\.?(\d+)?/)), a.shift());
              for (var c = 0; c < a.length; c++)
                if (a[c] !== b[c])
                  return parseInt(a[c]) > parseInt(b[c]) ? -1 : 1;
              return 0;
            }),
        ...
        function (a, b, c) {
          ...
          function e(a, b) {
            ...
            if (c)
              return (
                (c.value =
                  a.value && /^(rgb|hsl)/.test(a.value) ? a.value : "rgb"),
                c
              );
          }
          function f(a) {
          ...
          (h = {
            ...
            rgba: function (a, b, c, d) {
              try {
                if (a instanceof j)
                  return (d = b ? f(b) : a.alpha), new j(a.rgb, d, "rgba");
            ...
            hsla: function (a, b, c, e) {
              ...
              try {
                if (a instanceof j)
                  return (e = b ? f(b) : a.alpha), new j(a.rgb, e, "hsla");
                var h, i;
                (a = (f(a) % 360) / 360),
                  (b = d(f(b))),
                  (c = d(f(c))),
            ...
            each: function (a, b) {
              ...
              for (var o = 0; o < g.length; o++) {
                var p,
                  ...
                  r = g[o];
                r instanceof f
                  ? ((p = "string" == typeof r.name ? r.name : r.name[0].value),
                    (q = r.value))
                  : ((p = new e(o + 1)), (q = r)),
                  r instanceof d ||
                    ((c = b.rules.slice(0)),
                    l &&
                      c.push(
                        new f(l, q, !1, !1, this.index, this.currentFileInfo)
                      ),
                    n &&
                      c.push(
                        new f(
                    ...
                    m &&
                      c.push(
                        new f(m, p, !1, !1, this.index, this.currentFileInfo)
                      ),
                    k.push(
                      new h(
                        [new i([new j("", "&")])],
            ...
            var d,
              ...
              k = function (a) {
                return function () {
                  ...
                  return (
                    a.apply(b, Array.prototype.slice.call(arguments, 0)), b
                  );
                };
              },
              l = Object.create(j);
        ...
        function (a, b, c) {
          var d = a("./utils"),
            e = (b.exports = function (a, b, c) {
              ...
              var e = a.filename || c;
              if (
                ((this.message = a.message), (this.stack = a.stack), b && e)
              ) {
                var f = b.contents[e],
          ...
          (e.prototype.constructor = e),
            (e.prototype.toString = function (a) {
              ...
              if (a.stylize) {
                ...
                if ("function" !== f)
                  throw Error(
                    "options.stylize should be a function, got a " + f + "!"
                  );
                e = a.stylize;
              }
              if (null !== this.line) {
                if (
                  ...
                  c[1] &&
                    (g +=
                      ...
                      e(
                        e(
                          e(c[1].substr(this.column, 1), "bold") +
                            c[1].slice(this.column + 1),
                          "red"
                        ),
                        "inverse"
                      )),
              ...
              return (
                ...
                this.callLine &&
                  ...
                  (b +=
                    e(this.callLine, "grey") + " " + this.callExtract + "/n")),
                b
              );
            });
        },
        ...
        function (a, b, c) {
          ...
          b.exports = function (b, c, j) {
            var k = function (b, c, l) {
              ...
              if (((c.pluginManager = p), (n = new e.Parse(c)), c.rootFileInfo))
                o = c.rootFileInfo;
              else {
            ...
            j = function k(a, b, c) {
              ...
              function m(a, b) {
                return q.$char(a)
                  ? a
                  : void j(
                      b || "expected '" + a + "' got '" + q.currentChar() + "'"
                    );
              }
              function n(a) {
                var b = c.filename;
                ...
                try {
                  ...
                  for (var k, l, m = 0; (k = c[m]); m++)
                    (l = j.i),
                      (h = p[k]()),
                      h
                        ? ((h._index = l + e), (h._fileInfo = f), i.push(h))
                        : i.push(null);
                  var n = j.end();
                  n.isFinished ? g(null, i) : g(!0, null);
                } catch (o) {
                  throw new d(
                    { index: o.index + e, message: o.message },
                    b,
                    f.filename
                  );
                }
              ...
              return {
                ...
                parse: function (g, h, j) {
                  ...
                  if (
                    ...
                    for (
                      var s = a.pluginManager.getPreProcessors(), t = 0;
                      t < s.length;
                      t++
                    )
                      g = s[t].process(g, {
                ...
                parsers: (p = {
                  ...
                  entities: {
                      ...
                      for (q.save(); ; ) {
                        if (a) a = !1;
                          ...
                          if (
                            ...
                            break;
                          c.value && 1 == c.value.length && (c = c.value[0]),
                            d.push(c);
                        }
                        q.$char(",") ||
                          ((q.$char(";") || b) &&
                    ...
                    variable: function () {
                      ...
                      if (
                        (q.save(),
                        "@" === q.currentChar() && (b = q.$re(/^@@?[\w-]+/)))
                      ) {
                        if (
                          ((a = q.currentChar()),
                          "(" === a ||
                            ("[" === a && !q.prevChar().match(/^\s/)))
                        ) {
                  ...
                  mixin: {
                    ...
                    args: function (a) {
                      ...
                      for (q.save(); ; ) {
                        ...
                        if (
                          (a
                            ? h.value && 1 == h.value.length && (s = h.value[0])
                            : (s = h),
                          s &&
                            (s instanceof e.Variable ||
                              s instanceof e.Property))
                        )
                          if (q.$char(":")) {
                            if (
                              (m.length > 0 &&
                      ...
                      if (
                        ...
                        if (
                          ...
                          if (
                            ...
                            q.$str("when") &&
                              (d = l(p.conditions, "expected condition")),
                            (c = p.block()))
                          )
                            return (
                              q.forget(), new e.mixin.Definition(a, f, c, d, g)
                            );
                          q.restore();
                        } else q.forget();
                    },
                  ...
                  selector: function (a) {
                    ...
                    for (
                      ...
                      (i
                        ...
                        ? (h = h ? h.concat(d) : d)
                        : (h &&
                            j("Extend can only be used at the end of selector"),
                          (f = q.currentChar()),
                          b ? b.push(g) : (b = [g]),
                          (g = null)),
                      "{" !== f &&
                  ...
                  block: function () {
                    var a;
                    if (q.$char("{") && (a = this.primary()) && q.$char("}"))
                      return a;
                  },
                  ...
                  detachedRuleset: function () {
                    ...
                    return d
                      ? (q.forget(),
                        b
                          ? new e.mixin.Definition(null, b, d, null, c)
                  ...
                  declaration: function () {
                    ...
                    if ("." !== j && "#" !== j && "&" !== j && ":" !== j)
                      if (
                        (q.save(), (a = this.variable() || this.ruleProperty()))
                      ) {
                        if (
                          ((h = "string" == typeof a),
                          ...
                          if (
                            ...
                            return (
                              q.forget(), new e.Declaration(a, b, !1, g, i, c)
                            );
                          b || (b = this.value()),
                            b
                              ? (f = this.important())
                              : h && (b = this.permissiveValue());
                        }
                        if (b && (this.end() || d))
                          return (
                            q.forget(), new e.Declaration(a, b, f, g, i, c)
                          );
                        q.restore();
                      } else q.restore();
                  },
                  ...
                  permissiveValue: function (a) {
                    ...
                    if (!b()) {
                      ...
                      do
                        (f = this.comment()),
                          f ? h.push(f) : ((f = this.entity()), f && h.push(f));
                      while (f);
                      if (((g = b()), h.length > 0)) {
                        if (((h = new e.Expression(h)), g)) return h;
                        l.push(h),
                          " " === q.prevChar() &&
                            l.push(new e.Anonymous(" ", k));
                      }
                  ...
                  plugin: function () {
                    ...
                    if (g) {
                      if (
                        ((b = this.pluginArgs()),
                        (d = b
                          ? { pluginArgs: b, isPlugin: !0 }
                          : { isPlugin: !0 }),
                        (a = this.entities.quoted() || this.entities.url()))
                      )
                        return (
                          q.$char(";") ||
                            ((q.i = f), j("missing semi-colon on @plugin")),
                    ...
                    if ("@" === q.currentChar()) {
                      ...
                      if ((q.save(), (b = q.$re(/^@[a-z-]+/)))) {
                        ...
                        return (
                          ...
                          h
                            ? ((d = this.entity()),
                              d || j("expected " + b + " identifier"))
                            : i
                            ? ((d = this.expression()),
                              d || j("expected " + b + " expression"))
                            : k &&
                  ...
                  conditionAnd: function (a) {
                    function b() {
                      var b =
                        h.negatedCondition(a) || h.parenthesisCondition(a);
              ...
              this.installedPlugins.push(a),
                ...
                a.install &&
                  a.install(
                    this.less,
                    this,
                    c || this.less.functions.functionRegistry
                  );
            }),
          ...
          (e.prototype = new d()),
            ...
            (e.prototype.genCSS = function (a, b) {
              (this.nodeVisible = Boolean(this.value)),
                this.nodeVisible &&
                  b.add(this.value, this._fileInfo, this._index, this.mapLines);
            }),
            (b.exports = e);
        },
        { "./node": 76 },
        ...
        function (a, b, c) {
          var d = a("./node"),
            ...
            h = function (a, b, c, f, h, i, j, k) {
              ...
              if (
                ((this.name = a),
                (this.value = b instanceof d ? b : b ? new g(b) : b),
                c)
              ) {
                for (
                  Array.isArray(c)
        ...
        function (a, b, c) {
          ...
          (f.prototype = new d()),
            ...
            (f.prototype.genCSS = function (a, b) {
              this.debugInfo &&
                b.add(e(a, this), this.fileInfo(), this.getIndex()),
                b.add(this.value);
            }),
        ...
        function (a, b, c) {
          ...
          var e = a("./node"),
            ...
            j = function (a, b, c, d, g, i, j, k) {
              (this.name = a),
                (this.value =
                  b instanceof e ? b : new f([b ? new h(b) : null])),
                ...
                (this.inline = j || !1),
                (this.variable =
                  void 0 !== k ? k : a.charAt && "@" === a.charAt(0)),
                (this.allowRoot = !0),
          ...
          (j.prototype = new e()),
            ...
            (j.prototype.eval = function (a) {
              ...
              "string" != typeof f &&
                ((f =
                  1 === f.length && f[0] instanceof g ? f[0].value : d(a, f)),
                (h = !1)),
                "font" === f &&
                  a.math === i.ALWAYS &&
          ...
          (i.prototype = new d()),
            ...
            (i.prototype.eval = function (a) {
              var b,
                ...
                d =
                  this.parens &&
                  (a.math !== h.STRICT_LEGACY || !this.parensInOp),
                f = !1;
              return (
                d && a.inParenthesis(),
                this.value.length > 1
              ...
              if (this.options.isPlugin) {
                if (this.root && this.root.eval)
                  try {
                    ...
                    throw (
                      ((f.message = "Plugin error during evaluation"),
          ...
          (f.prototype = new d()),
            (f.prototype.evaluateJavaScript = function (a, b) {
              ...
              a = a.replace(/@\{([\w-]+)\}/g, function (a, c) {
                return d.jsify(
                  new e("@" + c, d.getIndex(), d.fileInfo()).eval(b)
                );
              });
              try {
          ...
          var d = a("./selector"),
            ...
            l = function (a, b, c, f, g, h, i) {
              (this.name = a || "anonymous mixin"),
                (this.selectors = [
                  new d([new e(null, a, !1, this._index, this._fileInfo)]),
                ]),
                (this.params = b),
                (this.condition = f),
                (this.variadic = g),
          ...
          (h.prototype = new d()),
            ...
            (h.prototype.eval = function (a) {
              ...
              for (b = 0; b < this.lookups.length; b++) {
                if (
                  ((c = this.lookups[b]),
                  Array.isArray(d) && (d = new f([new g()], d)),
                  "" === c)
                )
                  d = d.lastDeclaration();
                else if ("@" === c.charAt(0)) {
                  if (
                    ("@" === c.charAt(1) &&
                      (c = "@" + new e(c.substr(1)).eval(a).value),
          ...
          (f.prototype = new d()),
            ...
            (f.prototype.eval = function (a) {
              var b,
                c = this.name,
                d =
                  a.pluginManager.less.visitors.ToCSSVisitor.prototype
                    ._mergeRules;
              if (this.evaluating)
                throw {
                  type: "Name",
      ...
      80: [
        function (a, b, c) {
          ...
          (g.prototype = new d()),
            ...
            (g.prototype.genCSS = function (a, b) {
              this.escaped ||
                b.add(this.quote, this.fileInfo(), this.getIndex()),
                b.add(this.value),
            ...
            (g.prototype.eval = function (a) {
              ...
              var c = this,
                d = this.value,
                h = function (b, d) {
                  var f = new e("@" + d, c.getIndex(), c.fileInfo()).eval(
                    a,
                    !0
                  );
                ...
                i = function (b, d) {
                  var e = new f("$" + d, c.getIndex(), c.fileInfo()).eval(
                    a,
                    !0
                  );
          ...
          (q.prototype = new d()),
            ...
            (q.prototype.eval = function (a) {
              ...
              u || (a.selectors = u = []),
                ...
                (s.root || s.allowImports || !s.strictImports) &&
                  s.evalImports(a);
              var v = s.rules;
              ...
              for (g = 0; (l = v[g]); g++)
                "MixinCall" === l.type
                  ? ((r = l.eval(a).filter(function (a) {
                      return (
                        !(a instanceof e && a.variable) || !s.variable(a.name)
                      );
                    })),
                  ...
                  : "VariableCall" === l.type &&
                    ...
                    s.resetCache());
              for (g = 0; (l = v[g]); g++)
                l.evalFirst || (v[g] = l = l.eval ? l.eval(a) : l);
              for (g = 0; (l = v[g]); g++)
                if (
                  l instanceof q &&
                  l.selectors &&
            ...
            (q.prototype.matchCondition = function (a, b) {
              ...
              return (
                !!c.evaldCondition &&
                !(c.condition && !c.condition.eval(new l.Eval(b, b.frames)))
              );
            }),
                  ...
                  (this._variables = this.rules
                    ? this.rules.reduce(function (a, b) {
                        if (
                          ...
                          for (var d in c)
                            c.hasOwnProperty(d) && (a[d] = b.root.variable(d));
                        }
                        return a;
                      }, {})
                    : {}),
            ...
            (q.prototype.joinSelector = function (a, b, c) {
              ...
              function e(a, b) {
                var c, d;
                return (
                  (c = new j(null, a, b.isVariable, b._index, b._fileInfo)),
                  (d = new i([c]))
                );
              }
              function f(a, b, c, d) {
                ...
                if (
                  ...
                  h.emptyOrWhitespace &&
                    ...
                    (h = i.combinator),
                    g.elements.push(
                      new j(h, i.value, c.isVariable, c._index, c._fileInfo)
                    ),
          ...
          (g.prototype = new d()),
            ...
            (g.prototype.match = function (a) {
              var b,
                ...
                d = this.elements,
                e = d.length;
              if (((a = a.mixinElements()), (b = a.length), 0 === b || e < b))
                return 0;
      ...
      87: [
        function (a, b, c) {
          ...
          (i.prototype = new d()),
            ...
            (i.prototype.eval = function (a) {
              var b,
                c = new e(this.variable, this.getIndex(), this.fileInfo()).eval(
                  a
                ),
                d = new h({
            ...
            (f.prototype.eval = function (a) {
              ...
              if (
                (0 === c.indexOf("@@") &&
                  (c =
                    "@" +
                    new f(c.slice(1), this.getIndex(), this.fileInfo()).eval(a)
                      .value),
                this.evaluating)
              )
                throw {
              ...
              if (!a.root) {
                ...
                for (c = 0; c < k; c++)
                  a.rules[c] instanceof d.Extend &&
                    (i.push(j[c]), (a.extendOnEveryPath = !0));
                var l = a.paths;
            ...
            extendSelector: function (a, b, c, e) {
              ...
              for (f = 0; f < a.length; f++)
                (i = a[f]),
                  ...
                  k === i.pathIndex && f > 0
                    ? (m[m.length - 1].elements =
                        m[m.length - 1].elements.concat(j))
        ...
        function (a, b, c) {
          ...
          (i.prototype = {
            visit: function (a) {
              ...
              var b = a.typeIndex;
              if (!b)
                return a.value && a.value.typeIndex && this.visit(a.value), a;
              var c,
              ...
              return (
                i.visitDeeper && a && a.accept && a.accept(this),
                h != d && h.call(e, a),
                a
              );
            },
              ...
              function l(c, e) {
                ...
                if (a(c, h)) p = new h();
                  ...
                  (p = new RegExp(c.source, g(c))),
                    c.lastIndex && (p.lastIndex = c.lastIndex);
                ...
                if (Object.getOwnPropertySymbols)
                  for (
                    var u = Object.getOwnPropertySymbols(c), s = 0;
                    s < u.length;
                    s++
                  ) {
                    var v = u[s],
                    ...
                    (!w || w.enumerable || i) &&
                      ((p[v] = l(c[v], e - 1)),
                      w.enumerable ||
                        Object.defineProperty(p, v, { enumerable: !1 }));
                  }
                if (i)
                  for (
                    var x = Object.getOwnPropertyNames(c), s = 0;
                    s < x.length;
                    s++
                  ) {
                    var y = x[s],
                    ...
                    (w && w.enumerable) ||
                      ((p[y] = l(c[y], e - 1)),
                      Object.defineProperty(p, y, { enumerable: !1 }));
                  }
                return p;
              }
              "object" == typeof d &&
