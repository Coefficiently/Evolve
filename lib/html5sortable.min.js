var sortable = (function () {
  ...
  var d = function (e, t) {
    ...
    p = function (e) {
      ...
      return u.has(e) || u.set(e, new t()), u.get(e);
    };
  function a(e, t, n) {
    if (e instanceof Array) for (var r = 0; r < e.length; ++r) a(e[r], t, n);
    else e.addEventListener(t, n), p(e).setData("event" + t, n);
  }
  function i(e, t) {
    if (e instanceof Array) for (var n = 0; n < e.length; ++n) i(e[n], t);
    else
      e.removeEventListener(t, p(e).getData("event" + t)),
        p(e).deleteData("event" + t);
  }
  function l(e, t, n) {
  ...
  var m = function (e) {
    ...
    o = function (t, n, e) {
      ...
      var r = c(t, "opts").items,
        o = d(t.children, r),
        i = o.map(function (e) {
          return { parent: t, node: e, html: e.outerHTML, index: g(e, o) };
        });
      return {
        container: e({ node: t, itemCount: i.length }),
    ...
    L = function (e, t, n) {
      ...
      if ((n || (n = f), e.dataTransfer && e.dataTransfer.setDragImage)) {
        var r = n(t, m(t), e);
        if (
        ...
        (e.dataTransfer.effectAllowed = "copyMove"),
          e.dataTransfer.setData("text/plain", T(e).id),
          e.dataTransfer.setDragImage(r.element, r.posX, r.posY);
      }
    },
    C = function (e, t) {
      if (!0 === e.isSortable) {
        var n = p(e).getConfig("acceptFrom");
        ...
        if (e === t) return !0;
        if (
          void 0 !== p(e).getConfig("connectWith") &&
          null !== p(e).getConfig("connectWith")
        )
          return (
            p(e).getConfig("connectWith") === p(t).getConfig("connectWith")
          );
      }
      return !1;
    },
  ...
  var D,
    ...
    Y,
    O = function (e, t) {
      if ("string" == typeof p(e).getConfig("hoverClass")) {
        var o = p(e).getConfig("hoverClass").split(" ");
        !0 === t
          ? (a(
              e,
              "mousemove",
              (function (r, o) {
                ...
                return function () {
                  for (var e = [], t = 0; t < arguments.length; t++)
                    e[t] = arguments[t];
                  var n = Date.now();
                  (null === a || o <= n - a) && ((a = n), r.apply(i, e));
                };
              })(function (r) {
                0 === r.buttons &&
                  d(e.children, p(e).getConfig("items")).forEach(function (e) {
                    var t, n;
                    e !== r.target
                      ? (t = e.classList).remove.apply(t, o)
                      : (n = e.classList).add.apply(n, o);
                  });
              }, p(e).getConfig("throttleTime"))
            ),
            a(e, "mouseleave", function () {
              d(e.children, p(e).getConfig("items")).forEach(function (e) {
                var t;
                (t = e.classList).remove.apply(t, o);
              });
  ...
  function q(e, t) {
    var n = c(e, "opts"),
      r = d(e.children, n.items).filter(function (e) {
    ...
    return (
      ...
      /serialize/.test(i)
        ...
        : (e.forEach(function (s) {
            if (/enable|disable|destroy/.test(i)) return X[i](s);
            ["connectWith", "disableIEFix"].forEach(function (e) {
              ...
              (f = Object.assign({}, M, p(s).config, f)),
              (p(s).config = f),
              c(s, "opts", f),
              (s.isSortable = !0),
              R(s);
            var e,
              t = d(s.children, f.items);
            if (null !== f.placeholder && void 0 !== f.placeholder) {
              var n = document.createElement(s.tagName);
              f.placeholder instanceof HTMLElement
                ? n.appendChild(f.placeholder)
                : (n.innerHTML = f.placeholder),
                (e = n.children[0]);
            }
            (p(s).placeholder = w(s, e, f.placeholderClass)),
              c(s, "items", f.items),
              f.acceptFrom
                ? c(s, "acceptFrom", f.acceptFrom)
                : f.connectWith && c(s, "connectWith", f.connectWith),
              z(s),
              l(t, "role", "option"),
              l(t, "aria-grabbed", "false"),
              O(s, !0),
              a(s, "dragstart", function (e) {
                var t = T(e);
                if (
                  !0 !== t.isSortable &&
                  (e.stopImmediatePropagation(),
                  (!f.handle || t.matches(f.handle)) &&
                    "false" !== t.getAttribute("draggable"))
                ) {
                  var n = j(t, e),
                    r = q(n, t);
                  (S = d(n.children, f.items)),
                    (A = S.indexOf(r)),
                    (I = g(r, n.children)),
                    (H = n),
                    L(e, r, f.customDragImage),
                    (x = b(r)),
                    r.classList.add(f.draggingClass),
                    l((D = W(r, n)), "aria-grabbed", "true"),
                    n.dispatchEvent(
                      new CustomEvent("sortstart", {
                        detail: {
                          origin: { elementIndex: I, index: A, container: H },
                          item: D,
                          originalTarget: t,
                        },
                      })
              ...
              a(s, "dragenter", function (e) {
                var t = T(e),
                  n = j(t, e);
                n &&
                  n !== _ &&
                  ((Y = d(n.children, c(n, "items")).filter(function (e) {
                    return e !== p(s).placeholder;
                  })),
                  n.dispatchEvent(
                    new CustomEvent("sortenter", {
                      detail: {
                        origin: { elementIndex: I, index: A, container: H },
                        destination: { container: n, itemsBeforeUpdate: Y },
                        item: D,
                        originalTarget: t,
                      },
                    })
              ...
              a(s, "dragend", function (e) {
                if (D) {
                  D.classList.remove(f.draggingClass),
                    l(D, "aria-grabbed", "false"),
                    "true" === D.getAttribute("aria-copied") &&
                      "true" !== c(D, "dropped") &&
                      D.remove(),
                    (D.style.display = D.oldDisplay),
                    delete D.oldDisplay;
              ...
              a(s, "drop", function (e) {
                if (C(s, D.parentElement)) {
                  ...
                  var n = p(s).placeholder,
                    r = d(H.children, f.items).filter(function (e) {
                      return e !== n;
                    }),
                    o = !0 === this.isSortable ? this : this.parentElement,
                    i = d(o.children, c(o, "items")).filter(function (e) {
                      return e !== n;
                    }),
                    a = g(
                      D,
                      Array.from(D.parentElement.children).filter(function (e) {
                        return e !== n;
                      })
                    ),
                    l = g(D, i);
            ...
            var o = h(function (t, e, n) {
                if (D)
                  if (
                    (f.forcePlaceholderSize &&
                      (p(t).placeholder.style.height = x + "px"),
                    -1 < Array.from(t.children).indexOf(e))
                  ) {
                    var r = b(e),
                      o = g(p(t).placeholder, e.parentElement.children),
                      i = g(e, e.parentElement.children);
                    if (x < r) {
                      var a = r - x,
                        l = m(e).top;
                      if (o < i && n < l) return;
                      if (i < o && l + r - a < n) return;
                    }
                    void 0 === D.oldDisplay && (D.oldDisplay = D.style.display),
                      "none" !== D.style.display && (D.style.display = "none");
                    var s = !1;
                    try {
                      s = m(e).top + e.offsetHeight / 2 <= n;
                    } catch (e) {
                      s = o < i;
                    }
                    s ? E(e, p(t).placeholder) : y(e, p(t).placeholder),
                      Array.from(u.values())
                        .filter(function (e) {
                          return void 0 !== e.placeholder;
                        })
                        .forEach(function (e) {
                          e.placeholder !== p(t).placeholder &&
                            e.placeholder.remove();
                        });
                  } else {
                    var c = Array.from(u.values())
                      .filter(function (e) {
                        return void 0 !== e.placeholder;
                      })
                      .map(function (e) {
                    ...
                    -1 !== c.indexOf(e) ||
                      t !== e ||
                      d(e.children, f.items).length ||
                      (c.forEach(function (e) {
                        return e.remove();
                      }),
                      e.appendChild(p(t).placeholder));
                  }
              }, f.debounce),
              r = function (e) {
                var t = e.target,
                  n = !0 === t.isSortable ? t : j(t, e);
                if (
                  ((t = q(n, t)),
                  D && C(n, D.parentElement) && "true" !== c(n, "_disabled"))
                ) {
                  var r = c(n, "opts");
                  (parseInt(r.maxItems) &&
                    d(n.children, c(n, "items")).length >=
                      parseInt(r.maxItems) &&
                    D.parentElement !== n) ||
                    (e.preventDefault(),
                    e.stopPropagation(),
                    (e.dataTransfer.dropEffect =
                      !0 === p(n).getConfig("copy") ? "copy" : "move"),
                    o(n, t, e.pageY));
                }
              };
            a(t.concat(s), "dragover", r), a(t.concat(s), "dragenter", r);
          }),
          e)
    );
  }
