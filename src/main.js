...
popover(
  ...
  function (obj) {
    if (global.city.morale.unemployed !== 0) {
      ...
      obj.popper.append(
        `<p class="modal_bd"><span>${loc(
          global.race["playful"] ? "morale_hunter" : "morale_unemployed"
        )}</span> <span class="has-text-${type}"> ${+global.city.morale.unemployed.toFixed(
          1
        )}%</span></p>`
      );
    }
    if (global.city.morale.stress !== 0) {
      ...
      obj.popper.append(
        `<p class="modal_bd"><span>${loc(
          "morale_stress"
        )}</span> <span class="has-text-${type}"> ${+global.city.morale.stress.toFixed(
          1
        )}%</span></p>`
      );
    }
    ...
    Object.keys(global.city.morale).forEach(function (morale) {
      if (
        ...
        obj.popper.append(
          `<p class="modal_bd"><span>${loc(
            `morale_${morale}`
          )}</span> <span class="has-text-${type}"> ${+value.toFixed(
            1
          )}%</span></p>`
        );
        ...
        if (
          ...
          obj.popper.append(
            `<p class="modal_bd"><span>ᄂ${loc(
              "govern_democracy"
            )}</span> <span class="has-text-success"> +${democracy}%</span></p>`
          );
        }
      }
    });
    ...
    if (global.city.morale.season !== 0) {
      ...
      obj.popper.append(
        `<p class="modal_bd"><span>${season}</span> <span class="has-text-${type}"> ${+global.city.morale.season.toFixed(
          1
        )}%</span></p>`
      );
    }
    ...
    if (global.civic.govern.type === "corpocracy") {
      ...
      obj.popper.append(
        `<p class="modal_bd"><span>${loc(
          "govern_corpocracy"
        )}</span> <span class="has-text-danger"> -${penalty}%</span></p>`
      );
    }
    if (global.civic.govern.type === "republic") {
      ...
      obj.popper.append(
        `<p class="modal_bd"><span>${loc(
          "govern_republic"
        )}</span> <span class="has-text-success"> ${repub}%</span></p>`
      );
    }
    if (global.civic.govern.type === "federation") {
      ...
      obj.popper.append(
        `<p class="modal_bd"><span>${loc(
          "govern_federation"
        )}</span> <span class="has-text-success"> ${fed}%</span></p>`
      );
    }
    ...
    if (milVal) {
      ...
      obj.popper.append(
        `<p class="modal_bd"><span>${loc(
          "gov_trait_militant"
        )}</span> <span class="has-text-danger"> -${milVal}%</span></p>`
      );
    }
    ...
    if (global.race["cheese"]) {
      ...
      total += cheese;
      obj.popper.append(
        `<p class="modal_bd"><span>${swissKnife(
          true,
          false
        )}</span> <span class="has-text-success"> ${cheese}%</span></p>`
      );
    }
    ...
    if (global.race["motivated"]) {
      ...
      obj.popper.append(
        `<p class="modal_bd"><span>${loc(
          `event_motivation_bd`
        )}</span> <span class="has-text-success"> ${boost}%</span></p>`
      );
    }
    ...
    if (global.race["pet"]) {
      ...
      obj.popper.append(
        `<p class="modal_bd"><span>${loc(
          `event_pet_${global.race.pet.type}_owner`
        )}</span> <span class="has-text-success"> ${1}%</span></p>`
      );
    }
    ...
    if (global.race["wishStats"] && global.race.wishStats.fame !== 0) {
      ...
      if (global.race.wishStats.fame > 0) {
        obj.popper.append(
          `<p class="modal_bd"><span>${loc(
            `wish_reputable`
          )}</span> <span class="has-text-success"> ${
            global.race.wishStats.fame
          }%</span></p>`
        );
      } else {
        obj.popper.append(
    ...
    if (global.civic["homeless"]) {
      ...
      obj.popper.append(
        `<p class="modal_bd"><span>${loc(
          `homeless`
        )}</span> <span class="has-text-danger"> -${homeless}%</span></p>`
      );
    }
    ...
    if (global.tech["vax_c"] || global.tech["vax_f"]) {
      ...
      obj.popper.append(
        `<p class="modal_bd"><span>${loc(
          global.tech["vax_c"] ? `tech_vax_strat4_bd` : `tech_vax_strat2_bd`
        )}</span> <span class="has-text-danger"> -${drop}%</span></p>`
      );
      ...
      obj.popper.append(
        `<p class="modal_bd"><span>${loc(
          `tech_vax_strat3_bd`
        )}</span> <span class="has-text-success"> ${gain}%</span></p>`
      );
    }
    ...
    if (global.city["tormented"]) {
      ...
      obj.popper.append(
        `<p class="modal_bd"><span>${loc(
          `trait_tormented_name`
        )}</span> <span class="has-text-danger"> -${
          global.city.tormented
        }%</span></p>`
      );
    }
    ...
    if (
      ...
      obj.popper.append(
        `<p class="modal_bd"><span>${loc(
          `wish_bad`
        )}</span> <span class="has-text-danger"> -${badPress * 5}%</span></p>`
      );
    }
    ...
    container.append(
      `<div class="modal_bd sum"><span>${loc(
        "morale_total"
      )}</span> <span class="has-text-warning"> ${+total.toFixed(
        1
      )}%</span></div>`
    );
    container.append(
      `<div class="modal_bd"><span>${loc(
        "morale_max"
      )}</span> <span class="has-text-${
        total > moraleCap ? "caution" : "warning"
      }"> ${+moraleCap.toFixed(1)}%</span></div>`
    );
    container.append(
      `<div class="modal_bd"><span>${loc(
        "morale_current"
      )}</span> <span class="has-text-warning"> ${+global.city.morale.current.toFixed(
        1
      )}%</span></div>`
    );
  ...
  function (obj) {
    ...
    Object.keys(power_generated).forEach(function (k) {
      if (power_generated[k]) {
        ...
        obj.popper.append(
          `<p class="modal_bd"><span>${k}</span> <span class="has-text-success">+${+gen.toFixed(
            2
          )}</span></p>`
        );
      }
    ...
    obj.popper.append(
      `<p class="modal_bd"><span>${loc(
        "power_consumed"
      )}</span> <span class="has-text-danger"> -${drain}</span></p>`
    );
    let avail = +global.city.power.toFixed(2);
    if (global.city.power > 0) {
      obj.popper.append(
        `<p class="modal_bd sum"><span>${loc(
          "power_available"
        )}</span> <span class="has-text-success">${avail}</span></p>`
      );
    } else {
      obj.popper.append(
        `<p class="modal_bd sum"><span>${loc(
          "power_available"
        )}</span> <span class="has-text-danger">${avail}</span></p>`
      );
    }
  },
  {
  ...
  function (obj) {
    if (global.race.species === "protoplasm") {
      ...
      if (global.race["junker"]) {
        challenges =
          challenges +
          `<div>${loc("evo_challenge_junker_desc")} ${loc(
            "evo_challenge_junker_conditions"
          )}</div>`;
      }
      if (global.race["joyless"]) {
        challenges =
          challenges +
          `<div>${loc("evo_challenge_joyless_desc")} ${loc(
            "evo_challenge_joyless_conditions"
          )}</div>`;
      }
      if (global.race["steelen"]) {
        challenges =
          challenges +
          `<div>${loc("evo_challenge_steelen_desc")} ${loc(
            "evo_challenge_steelen_conditions"
          )}</div>`;
      }
      if (global.race["decay"]) {
        challenges =
          challenges +
          `<div>${loc("evo_challenge_decay_desc")} ${loc(
            "evo_challenge_decay_conditions"
          )}</div>`;
      }
      if (global.race["emfield"]) {
        challenges =
          challenges +
          `<div>${loc("evo_challenge_emfield_desc")} ${loc(
            "evo_challenge_emfield_conditions"
          )}</div>`;
      }
      if (global.race["inflation"]) {
        challenges =
          challenges +
          `<div>${loc("evo_challenge_inflation_desc")} ${loc(
            "evo_challenge_inflation_conditions"
          )}</div>`;
      }
      if (global.race["banana"]) {
        challenges =
          challenges +
          `<div>${loc("evo_challenge_banana_desc")} ${loc(
            "wiki_achieve_banana1"
          )}. ${loc("wiki_achieve_banana2")}. ${loc(
            "wiki_achieve_banana3"
          )}. ${loc("wiki_achieve_banana4", [500])}. ${loc(
            "wiki_achieve_banana5",
            [50]
          )}.</div>`;
      }
      ...
      if (global.race["sludge"]) {
        challenges =
          challenges +
          `<div>${loc("evo_challenge_sludge_desc")} ${loc(
            "evo_challenge_sludge_conditions"
          )}</div>`;
      }
      if (global.race["ultra_sludge"]) {
        challenges =
          challenges +
          `<div>${loc("evo_challenge_ultra_sludge_desc")} ${loc(
            "evo_challenge_ultra_sludge_conditions"
          )}</div>`;
      }
      if (global.race["orbit_decay"]) {
        ...
        challenges =
          challenges +
          `<div>${state} ${loc(
            "evo_challenge_orbit_decay_conditions"
          )} ${impact}</div>`;
      ...
      obj.popper.append(
        $(
          `<div>${loc(global.race["cataclysm"] ? "no_home" : "home", [
            planet,
            race,
            planet_label,
            orbit,
          ])}</div>${geo_traits}${challenges}`
        )
      );
    }
    return undefined;
...
function fastLoop() {
  ...
  if (global.race["no_plasmid"] || global.race.universe === "antimatter") {
    if (
      ((global.race["cataclysm"] || global.race["orbit_decayed"]) &&
        ...
        templeCount(true)) ||
      (global.city["temple"] && global.city["temple"].count)
    ) {
  ...
  if (
    ...
    let chaos =
      (global.resource[global.race.species].amount - (jobScale(10) - 1)) *
  ...
  if (
    ...
    breakdown.p["Global"][loc("unsuited")] = `-${Math.round(
      (1 - unsuited) * 100
    )}%`;
  ...
  if (global.race.species === "protoplasm") {
        ...
        if (global.resource[res].trade > 0) {
          ...
          if (global.resource.Money.amount >= price * time_multiplier) {
            ...
            breakdown.p.consume[res][loc("trade")] =
              global.resource[res].trade * rate;
          }
          steelCheck();
    ...
    if (
      ...
      let power =
        powerModifier(
          20 +
            (r_mass - 8) * waves +
            global.interstellar.stellar_engine.exotic * waves * 10
        ) * gWell;
      if (power > 10000) {
        power = 10000 + (power - 10000) ** 0.975;
        if (power > 20000) {
          power = 20000 + (power - 20000) ** 0.95;
        }
        if (power > 30000) {
          power = 30000 + (power - 30000) ** 0.925;
        }
      }
      max_power -= power;
      power_grid += power;
    ...
    if (
      ...
      let coal =
        p_on["coal_power"] * 0.35 * production("psychic_boost", "Uranium");
      breakdown.p["Uranium"][loc("city_coal_ash")] =
        coal / 65 / global_multiplier;
    ...
    if (global.tech["broadcast"]) {
      ...
      let signalVal = global.race["orbit_decayed"]
        ? p_on["nav_beacon"] || 0
        : global.tech["isolation"] && global.race["truepath"]
        ? support_on["colony"]
        : p_on["wardenclyffe"];
      ...
      let mVal = gasVal
        ? gasVal + global.tech.broadcast
        : global.tech.broadcast;
    ...
    if (global.city.morale.current < 100) {
      ...
      breakdown.p["Global"][loc("morale")] =
        (global.city.morale.current - 100) / 2 + "%";
    }
    ...
    if (
      ...
      if (global.race["artifical"]) {
        ...
        if (global.race["detritivore"]) {
          ...
          breakdown.p["Food"][
            loc(global.race["unfathomable"] ? "job_raider" : "job_hunter")
          ] = food_hunt + "v";
          ...
          if (global.city["captive_housing"]) {
            ...
            if (
              ...
              if (
                global.city.captive_housing.cattle > 0 &&
                global.resource.Food.amount < global.resource.Food.max * 0.01
              ) {
                global.city.captive_housing.cattle--;
      ...
      if (global.city.banquet) {
        if (global.city.banquet.on) {
          banquet *=
            (global.city.banquet.count >= 5 ? 1.02 : 1.022) **
    ...
    // Knowledge
    {
      ...
      if (global.city["library"]) {
        ...
        breakdown.p["Knowledge"][loc("city_library")] =
          (library_mult - 1) * 100 + "%";
        delta *= library_mult;
      }
      if (astroSign === "gemini") {
        ...
        if (
          ...
          messageQueue(
            loc("tau_gas2_alien_station_data2", [
              loc(
                `tau_gas2_alien_station_data2_r${
                  global.race.tau_food_item || 0
                }`
              ),
            ]),
            "success",
    ...
    if (global.resource.Omniscience.display) {
      if (support_on["research_station"]) {
        ...
        let ghost_gain =
          support_on["research_station"] * ghost_base * 0.0000325;
    ...
    if (smelterUnlocked()) {
      ...
      let consume_wood = global.race["forge"]
        ? 0
        : global.city.smelter.Wood *
          (global.race["evil"] &&
          (!global.race["soul_eater"] || global.race.species === "wendigo")
            ? 1
            : 3);
      let consume_coal = global.race["forge"]
        ? 0
        : global.city.smelter.Coal * coal_fuel;
      let consume_oil = global.race["forge"]
        ? 0
        : global.city.smelter.Oil * 0.35;
      ...
      let oil_bonus = global.race["forge"]
        ? global.city.smelter.Wood +
          global.city.smelter.Coal +
          global.city.smelter.Oil
        : global.city.smelter.Oil;
      ...
      while (
        iron_smelter + steel_smelter + iridium_smelter >
        global.city.smelter.Wood +
          global.city.smelter.Coal +
          global.city.smelter.Oil +
          global.city.smelter.Star +
      ...
      let l_type =
        global.race["soul_eater"] && global.race.species !== "wendigo"
          ...
          : "Lumber";
      while (
        consume_wood * time_multiplier > global.resource[l_type].amount &&
        consume_wood > 0
      ) {
        consume_wood -=
          global.race["evil"] &&
      ...
      if (inferno_bonus > 0) {
        ...
        Object.keys(inferno_rate).forEach(function (fuel) {
          while (
            inferno_rate[fuel] * inferno_bonus * time_multiplier >
              global.resource[fuel].amount &&
            inferno_bonus > 0
          ) {
            inferno_bonus--;
      ...
      if (
        ...
        let ash =
          (ash_base / 65 / global_multiplier) *
          production("psychic_boost", "Uranium");
        breakdown.p["Uranium"][loc("city_coal_ash")] = breakdown.p["Uranium"][
          loc("city_coal_ash")
        ]
          ? breakdown.p["Uranium"][loc("city_coal_ash")] + ash
          : ash;
    ...
    if (
      global[graph_source]["g_factory"] &&
      global[graph_source]["g_factory"].count > 0
    ) {
      ...
      if (graphene_production > 0) {
        ...
        breakdown.p.consume.Lumber[loc("interstellar_g_factory_bd")] =
          -consume_wood;
        breakdown.p.consume.Coal[loc("interstellar_g_factory_bd")] =
          -consume_coal;
        breakdown.p.consume.Oil[loc("interstellar_g_factory_bd")] =
          -consume_oil;
        ...
        let delta =
          ...
          synd *
          eff;
        breakdown.p["Graphene"][loc("interstellar_g_factory_bd")] =
    ...
    // Lumber
    {
      ...
      if (global.race["cataclysm"] || global.race["orbit_decayed"]) {
        ...
        modRes(
          "Lumber",
          soldiers * hunger * global_multiplier * q_multiplier * time_multiplier
        );
      } else {
    ...
    if (global.race["sappy"]) {
      ...
      stone_base *=
        global.civic.quarry_worker.impact *
        production("psychic_boost", "Stone");
        ...
        if (global.tech["mars"] && support_on["red_mine"]) {
          ...
          if (global.race["smoldering"] && global.resource.Chrysotile.display) {
            asbestos_base =
              support_on["red_mine"] *
              workerScale(global.civic.colonist.workers, "colonist") *
              production("red_mine", "asbestos") *
              production("psychic_boost", "Chrysotile");
            breakdown.p["Chrysotile"][structName("mine")] = asbestos_base + "v";
            if (asbestos_base > 0) {
              breakdown.p["Chrysotile"][
      ...
      if (global.race["forager"] && global.resource.Stone.display) {
        ...
        let forage_base =
          foragers * forage * 0.22 * production("psychic_boost", "Stone");
      ...
      if (
        global.race["smoldering"] &&
        global.resource.Chrysotile.display &&
      ...
      if (
        ...
        let base =
          stone_base * rock_quarry * (global.race["cataclysm"] ? 0.16 : 0.08);
        ...
        let delta =
          base * shrineMetal.mult * hunger * q_multiplier * global_multiplier;
      ...
      if (global.race["casting"]) {
        [
          ...
          if (global.race.casting[spell] && global.race.casting[spell] > 0) {
            ...
            let buffer =
              global.resource.Mana.diff > 0
                ? global.resource.Mana.diff * time_multiplier
                : 0;
            if (
              !modRes("Mana", -(consume_mana * time_multiplier), false, buffer)
            ) {
    ...
    if (global.resource.Copper.display || global.resource.Iron.display) {
      ...
      if (global.resource.Iron.display) {
        ...
        let delta =
          (iron_base * iron_power * q_multiplier +
    ...
    if (global.resource.Oil.display) {
      ...
      let oil_well = global.city["oil_well"]
        ? production("oil_well") * fueled_oil_wells
        : 0;
      let oil_extractor = global.space["oil_extractor"]
        ? fueled_oil_extractor * production("oil_extractor")
        : 0;
      ...
      let delta =
        oil_well * q_multiplier +
        oil_extractor * qs_multiplier * synd * zigVal +
    ...
    if (support_on["iridium_mine"]) {
      ...
      breakdown.p["Iridium"][loc("space_moon_iridium_mine_title")] =
        iridium_base + "v";
      if (iridium_base > 0) {
        breakdown.p["Iridium"][`ᄂ${loc("city_smelter")}+0`] =
          (iridium_smelter - 1) * 100 + "%";
    ...
    if (global.space["moon_base"] && support_on["helium_mine"]) {
      ...
      breakdown.p["Helium_3"][loc("space_moon_helium_mine_title")] =
        helium_base + "v";
      if (helium_base > 0) {
    ...
    if (global.resource.Infernite.display) {
      if (global.civic.hell_surveyor.workers > 0) {
        ...
        let surveyor_base =
          workerScale(
            highPopAdjust(global.civic.hell_surveyor.workers),
            "hell_surveyor"
          ) *
          rate *
        ...
        breakdown.p["Infernite"][loc("job_hell_surveyor")] =
          surveyor_base + "v";
      ...
      if (tauEnabled()) {
        ...
        if (global.tech["isolation"]) {
...

          {
            // Chrysotile
            let cry_base =
              miner_base * production("psychic_boost", "Chrysotile");
            ...
            if (cry_base > 0) {
              breakdown.p["Chrysotile"][`ᄂ${loc("tau_home_colony")}`] =
                (colony_val - 1) * 100 + "%";
              breakdown.p["Chrysotile"][loc("hunger")] =
                (hunger - 1) * 100 + "%";
            }
            modRes("Chrysotile", delta * time_multiplier);
          }
    ...
    if (
      ...
      (p_on["casino"] || p_on["spc_casino"] || p_on["tauceti_casino"])
    ) {
      let casinos = 0;
      if (p_on["casino"]) {
        casinos += p_on["casino"];
      ...
      if (global.race["gambler"]) {
        revenue *=
          1 + (traits.gambler.vars()[0] * global.race["gambler"]) / 100;
      }
      cash *= revenue;
    ...
    if (global.tech["foundry"]) {
      ...
      Object.keys(crafting_usage).forEach(function (used) {
        if (crafting_usage[used] > 0) {
          breakdown.p.consume[used][loc("job_craftsman")] =
            -crafting_usage[used];
        }
      });
    }
  ...
  if (global.race.species === "protoplasm") {
    ...
    if (global.portal["harbor"] && p_on["harbor"]) {
      ...
      for (const res of actions.portal.prtl_lake.harbor.res()) {
        if (global.resource[res].display) {
          let gain =
            p_on["harbor"] *
            spatialReasoning(actions.portal.prtl_lake.harbor.val(res));
          caps[res] += gain;
          breakdown.c[res][label] = gain + "v";
        }
      }
    ...
    if (p_on["embassy"] && global.galaxy["symposium"]) {
      ...
      if (global.tech.xeno >= 7) {
        let crew =
          global.galaxy.defense.gxy_gorddon.scout_ship *
          (actions.galaxy.gxy_gateway.scout_ship.ship.civ() +
            actions.galaxy.gxy_gateway.scout_ship.ship.mil());
        crew +=
          global.galaxy.defense.gxy_gorddon.corvette_ship *
          (actions.galaxy.gxy_gateway.corvette_ship.ship.civ() +
            actions.galaxy.gxy_gateway.corvette_ship.ship.mil());
        crew +=
          global.galaxy.defense.gxy_gorddon.frigate_ship *
          (actions.galaxy.gxy_gateway.frigate_ship.ship.civ() +
            actions.galaxy.gxy_gateway.frigate_ship.ship.mil());
        crew +=
          global.galaxy.defense.gxy_gorddon.cruiser_ship *
          (actions.galaxy.gxy_gateway.cruiser_ship.ship.civ() +
            actions.galaxy.gxy_gateway.cruiser_ship.ship.mil());
        crew +=
          global.galaxy.defense.gxy_gorddon.dreadnought *
          (actions.galaxy.gxy_gateway.dreadnought.ship.civ() +
            actions.galaxy.gxy_gateway.dreadnought.ship.mil());

        if (gal_on["freighter"]) {
          crew +=
            gal_on["freighter"] *
            (actions.galaxy.gxy_gorddon.freighter.ship.civ() +
              actions.galaxy.gxy_gorddon.freighter.ship.mil());
        }
    ...
    if (
      ...
      if (global.portal.spire.progress >= 100) {
        ...
        messageQueue(
          `${loc("portal_spire_conquest", [
            loc(`portal_mech_boss_${global.portal.spire.boss}`),
            global.portal.spire.count,
          ])} ${loc(
            stones === 1
              ? "portal_spire_conquest_stone"
              : "portal_spire_conquest_stones",
            [stones]
          )}`,
          "info",
          false,
...
function longLoop() {
  ...
  if (global.race.species !== "protoplasm") {
    ...
    if (
      ...
      let womlings =
        global.stats.matrix + global.stats.retire + global.stats.eden;
      let skilled =
        global.stats.achieve["pathfinder"] &&
...
function buildGene() {
  ...
  let buffer =
    global.resource.Knowledge.diff < 10000
      ? global.resource.Knowledge.diff
      : 10000;
  if (
