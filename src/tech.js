...
const techs = {
  ...
  bone_tools: {
    ...
    cost: {
      Food() {
        return (global.race["evil"] && !global.race["smoldering"]) ||
          global.race["fasting"]
          ? 0
          : 10;
      },
  ...
  wooden_tools: {
    ...
    title() {
      return global.race["kindling_kindred"]
        ? loc("tech_bone_tools")
        : loc("tech_wooden_tools");
    },
    desc() {
      return global.race["kindling_kindred"]
        ? loc("tech_bone_tools_desc")
        : loc("tech_wooden_tools_desc");
    },
    category: "stone_gathering",
    era: "primitive",
    reqs: { primitive: 1 },
  ...
  sundial: {
    ...
    desc() {
      return global.race["unfathomable"]
        ? loc("tech_moondial_desc")
        : loc("tech_sundial_desc");
    },
    category: "science",
    era: "primitive",
    reqs: { primitive: 2 },
    condition() {
      return !global.race["gravity_well"] ||
        (global.race["gravity_well"] && global.tech["transport"])
        ? true
        : false;
    },
    grant: ["primitive", 3],
    ...
    effect() {
      return global.race["unfathomable"]
        ? loc("tech_moondial_effect")
        : loc("tech_sundial_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  psychic_channeling: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        global.race.psychicPowers["channel"] = {
          cash: 0,
          assault: 0,
          boost: 0,
        };
  ...
  smokehouse: {
    ...
    desc() {
      return global.race["hrt"] &&
        ["wolven", "vulpine"].includes(global.race["hrt"])
        ? loc("tech_smokehouse_easter_desc")
        : loc("tech_smokehouse_desc");
    },
    category: "storage",
    era: "civilized",
    reqs: { primitive: 3, storage: 1 },
    ...
    effect() {
      return global.race["hrt"] &&
        ["wolven", "vulpine"].includes(global.race["hrt"])
        ? loc("tech_smokehouse_easter_effect")
        : loc("tech_smokehouse_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        checkAltPurgatory(
          ...
          "smokehouse",
          "silo",
          actions.city.smokehouse.struct().d
        );
        return true;
      }
      return false;
  ...
  alt_lodge: {
    ...
    grant: ["s_lodge", 1],
    condition() {
      return ((global.race.species === "wendigo" ||
    ...
    cost: {
      Knowledge() {
        return global.race["artifical"] ? 10000 : 180;
      },
    },
    effect() {
      return this.condition()
        ? loc("tech_lodge_effect_alt")
        : loc("tech_lodge_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        checkAltPurgatory(
  ...
  wind_plant: {
    ...
    effect() {
      return global.race["unfathomable"]
        ? loc("tech_watermill_effect")
        : loc("tech_wind_plant_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        checkAltPurgatory(
          ...
          "windmill",
          "mill",
          actions.city.windmill.struct().d
        );
        return true;
      }
      return false;
  ...
  assembly_line: {
    ...
    effect: `<span>${loc(
      "tech_assembly_line_effect"
    )}</span> <span class="has-text-special">${loc(
      "tech_factory_warning"
    )}</span>`,
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  high_tech_factories: {
    ...
    effect: `<span>${loc(
      "tech_high_tech_factories_effect"
    )}</span> <span class="has-text-special">${loc(
      "tech_factory_warning"
    )}</span>`,
    action() {
  ...
  magic: {
    ...
    effect() {
      return global.race.universe === "magic"
        ? loc("tech_illusionist_effect")
        : loc("tech_magic_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  mining: {
    ...
    effect() {
      return global.race["sappy"]
        ? loc("tech_amber_effect")
        : loc(
            global.race["flier"]
              ? "tech_mining_effect_alt"
              : "tech_mining_effect"
          );
    },
    action() {
  ...
  bayer_process: {
    ...
    effect() {
      return global.race["sappy"]
        ? loc("tech_bayer_process_effect_alt")
        : loc("tech_bayer_process_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  titanium_crates: {
    ...
    effect() {
      return loc("tech_titanium_crates_effect", [
  ...
  infernite_crates: {
    ...
    desc() {
      return loc("tech_infernite_crates_desc", [
    ...
    effect() {
      return loc("tech_infernite_crates_effect", [
        global.resource.Infernite.name,
      ]);
    },
    action() {
  ...
  graphene_crates: {
    ...
    effect() {
      return loc("tech_graphene_crates_effect", [
  ...
  bolognium_crates: {
    ...
    effect() {
      return loc("tech_bolognium_crates_effect", [
  ...
  elysanite_crates: {
    ...
    effect() {
      return loc("tech_elysanite_crates_effect", [
        global.resource.Elysanite.name,
        global.resource.Asphodel_Powder.name,
      ]);
    },
    action() {
      if (payCosts($(this)[0])) {
        ...
        let res =
          global.race["kindling_kindred"] || global.race["smoldering"]
            ? global.race["smoldering"]
              ...
              : "Stone"
            : "Plywood";
        return loc("tech_steel_containers_alt_effect", [
  ...
  mythril_containers: {
    ...
    desc() {
      return loc("tech_mythril_containers_desc", [
        global.resource.Mythril.name,
      ]);
    },
    category: "storage",
    era: "early_space",
    ...
    effect() {
      return loc("tech_mythril_containers_effect", [
        global.resource.Mythril.name,
      ]);
    },
    action() {
  ...
  adamantite_containers: {
    ...
    desc() {
      return loc("tech_adamantite_containers_desc", [
    ...
    effect() {
      return loc("tech_adamantite_containers_effect", [
        global.resource.Adamantite.name,
      ]);
    },
    action() {
  ...
  aerogel_containers: {
    ...
    effect() {
      return loc("tech_aerogel_containers_effect", [
        global.resource.Aerogel.name,
      ]);
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  bolognium_containers: {
    ...
    effect() {
      return loc("tech_bolognium_containers_effect", [
        global.resource.Bolognium.name,
      ]);
    },
    action() {
  ...
  nanoweave_containers: {
    ...
    effect() {
      return loc("tech_nanoweave_containers_effect", [
        global.resource.Nanoweave.name,
      ]);
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  elysanite_containers: {
    ...
    effect() {
      return loc("tech_elysanite_containers_effect", [
        global.resource.Elysanite.name,
      ]);
    },
    action() {
  ...
  republic: {
    ...
    reqs: { govern: 1 },
    condition() {
      return (global.tech["trade"] && global.tech["trade"] >= 2) ||
  ...
  federation: {
    ...
    condition() {
      return (
        (global.tech["unify"] && global.tech["unify"] >= 2) ||
        checkControlling()
      );
    },
    grant: ["gov_fed", 1],
  ...
  governor: {
    ...
    reqs: { govern: 1 },
    condition() {
      return global.genes["governor"] && global.civic.govern.type !== "anarchy"
        ? true
        : false;
    },
    grant: ["governor", 1],
  ...
  scientific_journal: {
    ...
    title() {
      return global.race.universe === "magic"
        ? loc("tech_magic_tomes")
        : loc("tech_scientific_journal");
    },
    desc() {
      return global.race.universe === "magic"
        ? loc("tech_magic_tomes_desc")
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 27000);
      },
    },
    effect() {
      return global.race.universe === "magic"
        ? loc("tech_magic_tomes_effect")
        : loc("tech_scientific_journal_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  adjunct_professor: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 36000);
      },
    },
    effect() {
      return loc("tech_adjunct_professor_effect", [
        wardenLabel(),
  ...
  observatory: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 148000);
      },
    },
  ...
  world_collider: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 350000);
      },
    },
    effect() {
    ...
    flair: `<div>${loc("tech_world_collider_flair1")}</div><div>${loc(
      "tech_world_collider_flair2"
    )}</div>`,
  },
  laboratory: {
    id: "tech-laboratory",
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 500000);
      },
    },
    effect() {
      return global.race.universe === "magic"
        ? loc("tech_sanctum_effect")
        : loc("tech_laboratory_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
    ...
    flair() {
      return global.race.universe === "magic"
        ? loc("tech_sanctum_flair")
        : loc("tech_laboratory_flair");
    },
  },
  virtual_assistant: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 635000);
      },
    },
    effect() {
      return global.race.universe === "magic"
        ? loc("tech_virtual_assistant_magic_effect")
        : loc("tech_virtual_assistant_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  dimensional_readings: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 750000);
      },
    },
    effect() {
  ...
  quantum_entanglement: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 850000);
      },
      Neutronium() {
        return 7500;
      },
    ...
    effect() {
      return loc("tech_quantum_entanglement_effect", [
        2,
  ...
  expedition: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 5350000);
      },
    },
    effect() {
      return global.race.universe === "magic"
        ? loc("tech_expedition_wiz_effect")
        : loc("tech_expedition_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  subspace_sensors: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 6000000);
      },
    },
    effect() {
  ...
  alien_database: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 8250000);
      },
    },
    effect() {
  ...
  orichalcum_capacitor: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 12500000);
      },
      Orichalcum() {
        return 250000;
      },
  ...
  advanced_biotech: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 25500000);
      },
    },
    effect() {
  ...
  codex_infinium: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 40100000);
      },
      Codex() {
        return 1;
      },
  ...
  spirit_researcher: {
    ...
    effect() {
      return loc("tech_spirit_researcher_effect", [
        global.civic.scientist
          ? global.civic.scientist.name
          : loc("job_scientist"),
      ]);
    ...
    action() {
      if (payCosts($(this)[0])) {
        if (global.tech["hell_lake"] >= 3) {
          messageQueue(loc("tech_lake_analysis_fasting"), "info", false, [
            "progress",
            "hell",
          ]);
        }
      ...
      return `${loc("tech_final_ingredient_effect")}
            ${
              global.race["witch_hunter"]
                ? `<div class="has-text-warning">${loc(
                    "dish_witch_hunter_interaction",
                    [
                      loc("tech_outerplane_summon"),
                      loc("portal_devilish_dish_title"),
                    ]
                  )}</div>`
                : ""
            }
            <div class="has-text-special">${loc(
  ...
  crispr: {
    ...
    effect() {
      return global.race["artifical"]
        ? loc("tech_crispr_effect_artifical")
        : loc("tech_crispr_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  shotgun_sequencing: {
    ...
    desc() {
      return global.race["artifical"]
        ? loc("tech_shotgun_sequencing_desc_artifical")
        : loc("tech_shotgun_sequencing_desc");
    },
    category: "genes",
    era: "early_space",
    reqs: { genetics: 4 },
    ...
    effect() {
      return global.race["artifical"]
        ? loc("tech_shotgun_sequencing_effect_artifical")
        : loc("tech_shotgun_sequencing_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  de_novo_sequencing: {
    ...
    effect() {
      return global.race["artifical"]
        ? loc("tech_de_novo_sequencing_effect_artifical")
        : loc("tech_de_novo_sequencing_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  dna_sequencer: {
    ...
    title() {
      return global.race["artifical"]
        ? loc("tech_code_sequencer")
        : loc("tech_dna_sequencer");
    },
    desc() {
      return global.race["artifical"]
        ? loc("tech_code_sequencer")
    ...
    effect() {
      return global.race["artifical"]
        ? loc("tech_code_sequencer_effect")
        : loc("tech_dna_sequencer_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  rapid_sequencing: {
    ...
    title() {
      return global.race["artifical"]
        ? loc("tech_agile_development")
        : loc("tech_rapid_sequencing");
    },
    desc() {
      return global.race["artifical"]
        ? loc("tech_agile_development")
    ...
    effect() {
      return global.race["artifical"]
        ? loc("tech_agile_development_effect")
        : loc("tech_rapid_sequencing_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  mad_science: {
    ...
    cost: {
      ...
      Crystal() {
        return global.race.universe === "magic" ? 1000 : 0;
      },
      Aluminium() {
        return 750;
      },
    ...
    effect() {
      return global.race.universe === "magic"
        ? loc("tech_sages_effect")
        : loc("tech_mad_science_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  matter_replicator: {
    ...
    title() {
      return global.race.universe === "antimatter" && !global.race["amexplode"]
    ...
    effect() {
      return global.race.universe === "antimatter" && !global.race["amexplode"]
        ? loc("tech_antireplicator_effect_alt")
        : loc("tech_replicator_effect_alt");
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  electronics: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 50000);
      },
    },
  ...
  arpa: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 90000);
      },
    },
  ...
  rocketry: {
    ...
    cost: {
      ...
      Oil() {
        return global.city.ptrait.includes("dense") ? 8000 : 6800;
      },
    },
  ...
  robotics: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 125000);
      },
    },
  ...
  lasers: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 280000);
      },
      Elerium() {
        return 100;
      },
  ...
  artifical_intelligence: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 325000);
      },
    },
  ...
  quantum_computing: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 435000);
      },
      Elerium() {
        return 250;
      },
  ...
  virtual_reality: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 600000);
      },
      Stanene() {
        return 1250;
      },
  ...
  plasma: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 755000);
      },
      Infernite() {
        return global.race["truepath"] ? 0 : 1000;
      },
      Stanene() {
        return global.race["truepath"] ? 1000000 : 250000;
      },
    },
  ...
  ai_core: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 1500000);
      },
    },
  ...
  metaphysics: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 5000000);
      },
      Vitreloy() {
        return 10000;
      },
  ...
  orichalcum_analysis: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 12200000);
      },
      Orichalcum() {
        return 100000;
      },
  ...
  cybernetics: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 25000000);
      },
      Adamantite() {
        return 12500000;
      },
  ...
  divinity: {
    ...
    cost: {
      Knowledge() {
        return traitCostMod("stubborn", 120000000);
      },
      Omniscience() {
        return 34000;
      },
  ...
  purify_essence: {
    ...
    effect() {
      return `<div>${loc(
        "tech_purify_essence_effect"
      )}</div><div class="has-text-special">${loc(
        "tech_purify_essence_warn"
      )}</div>`;
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  study_corrupt_gem: {
    ...
    cost: {
      Mana() {
        return global.race["no_plasmid"] ? 10000 : 30000;
      },
      Knowledge() {
        return 18500000;
      },
    ...
    action() {
      if (payCosts($(this)[0])) {
        messageQueue(loc("tech_study_corrupt_gem_result"), "info", false, [
          "progress",
          "hell",
        ]);
  ...
  corrupt_gem_analysis: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        messageQueue(loc("tech_corrupt_gem_analysis_result"), "info", false, [
          "progress",
          "hell",
        ]);
        global.resource.Corrupt_Gem.display = false;
  ...
  hell_search: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        messageQueue(loc("tech_hell_search_result"), "info", false, [
          "progress",
          "hell",
        ]);
  ...
  lake_threat: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        ...
        messageQueue(loc("tech_lake_threat_result"), "info", false, [
          "progress",
          "hell",
        ]);
        return true;
  ...
  crypto_mining: {
    ...
    effect: loc("tech_crypto_mining_effect", [
      loc("interstellar_citadel_title"),
    ]),
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  oil_well: {
    ...
    effect() {
      return global.race["blubber"]
        ? loc("tech_oil_refinery_effect")
        : loc("tech_oil_well_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  oil_power: {
    ...
    effect() {
      return global.race["environmentalist"]
        ? loc("tech_wind_power_effect")
        : loc("tech_oil_power_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  synthetic_fur: {
    ...
    title() {
      return global.race["evil"]
        ? loc("tech_faux_leather")
        : loc("tech_synthetic_fur");
    },
    desc() {
      return global.race["evil"]
        ? loc("tech_faux_leather")
    ...
    effect() {
      return global.race["evil"]
        ? loc("tech_faux_leather_effect")
        : loc("tech_synthetic_fur_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
    ...
    action() {
      if (payCosts($(this)[0])) {
        ...
        if (
          ...
          !global.pillars[global.race.species]
        ) {
  ...
  pillars: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        messageQueue(
          loc("tech_pillars_msg", [races[global.race.species].entity]),
          "info",
          false,
          ["progress", "hell"]
        );
  ...
  stone_axe: {
    ...
    effect() {
      ...
      return global.race["sappy"]
        ? loc("tech_amber_axe_effect")
        : loc("tech_stone_axe_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        if (!global.race["forager"]) {
  ...
  chainsaws: {
    ...
    flair() {
      return `<div>${loc("tech_chainsaws_flair1")}</div><div>${loc(
        "tech_chainsaws_flair2"
      )}</div>`;
    },
  },
  copper_sledgehammer: {
  ...
  adamantite_hammer: {
    ...
    effect() {
      return loc("tech_improved_jackhammer_effect", [
        global.resource.Adamantite.name,
      ]);
    },
    action() {
  ...
  bac_tanks: {
    ...
    title() {
      return global.race["artifical"]
        ? loc("tech_repair_subroutines")
        : loc("tech_bac_tanks");
    },
    desc() {
      return global.race["artifical"]
        ? loc("tech_repair_subroutines")
        : loc("tech_bac_tanks_desc");
    },
    category: "military",
    era: "interstellar",
    ...
    effect() {
      return global.race["artifical"]
        ? loc("tech_repair_subroutines_effect")
        : loc("tech_bac_tanks_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  bows: {
    ...
    effect() {
      return global.race["blubber"]
        ? loc("tech_harpoon_effect")
        : loc("tech_bows_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  flintlock_rifle: {
    ...
    effect() {
      return global.race.universe === "magic"
        ? loc("tech_magic_arrow_effect")
        : loc("tech_flintlock_rifle_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  machine_gun: {
    ...
    effect() {
      return global.race.universe === "magic"
        ? loc("tech_fire_mage_effect")
        : loc("tech_machine_gun_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  rail_guns: {
    ...
    effect() {
      return global.race.universe === "magic"
        ? loc("tech_lightning_caster_effect")
        : loc("tech_rail_guns_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  laser_rifles: {
    ...
    effect() {
      return global.race.universe === "magic"
        ? loc("tech_mana_rifles_effect")
        : loc("tech_laser_rifles_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  plasma_rifles: {
    ...
    cost: {
      ...
      Elerium() {
        return global.race["truepath"] ? 1000 : 500;
      },
    },
    effect() {
      return global.race.universe === "magic"
        ? loc("tech_focused_rifles_effect")
        : loc("tech_plasma_rifles_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  disruptor_rifles: {
    ...
    effect() {
      return global.race.universe === "magic"
        ? loc("tech_magic_missile_effect")
        : loc("tech_disruptor_rifles_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  gauss_rifles: {
    ...
    effect() {
      return global.race.universe === "magic"
        ? loc("tech_magicword_kill_effect")
        : loc("tech_gauss_rifles_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  space_marines: {
    ...
    effect() {
      return `<div>${loc("tech_space_marines_effect", [
        planetName().red,
      ])}</div>`;
    },
    action() {
  ...
  laser_turret: {
    ...
    effect() {
      return `<div>${loc(
        "tech_laser_turret_effect1"
      )}</div><div class="has-text-special">${loc(
        "tech_laser_turret_effect2"
      )}</div>`;
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  black_powder: {
    ...
    title() {
      return global.race.universe === "magic"
        ? loc("tech_magic_powder")
        : loc("tech_black_powder");
    },
    desc() {
      return global.race.universe === "magic"
        ? loc("tech_magic_powder_desc")
        : loc("tech_black_powder_desc");
    },
    category: "progress",
    era: "civilized",
    reqs: { mining: 4 },
    ...
    effect() {
      return global.race.universe === "magic"
        ? loc("tech_magic_powder_effect")
        : loc("tech_black_powder_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
        return true;
  ...
  super_tnt: {
    ...
    effect() {
      return loc("tech_super_tnt_effect", [
        global.resource.Asphodel_Powder.name,
      ]);
    },
    action() {
    ...
    action() {
      if (payCosts($(this)[0])) {
        if (
          ...
          messageQueue(loc("tech_mad_info_easter"), "info", false, [
            "progress",
          ]);
        } else {
  ...
  otherworldly_binder: {
    ...
    effect() {
      return loc("tech_otherworldly_binder_effect", [
        global.resource.Asphodel_Powder.name,
  ...
  fanaticism: {
    ...
    no_queue() {
      return global.r_queue.queue.some(
        (item) => item.id === "tech-anthropology"
      )
        ? true
        : false;
    },
    ...
    effect: `<div>${loc(
      "tech_fanaticism_effect"
    )}</div><div class="has-text-special">${loc(
      "tech_fanaticism_warning"
    )}</div>`,
    action() {
      if (payCosts($(this)[0])) {
  ...
  study: {
    ...
    grant: ["theology", 5],
    wiki:
      global.genes["transcendence"] && global.genes.transcendence >= 2
        ? false
        : true,
    condition() {
      return !global.genes["transcendence"] || global.genes.transcendence < 2
        ? true
        : false;
    },
    no_queue() {
      return global.r_queue.queue.some((item) => item.id === "tech-deify")
        ? true
        : false;
    },
    cost: {
    ...
    effect() {
      let entity =
        global.race.old_gods !== "none"
          ? races[global.race.old_gods.toLowerCase()].entity
          : races[global.race.species].entity;
      return `<div>${loc("tech_study_effect", [
        entity,
      ])}</div><div class="has-text-special">${loc(
        "tech_study_warning"
      )}</div>`;
  ...
  deify: {
    ...
    no_queue() {
      return global.r_queue.queue.some((item) => item.id === "tech-study")
        ? true
        : false;
    },
    cost: {
    ...
    effect() {
      let entity =
        global.race.old_gods !== "none"
          ? races[global.race.old_gods.toLowerCase()].entity
          : races[global.race.species].entity;
      return `<div>${loc("tech_deify_effect", [
        entity,
      ])}</div><div class="has-text-special">${loc(
        "tech_deify_warning"
      )}</div>`;
  ...
  anthropology: {
    ...
    not_gene: ["transcendence"],
    no_queue() {
      return global.r_queue.queue.some((item) => item.id === "tech-fanaticism")
        ? true
        : false;
    },
    cost: {
    ...
    effect: `<div>${loc(
      "tech_anthropology_effect"
    )}</div><div class="has-text-special">${loc(
      "tech_anthropology_warning"
    )}</div>`,
    action() {
      if (payCosts($(this)[0])) {
  ...
  colonization: {
    ...
    effect() {
      return loc(
        global.race["artifical"]
          ? "tech_colonization_artifical_effect"
          : "tech_colonization_effect",
        [planetName().red]
      );
    },
    action() {
  ...
  swarm_plant: {
    ...
    effect() {
      return loc("tech_swarm_plant_effect", [
  ...
  orichalcum_sphere: {
    ...
    condition() {
      return global.interstellar["dyson_sphere"] &&
  ...
  unification2: {
    ...
    effect() {
      let banana_warn = global.race["banana"]
        ? `<div class="has-text-danger">${loc("tech_unification_banana")}</div>`
        : "";
      return `<div>${loc(
        "tech_unification_effect2"
      )}</div><div class="has-text-special">${loc(
        "tech_unification_warning"
      )}</div>${banana_warn}`;
    },
    action() {
      if (payCosts($(this)[0])) {
        ...
        if (
          global.civic.foreign.gov0.occ &&
          global.civic.foreign.gov1.occ &&
          global.civic.foreign.gov2.occ
        ) {
          unlockAchieve(`world_domination`);
        }
        if (
          global.civic.foreign.gov0.anx &&
          global.civic.foreign.gov1.anx &&
          global.civic.foreign.gov2.anx
        ) {
          unlockAchieve(`illuminati`);
        }
        if (
          global.civic.foreign.gov0.buy &&
          global.civic.foreign.gov1.buy &&
          global.civic.foreign.gov2.buy
        ) {
  ...
  unite: {
    ...
    effect() {
      return `<div>${loc(
        "tech_unite_effect"
      )}</div><div class="has-text-warning">${loc(
        "tech_unification_effect2"
      )}</div>`;
    },
    action() {
  ...
  genesis_ship: {
    ...
    title() {
      return global.race["cataclysm"]
        ? loc("tech_generational_ship")
        : loc("tech_genesis_ship");
    },
    desc() {
      return global.race["cataclysm"]
        ? loc("tech_generational_ship")
    ...
    effect() {
      return global.race["cataclysm"]
        ? loc("tech_generational_effect")
        : loc("tech_genesis_ship_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  exotic_infusion: {
    ...
    effect() {
      return `<div>${loc("tech_exotic_infusion_effect", [
        global.resource.Soul_Gem.name,
      ])}</div><div class="has-text-danger">${loc(
        "tech_exotic_infusion_effect2"
      )}</div>`;
    },
    action() {
      if (checkAffordable($(this)[0])) {
  ...
  infusion_confirm: {
    ...
    effect() {
      ...
      let prestige = `<div class="has-text-caution">${loc(
        "wiki_tech_infusion_confirm_gains",
        [gains.plasmid, gains.phage, gains.dark, plasmidType]
      )}</div>`;
      return `<div>${loc(
        "tech_infusion_confirm_effect"
      )}</div><div class="has-text-danger">${loc(
        "tech_exotic_infusion_effect2"
      )}</div>${prestige}`;
    },
  ...
  stabilize_blackhole: {
    ...
    desc() {
      return `<div>${loc(
        "tech_stabilize_blackhole"
      )}</div><div class="has-text-danger">${loc(
        "tech_stabilize_blackhole2"
      )}</div>`;
    },
    category: "stellar_engine",
    era: "interstellar",
    ...
    action() {
      if (payCosts($(this)[0])) {
        global.interstellar.stellar_engine.mass +=
          (atomic_mass.Neutronium * 20000) / 10000000000;
        global.interstellar.stellar_engine.mass +=
          global.interstellar.stellar_engine.exotic * 40;
  ...
  industrial_partnership: {
    ...
    effect() {
      return loc("tech_industrial_partnership_effect", [
        races[
          global.galaxy.hasOwnProperty("alien1")
            ? global.galaxy.alien1.id
            : global.race.species
  ...
  embassy_housing: {
    ...
    effect() {
      return loc("tech_embassy_housing_effect", [
        races[
          global.galaxy.hasOwnProperty("alien1")
            ? global.galaxy.alien1.id
            : global.race.species
  ...
  cruiser_ship: {
    ...
    effect() {
      return loc("tech_cruiser_ship_effect", [
        races[
  ...
  scavenger: {
    ...
    effect() {
      return loc("tech_scavenger_effect", [
        races[
          global.galaxy.hasOwnProperty("alien2")
            ? global.galaxy.alien2.id
            : global.race.species
  ...
  chthonian_survey: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        ...
        messageQueue(loc("tech_chthonian_survey_result"), "info", false, [
          "progress",
        ]);
        return true;
      }
  ...
  soul_bait: {
    ...
    effect() {
      return loc("tech_soul_bait_effect", [
        global.resource.Asphodel_Powder.name,
        loc("arpa_blood_attract_title"),
      ]);
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  dial_it_to_11: {
    ...
    condition() {
      return (global.race["sludge"] || global.race["ultra_sludge"]) &&
    ...
    effect() {
      ...
      let plasmidType =
        global.race.universe === "antimatter"
          ? loc("resource_AntiPlasmid_plural_name")
          : loc("resource_Plasmid_plural_name");
      return `<div>${loc("tech_dial_it_to_11_effect", [
        planetName().dwarf,
        global.race["cataclysm"]
          ? planetName().red
          : races[global.race.species].home,
      ])}</div><div class="has-text-danger">${loc(
        "tech_dial_it_to_11_effect2"
      )}</div><div class="has-text-special">${loc("star_dock_genesis_effect2", [
        gains.plasmid,
        plasmidType,
      ])}</div><div class="has-text-special">${loc(
        "star_dock_genesis_effect3",
        [gains.phage]
      )}</div>`;
    },
    action() {
  ...
  secret_society: {
    ...
    grant: ["roguemagic", 1],
    condition() {
      return global.race["universe"] === "magic" && global.race["witch_hunter"]
        ? true
        : false;
    },
    cost: {
  ...
  improved_concealment: {
    ...
    cost: {
      Mana() {
        return global.race["no_plasmid"] ? 6000 : 15000;
      },
      Knowledge() {
        return 20000000;
      },
  ...
  outerplane_summon: {
    ...
    cost: {
      Mana() {
        return global.race["no_plasmid"] ? 12000 : 40000;
      },
      Knowledge() {
        return 60000000;
      },
  ...
  bribe_sphinx: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        ...
        messageQueue(loc("tech_bribe_sphinx_msg"), "info", false, [
          "progress",
          "hell",
        ]);
        return true;
    ...
    effect() {
      return loc(
        global.race["orbit_decayed"]
          ? "tech_alien_biotech_effect_alt"
          : "tech_alien_biotech_effect"
      );
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  protocol66a: {
    ...
    effect() {
      ...
      let plasmidType =
        global.race.universe === "antimatter"
          ...
          : loc("resource_Plasmid_plural_name");
      let prestige = `<div class="has-text-caution">${loc(
        "tech_protocol66a_effect_gains",
        [gains.plasmid, plasmidType, gains.phage, gains.cores]
      )}</div>`;
    ...
    action() {
      if (payCosts($(this)[0])) {
        ...
        setTimeout(function () {
          $(`body`).append(
            `<div id="deadAirTop" class="signal-lost-top"></div>`
          );
          $(`body`).append(
            `<div id="deadAirBottom" class="signal-lost-bottom"></div>`
          );
  ...
  anitgrav_bunk: {
    ...
    effect() {
      return loc("tech_anitgrav_bunk_effect", [
        loc("space_red_space_barracks_title"),
      ]);
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  data_analysis: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        messageQueue(loc("tech_data_analysis_result"), "info", false, [
          "progress",
        ]);
  ...
  nav_data: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        ...
        messageQueue(
          loc("tech_nav_data_result", [planetName().eris]),
          "info",
          false,
          ["progress"]
        );
  ...
  sensor_logs: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        messageQueue(loc("tech_sensor_logs_result"), "info", false, [
          "progress",
        ]);
        return true;
      }
  ...
  electrolysis: {
    ...
    effect() {
      return loc("tech_electrolysis_effect", [
        planetName().titan,
  ...
  quantium_containers: {
    ...
    effect() {
      return loc("tech_quantium_containers_effect", [
        global.resource.Quantium.name,
      ]);
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  alien_outpost: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        ...
        messageQueue(loc("tech_alien_outpost_msg"), "info", false, [
          "progress",
        ]);
        return true;
      }
  ...
  tau_cultivation: {
    ...
    effect() {
      return loc("tech_tau_cultivation_effect", [
        races[global.race.species].home,
      ]);
    },
    action() {
  ...
  tau_manufacturing: {
    ...
    effect() {
      return loc("tech_tau_manufacturing_effect", [
        races[global.race.species].home,
      ]);
    },
    action() {
  ...
  weasels: {
    ...
    effect() {
      return loc("tech_weasels_effect", [
    ...
    action() {
      if (payCosts($(this)[0])) {
        messageQueue(
          loc("tech_weasels_msg", [loc("tau_planet", [planetName().red])]),
          "info",
          false,
          ["progress"]
        );
  ...
  jeff: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        messageQueue(loc("tech_jeff_effect_msg", []), "info", false, [
          "progress",
        ]);
        return true;
      }
  ...
  womling_logistics: {
    ...
    effect() {
      return loc("tech_womling_logistics_effect", [
  ...
  womling_repulser: {
    ...
    effect() {
      return loc("tech_womling_repulser_effect", [
  ...
  asteroid_analysis: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        messageQueue(loc("tech_asteroid_analysis_msg"), "info", false, [
          "progress",
        ]);
        return true;
      }
  ...
  shark_repellent: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        messageQueue(loc("tech_shark_repellent_msg"), "info", false, [
          "progress",
        ]);
        return true;
      }
  ...
  infectious_disease_lab: {
    ...
    effect() {
      return loc(
        global.race["artifical"]
          ? "tech_infectious_disease_lab_effect_s"
          : "tech_infectious_disease_lab_effect"
      );
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  isolation_protocol: {
    ...
    effect() {
      return `<div>${loc("tech_isolation_protocol_effect", [
        loc("tab_tauceti"),
      ])}</div><div class="has-text-special">${loc(
        "tech_isolation_protocol_warning"
      )}</div>`;
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  focus_cure: {
    ...
    effect() {
      return `<div>${loc("tech_focus_cure_effect", [
        loc("tab_tauceti"),
      ])}</div><div class="has-text-special">${loc(
        "tech_focus_cure_warning"
      )}</div>`;
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  vaccine_campaign: {
    ...
    effect() {
      let struct = global.race["artifical"]
        ? actions.city.boot_camp.title()
        : actions.city.hospital.title;
  ...
  vax_strat1: {
    ...
    effect() {
      return `<div>${loc(
        "tech_vax_strat1_effect"
      )}</div><div class="has-text-special">${loc("tech_vax_warning")}</div>`;
    },
    action() {
      if (payCosts($(this)[0])) {
        global.tech["vax_p"] = 1;
  ...
  clone_degradation: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        messageQueue(loc("tech_clone_degradation_msg"), "info", false, [
          "progress",
        ]);
        return true;
      }
  ...
  outer_tau_survey: {
    ...
    cost: {
      ...
      Helium_3() {
        return +int_fuel_adjust(5000000).toFixed(0);
      },
    },
  ...
  alien_research: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        ...
        messageQueue(loc("tech_alien_research_msg"), "info", false, [
          "progress",
        ]);
        return true;
      }
  ...
  food_culture: {
    ...
    title() {
      return loc("tech_food_culture", [
        loc(`tau_gas2_alien_station_data2_r${global.race.tau_food_item || 0}`),
      ]);
    },
    desc() {
      return loc("tech_food_culture", [
    ...
    effect() {
      return loc("tech_food_culture_effect", [
        loc(`tau_gas2_alien_station_data2_r${global.race.tau_food_item || 0}`),
  ...
  useless_junk: {
    ...
    effect() {
      return loc("tech_useless_junk_effect", [
        loc(`tau_gas2_alien_station_data4_r${global.race.tau_junk_item || 0}`),
        loc(`tau_red_womlings`),
      ]);
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  advanced_asteroid_mining: {
    ...
    effect() {
      return loc("tech_advanced_asteroid_mining_effect", [
  ...
  advanced_material_synthesis: {
    ...
    effect() {
      return loc("tech_advanced_material_synthesis_effect", [
        global.resource.Quantium.name,
      ]);
    },
    action() {
  ...
  matrioshka_brain: {
    ...
    effect() {
      return loc("tech_matrioshka_brain_effect", [
        actions.tauceti.tau_gas2.info.name(),
      ]);
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  ignition_device: {
    ...
    effect() {
      return loc("tech_ignition_device_effect", [
        actions.tauceti.tau_gas2.info.name(),
      ]);
    },
    action() {
  ...
  replicator: {
    id: "tech-replicator",
    title() {
      return global.race.universe === "antimatter"
        ? loc("tech_antireplicator")
        : loc("tech_replicator");
    },
    desc() {
    ...
    effect() {
      return global.race.universe === "antimatter"
        ? loc("tech_antireplicator_effect")
        : loc("tech_replicator_effect");
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  womling_unlock: {
    ...
    effect() {
      return loc("tech_womling_unlock_effect", [
        loc("tau_planet", [planetName().red]),
      ]);
    },
    action() {
  ...
  asphodel_flowers: {
    ...
    action() {
      if (payCosts($(this)[0])) {
        messageQueue(loc("tech_asphodel_flowers_msg"), "info", false, [
          "progress",
        ]);
  ...
  railway_to_hell: {
    ...
    effect() {
      return loc("tech_railway_to_hell_effect", [
        global.resource.Asphodel_Powder.name,
      ]);
    },
    action() {
  ...
  purification: {
    ...
    effect() {
      return loc("tech_purification_effect", [
        global.resource.Asphodel_Powder.name,
        loc("portal_purifier_title"),
        2,
  ...
  asphodel_storage: {
    ...
    effect() {
      return loc("tech_asphodel_storage_effect", [
        global.resource.Asphodel_Powder.name,
      ]);
    },
    action() {
  ...
  asphodel_stabilizer: {
    ...
    effect() {
      return loc("tech_asphodel_stabilizer_effect", [
        global.resource.Asphodel_Powder.name,
      ]);
    },
    action() {
  ...
  bliss_den: {
    ...
    effect() {
      return loc("tech_bliss_den_effect", [
        global.resource.Asphodel_Powder.name,
      ]);
    },
    action() {
  ...
  hallowed_housing: {
    ...
    effect() {
      return loc("tech_hallowed_housing_effect", [
        loc(`job_priest`),
        loc("eden_asphodel_name"),
      ]);
    },
    action() {
      if (payCosts($(this)[0])) {
  ...
  celestial_tactics: {
    ...
    condition() {
      return global.eden.hasOwnProperty("fortress") &&
        global.eden.fortress.patrols <= 18
        ? true
        : false;
    },
  ...
  active_camouflage: {
    ...
    condition() {
      return global.eden.hasOwnProperty("fortress") &&
        global.eden.fortress.armory < 100
        ? true
        : false;
    },
  ...
  special_ops_training: {
    ...
    condition() {
      return global.eden.hasOwnProperty("fortress") &&
        global.eden.fortress.armory <= 80 &&
        global.eden.fortress.patrols <= 15
        ? true
        : false;
    },
    ...
    effect() {
      return loc("tech_special_ops_training_effect", [
  ...
  elysanite_mining: {
    ...
    effect() {
      return loc("tech_elysanite_mining_effect", [
        global.resource.Elysanite.name,
      ]);
    },
    action() {
  ...
  elerium_cannon: {
    ...
    effect() {
      return loc("tech_elerium_cannon_effect", [
  ...
  elerium_containment: {
    ...
    effect() {
      return loc("tech_elerium_containment_effect", [
  ...
  otherworldly_cement: {
    ...
    effect() {
      return loc("tech_otherworldly_cement_effect", [
        global.resource.Cement.name,
      ]);
    },
    action() {
  ...
  ancient_crafters: {
    ...
    effect() {
      return loc("tech_ancient_crafters_effect", [
        actions.eden.eden_elysium.sacred_smelter.title(),
      ]);
    },
    action() {
      if (payCosts($(this)[0])) {
...
export function swissKnife(cheeseOnly, cheeseList) {
  ...
  let type =
    (global.stats.hasOwnProperty("reset") ? global.stats.reset : 0) %
    cheeses.length;
  return cheeseOnly
    ? loc(`cheese_${cheeses[type]}`)
    : loc(`tech_swiss_bank`, [loc(`cheese_${cheeses[type]}`)]);
}
...
export function techList(path) {
  if (path) {
    ...
    Object.keys(techs).forEach(function (t) {
      if (
        techPath[path].includes(techs[t].era) ||
        techs[t].hasOwnProperty("path")
      ) {
        if (
          !techs[t].hasOwnProperty("path") ||
          (techs[t].hasOwnProperty("path") && techs[t].path.includes(path))
        ) {
          techList[t] = techs[t];
        }
      }
