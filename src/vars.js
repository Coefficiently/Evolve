...
export function seededRandom(min, max, alt) {
  ...
  global[alt ? "warseed" : "seed"] =
    (global[alt ? "warseed" : "seed"] * 9301 + 49297) % 233280;
...
if (convertVersion(global["version"]) < 2060) {
  Object.keys(global.resource).forEach(function (res) {
    ...
    if (global.resource[res].containers) {
      global.resource[res].containers = Math.ceil(
        global.resource[res].containers / 5
      );
    }
  });
}
...
if (
  convertVersion(global["version"]) < 2062 &&
  global.civic.taxes !== undefined
) {
...
if (
  convertVersion(global["version"]) < 2065 &&
  global.race !== undefined &&
...
if (
  convertVersion(global["version"]) < 3004 &&
  global["settings"] &&
  global.settings["space"] &&
  global.settings.space.belt
) {
  global.space["space_station"] = { count: 0, on: 0, support: 0, s_max: 0 };
}

if (
  convertVersion(global["version"]) < 4001 &&
  global["city"] &&
  global.city["factory"] &&
...
if (
  convertVersion(global["version"]) < 4028 &&
  global.stats["achieve"] &&
  global.stats.achieve["genus_demonic"]
) {
  global.stats.achieve["biome_hellscape"] =
    global.stats.achieve["genus_demonic"];
}

if (
  convertVersion(global["version"]) < 4029 &&
  ...
  if (global.civic["craftsman"]) {
    ...
    if (global.city["foundry"]) {
      let workers =
        ...
        global.city.foundry.Brick +
        global.city.foundry.Wrought_Iron +
        global.city.foundry.Sheet_Metal +
        global.city.foundry.Mythril +
        global.city.foundry.Aerogel;
...
if (
  convertVersion(global["version"]) <= 5008 &&
  global["queue"] &&
  global["queue"]["queue"]
) {
  global.queue.queue = [];
...
if (
  convertVersion(global["version"]) <= 5016 &&
...
if (
  convertVersion(global["version"]) < 6004 &&
  global.city["windmill"] &&
...
if (
  convertVersion(global["version"]) < 6006 &&
  !global.city["windmill"] &&
  global.tech["wind_plant"] &&
  (global.race["soul_eater"] || global.race["carnivore"])
) {
...
if (
  convertVersion(global["version"]) <= 6008 &&
  global["r_queue"] &&
...
if (
  convertVersion(global["version"]) < 6016 &&
  global.stats &&
  global.stats["reset"] &&
  global.stats["achieve"]
) {
...
if (
  convertVersion(global["version"]) < 6020 &&
  global.race["mutation"] &&
...
if (
  convertVersion(global["version"]) < 7004 &&
  global["queue"] &&
  global["queue"]["queue"]
) {
...
if (
  convertVersion(global["version"]) < 7007 &&
  global["queue"] &&
  global["queue"]["queue"]
) {
  for (let i = 0; i < global.queue.queue.length; i++) {
...
if (convertVersion(global["version"]) < 7028) {
  if (
    global.stats["achieve"] &&
    global.stats.achieve["blood_war"] &&
    global.stats.achieve["blood_war"]["e"]
  ) {
...
if (convertVersion(global["version"]) < 8003) {
  if (global.stats["harmony"] && global.stats["harmony"] > 0) {
    ...
    global.race["Harmony"].count = parseFloat(
      global.race["Harmony"].count.toFixed(2)
    );
  }
}
...
if (convertVersion(global["version"]) < 9005) {
  if (
    global.race.hasOwnProperty("terrifying") &&
    global.tech.hasOwnProperty("gambling") &&
    !global.space.hasOwnProperty("spc_casino")
  ) {
...
if (convertVersion(global["version"]) < 9010) {
  ["species", "gods", "old_gods"].forEach((field) => {
    ...
    } // prior to 0.9.10 this was misspelled in the codebase
  });
  if (
    global.stats.hasOwnProperty("achieve") &&
    global.stats.achieve.hasOwnProperty("extinct_orge")
  ) {
...
if (convertVersion(global["version"]) < 9014) {
  ["seraph", "unicorn", "custom"].forEach((field) => {
    if (global.race.species === field) {
      if (
        (field === "custom" &&
          global.hasOwnProperty("custom") &&
          global.custom.race0.genus === "angelic") ||
        field !== "custom"
      ) {
        global.race["holy"] = 1;
      }
...
if (convertVersion(global["version"]) < 100000) {
  ...
  if (
    global.hasOwnProperty("settings") &&
    global.settings.portal &&
    global.settings.portal.spire &&
  ...
  if (
    ...
    !Array.isArray(global.portal.mechbay.mechs)
  ) {
  ...
  if (
    ...
    global.portal.transport.count >= 1 &&
...
if (convertVersion(global["version"]) < 100013) {
  if (
    global.hasOwnProperty("settings") &&
    global.settings.hasOwnProperty("showPowerGrid") &&
    global.hasOwnProperty("race") &&
    global.race["infiltrator"] &&
    global.hasOwnProperty("tech") &&
    global.tech.hasOwnProperty("high_tech") &&
...
if (convertVersion(global["version"]) < 100016) {
  ["l", "a", "e", "h", "m", "mg"].forEach(function (affix) {
    if (
      ...
      global.stats.spire[affix].hasOwnProperty("lord")
    ) {
  ...
  if (
    global.hasOwnProperty("special") &&
    global.special.hasOwnProperty("gift") &&
    global.special.gift
  ) {
...
if (convertVersion(global["version"]) < 100017) {
  if (
    global.hasOwnProperty("settings") &&
    !global.settings.hasOwnProperty("font")
  ) {
    ...
    if (!global.race["kindling_kindred"]) {
      ...
      if (global.interstellar["mass_ejector"]) {
        global.interstellar.mass_ejector.total -=
          global.interstellar.mass_ejector.Lumber;
...
if (convertVersion(global["version"]) < 100033) {
  if (
    global.hasOwnProperty("special") &&
    global.special.hasOwnProperty("egg")
  ) {
    global.special.egg["2020"] = JSON.parse(
      JSON.stringify(global.special["egg"])
    );
...
if (convertVersion(global["version"]) < 100040) {
  ...
  if (
    ...
    dt.getMonth() === 3 &&
    dt.getDate() <= 14 &&
    global.race.hasOwnProperty("species") &&
...
if (convertVersion(global["version"]) < 101000) {
  ...
  if (
    ...
    global.custom.race0.hasOwnProperty("genus") &&
    global.custom.race0.genus === "animal"
  ) {
  ...
  if (
    global.hasOwnProperty("stats") &&
    global.stats.hasOwnProperty("achieve") &&
    global.stats.achieve.hasOwnProperty("genus_animal")
  ) {
...
if (convertVersion(global["version"]) < 101001) {
  if (
    ...
    global.race.governor.hasOwnProperty("config") &&
    global.race.governor.config.hasOwnProperty("merc")
  ) {
...
if (convertVersion(global["version"]) < 101002) {
  if (global.race.hasOwnProperty("frenzy")) {
    ...
    if (
      global.city.hasOwnProperty("morale") &&
      global.city.morale.hasOwnProperty("frenzy")
    ) {
  ...
  if (
    global.hasOwnProperty("custom") &&
    global.custom.hasOwnProperty("race0") &&
    global.custom.race0.hasOwnProperty("traits")
  ) {
...
if (convertVersion(global["version"]) < 101010) {
  if (
    global.hasOwnProperty("settings") &&
    !global.settings.hasOwnProperty("q_merge")
  ) {
...
if (convertVersion(global["version"]) < 101011) {
  if (
    global.hasOwnProperty("settings") &&
    !global.settings.hasOwnProperty("msgFilters")
  ) {
    global.settings["msgFilters"] = {
      ...
      achievements:
        (global.stats["achieve"] &&
          Object.keys(global.stats.achieve).length > 0) ||
        (global.stats["feat"] && Object.keys(global.stats.feat).length > 0),
      hell:
        global.settings.showPortal ||
        global.stats.blackhole ||
        global.stats.ascend ||
...
if (convertVersion(global["version"]) < 101015) {
  if (
    global.hasOwnProperty("special") &&
    global.special.hasOwnProperty("trick")
  ) {
    global.special.trick["2020"] = JSON.parse(
      JSON.stringify(global.special["trick"])
    );
...
if (convertVersion(global["version"]) < 102000) {
  if (
    global.hasOwnProperty("portal") &&
    global.portal.hasOwnProperty("fortress") &&
    !global.portal.fortress.hasOwnProperty("nocrew")
  ) {
    global.portal.fortress["nocrew"] = false;
  }
  if (
    global.city.hasOwnProperty("smelter") &&
    !global.city.smelter.hasOwnProperty("Iridium")
  ) {
  ...
  if (
    global.hasOwnProperty("portal") &&
    global.portal.hasOwnProperty("mechbay") &&
    !global.portal.mechbay.hasOwnProperty("active")
  ) {
...
if (convertVersion(global["version"]) < 102012) {
  if (global.city.hasOwnProperty("ptrait")) {
    global.city.ptrait =
      global.city.ptrait === "none" ? [] : [global.city.ptrait];
  }
...
if (convertVersion(global["version"]) < 102017) {
  ...
  if (
    global.tech.hasOwnProperty("genetics") &&
    global.tech.genetics > 1 &&
    global.hasOwnProperty("arpa")
  ) {
...
if (convertVersion(global["version"]) < 102021) {
  if (
    ...
    let race = global.race.hasOwnProperty("species")
      ? global.race.species
      : "protoplasm";
    if (
      global.galaxy.hasOwnProperty("alien1") &&
      global.galaxy.alien1.id === "custom"
    ) {
      global.galaxy.alien1.id = race === "human" ? "elven" : "human";
    }
    if (
      global.galaxy.hasOwnProperty("alien2") &&
      global.galaxy.alien2.id === "custom"
    ) {
      global.galaxy.alien2.id =
        race === "orc" || global.galaxy.alien1.id === "orc" ? "cath" : "orc";
    }
  }
}
...
if (convertVersion(global["version"]) < 103000) {
  ...
  if (global.race.species === "protoplasm") {
    if (global.evolution.hasOwnProperty("sexual_reproduction")) {
      global.tech["evo"] =
        global.evolution.sexual_reproduction.count > 0 ? 2 : 1;
    ...
    [
      ...
      if (
        global.evolution.hasOwnProperty(step[0]) &&
        global.evolution[step[0]].count > 0
      ) {
...
if (convertVersion(global["version"]) < 103001) {
  ...
  if (
    !global.stats.hasOwnProperty("synth") &&
    global.race.hasOwnProperty("srace")
  ) {
    global.stats["synth"] = {};
  ...
  if (
    ...
    ["Infernite", "Elerium", "Copper", "Iron"].forEach(function (res) {
      if (
        ...
        typeof global.race.governor.config.trash[res] === "number"
      ) {
        global.race.governor.config.trash[res] = {
          v: global.race.governor.config.trash[res],
          s: true,
        };
      }
    });
...
if (convertVersion(global["version"]) < 103002) {
  if (
    global.portal.hasOwnProperty("observe") &&
    global.portal.observe.hasOwnProperty("stats")
  ) {
...
if (convertVersion(global["version"]) < 103011) {
  if (
    global.city.hasOwnProperty("slave_pen") &&
    global.city.slave_pen.hasOwnProperty("slaves")
  ) {
...
if (convertVersion(global["version"]) < 103014) {
  ...
  if (
    ...
    ((global.tauceti["tau_factory"] && global.tauceti.tau_factory.count > 0) ||
      (global.tauceti["womling_station"] &&
        global.tauceti.womling_station.count > 0))
  ) {
    global.civic.craftsman.display = true;
  }
}
...
if (convertVersion(global["version"]) <= 104000) {
  if (
    ...
    !global.city.shrine.hasOwnProperty("cycle")
  ) {
...
if (
  global.civic["cement_worker"] &&
  global.civic.cement_worker.impact === 0.25
) {
...
["all", "progress", "events", "major_events", "minor_events"].forEach(function (
  filter
) {
...
if (
  ...
  !global.interstellar.mass_ejector["Bolognium"]
) {
  global.interstellar.mass_ejector["Bolognium"] = 0;
}
if (
  global.interstellar["mass_ejector"] &&
  !global.interstellar.mass_ejector["Vitreloy"]
) {
  global.interstellar.mass_ejector["Vitreloy"] = 0;
}
if (
  global.interstellar["mass_ejector"] &&
  !global.interstellar.mass_ejector["Orichalcum"]
) {
  global.interstellar.mass_ejector["Orichalcum"] = 0;
}
if (
  global.interstellar["mass_ejector"] &&
  !global.interstellar.mass_ejector["Nanoweave"]
) {
  global.interstellar.mass_ejector["Nanoweave"] = 0;
}
if (
  global.interstellar["mass_ejector"] &&
  !global.interstellar.mass_ejector["Scarletite"]
) {
...
export function setupStats() {
  ...
  if (
    global.stats["death_tour"] &&
    !global.stats.death_tour.hasOwnProperty("md")
  ) {
...
if (
  ...
  global.custom.planet.hasOwnProperty("biome")
) {
...
if (
  global.city.hasOwnProperty("smelter") &&
  !global.city.smelter.hasOwnProperty("cap")
) {
...
if (
  typeof global.civic.foreign.gov0["name"] !== "undefined" &&
  global.civic.foreign.gov0.name.s1 === "evo_organism_title"
) {
  global.civic.foreign.gov0.name.s1 = "Northern";
}
if (
  typeof global.civic.foreign.gov1["name"] !== "undefined" &&
  global.civic.foreign.gov1.name.s1 === "evo_organism_title"
) {
  global.civic.foreign.gov1.name.s1 = "Southern";
}
if (
  typeof global.civic.foreign.gov2["name"] !== "undefined" &&
  global.civic.foreign.gov2.name.s1 === "evo_organism_title"
) {
...
if (
  ...
  const date = new Date();
  if (
    global.settings.hasOwnProperty("boring") &&
  ...
  if (
    ...
    Object.keys(global.special.gift).forEach(function (gy) {
      ...
      if (
        ...
        (cdate.getFullYear() === year && cdate.getMonth() !== 11)
      ) {
...
if (
  global.tech["fanaticism"] &&
  global.tech["theology"] &&
...
if (
  global["arpa"] &&
  global.arpa["launch_facility"] &&
  global.arpa.launch_facility.rank > 0 &&
  !global.tech["space"]
) {
  global.tech["space"] = 1;
}
...
var numFormatShort = new Intl.NumberFormat(undefined, {
  maximumFractionDigits: 2,
  maximumSignificantDigits: 3,
  roundingMode: "trunc",
  roundingPriority: "lessPrecision",
});
var numFormatLong = new Intl.NumberFormat(undefined, {
  maximumFractionDigits: 2,
 ...
 * @return {String}
 */
export function sizeApproximation(
  value,
  precision = 1,
  precise = false,
  exact = false
  ...
  //  The number of fractional digits is limited by the precision argument, but may be reduced for large values.
    ...
    let maxSigFigs = Math.max(
      oom + 1, // Full precision for the integer component of large numbers (at least 1e4)
      precision + 1, // Requested precision for values with only 1 leading digit
      5
    ); // Always allow 5 sigfigs, not only 4, for numbers where 1e2 <= x < 1e4
    return value.toLocaleString(undefined, {
...
window.soft_reset = function reset(source) {
  ...
  let replace = {
    ...
    ascended: global.race.hasOwnProperty("ascended")
      ? global.race.ascended
      : false,
    rejuvenated: global.race.hasOwnProperty("rejuvenated")
