...
export function hellPage(content) {
  ...
  mainContent.append(
    `<h2 class="header has-text-caution">${loc("wiki_hell")}</h2>`
  );
  ...
  let soul = infoBoxBuilder(mainContent, {
    name: "soul_gem",
    template: "hell",
    paragraphs: 4,
    para_data: {
  ...
  mainContent.append(
    `<h2 class="header has-text-caution">${loc("wiki_hell_deep")}</h2>`
  );
  ...
  mainContent.append(
    `<h2 class="header has-text-caution">${loc("portal_spire_name")}</h2>`
  );
  ...
  {
    // Spire Mech
    let mechs = infoBoxBuilder(mainContent, {
      name: "mech",
      template: "hell",
      paragraphs: 2,
      para_data: {
        2: [
          5,
          loc("portal_mech_size_small"),
          loc("portal_mech_size_medium"),
          loc("portal_mech_size_large"),
          loc("portal_mech_size_titan"),
          loc("portal_mech_size_collector"),
        ],
      },
    });

    let s_cost = mechCost("small");
    infoBoxBuilder(mechs, {
      name: "scout",
      template: "hell",
      paragraphs: 10,
      break: [3, 4, 5, 6, 10],
...

  {
    ...
    types.forEach(function (t) {
      typeList.push(loc(`portal_mech_chassis_${t}`));
    });
    ...
    terrains.forEach(function (t) {
      ...
      for (let i = 1; i <= types.length; i++) {
        let raws = +(
          terrainEffect({ chassis: types[i - 1], size: "small" }, t) * 100
        ).toFixed(1);
        let rawl = +(
          terrainEffect({ chassis: types[i - 1], size: "large" }, t) * 100
        ).toFixed(1);
        ratings[i + 1] = `${loc("wiki_hell_effectiveness", [
          `<span class="has-text-warning">${loc(
            `portal_mech_chassis_${types[i - 1]}`
          )}</span>`,
          `<span class="has-text-${
            raws >= 100 ? "success" : "danger"
          }">${raws}%</span>`,
          `<span class="has-text-${
            rawl >= 100 ? "success" : "danger"
          }">${rawl}%</span>`,
      ...
      infoBoxBuilder(mechs, {
        name: `t_${t}`,
        template: "hell",
        label: loc(`portal_spire_type_${t}`),
        paragraphs: 7,
        break: [2, 3, 4, 5, 6, 7],
        h_level: 4,
        header: true,
...

  {
    ...
    let mobs = infoBoxBuilder(mainContent, {
      name: "monsters",
      template: "hell",
      paragraphs: 4,
      para_data: {
    ...
    Object.keys(monsters).forEach(function (mob) {
      ...
      for (let i = 1; i <= weapons.length; i++) {
        let wep = +(
          (monsters[mob].weapon.hasOwnProperty(weapons[i - 1])
            ? monsters[mob].weapon[weapons[i - 1]]
            : 1) * 100
        ).toFixed(0);
        ratings[i] = `${loc("wiki_hell_weapon_effect", [
          `<span class="has-text-warning">${loc(
            `portal_mech_weapon_${weapons[i - 1]}`
          )}</span>`,
          `<span class="has-text-${
            wep >= 90 ? "success" : "danger"
          }">${wep}%</span>`,
        ])}`;
      }
      ...
      infoBoxBuilder(mobs, {
        name: `boss_${mob}`,
        template: "hell",
        label: loc(`portal_mech_boss_${mob}`),
        paragraphs: 8,
        break: [2, 3, 4, 5, 6, 7, 8],
        h_level: 4,
        header: true,
  ...
  {
    // Hazards
    let hazard = infoBoxBuilder(mainContent, {
      name: "hazard",
      template: "hell",
      paragraphs: 8,
      break: [3, 4, 5, 6, 7],
      para_data: {
        ...
        6: [
          `26/(1025-${loc("wiki_hell_hazard_para3_note")})`,
          `+1`,
          `251-1000`,
        ],
        7: [`-1`],
        8: [
          loc("portal_spire_status_freeze"),
          loc("portal_spire_status_hot"),
          loc("portal_spire_status_rain"),
          loc("portal_spire_status_hail"),
        ],
      },
    });
    ...
    infoBoxBuilder(hazard, {
      name: "h_freeze",
      template: "hell",
      label: loc(`portal_spire_status_freeze`),
      paragraphs: 2,
      break: [2],
      h_level: 4,
      header: true,
    ...
    infoBoxBuilder(hazard, {
      name: "h_hot",
      template: "hell",
      label: loc(`portal_spire_status_hot`),
      paragraphs: 2,
      break: [2],
      h_level: 4,
      header: true,
    ...
    infoBoxBuilder(hazard, {
      name: "h_corrosive",
      template: "hell",
      label: loc(`portal_spire_status_corrosive`),
      paragraphs: 3,
      break: [2, 3],
      h_level: 4,
      header: true,
    ...
    infoBoxBuilder(hazard, {
      name: "h_humid",
      template: "hell",
      label: loc(`portal_spire_status_humid`),
      paragraphs: 2,
      break: [2],
      h_level: 4,
      header: true,
    ...
    infoBoxBuilder(hazard, {
      name: "h_windy",
      template: "hell",
      label: loc(`portal_spire_status_windy`),
      paragraphs: 1,
      h_level: 4,
      header: true,
      text: {
    ...
    infoBoxBuilder(hazard, {
      name: "h_hilly",
      template: "hell",
      label: loc(`portal_spire_status_hilly`),
      paragraphs: 1,
      h_level: 4,
      header: true,
      text: {
    ...
    infoBoxBuilder(hazard, {
      name: "h_mountain",
      template: "hell",
      label: loc(`portal_spire_status_mountain`),
      paragraphs: 2,
      break: [2],
      h_level: 4,
      header: true,
      ...
      para_data: {
        1: [
          `50%`,
          loc(`portal_mech_chassis_spider`),
          loc(`portal_mech_equip_grapple`),
        ],
    ...
    infoBoxBuilder(hazard, {
      name: "h_radioactive",
      template: "hell",
      label: loc(`portal_spire_status_radioactive`),
      paragraphs: 2,
      break: [2],
      h_level: 4,
      header: true,
    ...
    infoBoxBuilder(hazard, {
      name: "h_quake",
      template: "hell",
      label: loc(`portal_spire_status_quake`),
      paragraphs: 2,
      break: [2],
      h_level: 4,
      header: true,
    ...
    infoBoxBuilder(hazard, {
      name: "h_dust",
      template: "hell",
      label: loc(`portal_spire_status_dust`),
      paragraphs: 2,
      break: [2],
      h_level: 4,
      header: true,
    ...
    infoBoxBuilder(hazard, {
      name: "h_river",
      template: "hell",
      label: loc(`portal_spire_status_river`),
      paragraphs: 1,
      h_level: 4,
      header: true,
      text: {
    ...
    infoBoxBuilder(hazard, {
      name: "h_tar",
      template: "hell",
      label: loc(`portal_spire_status_tar`),
      paragraphs: 2,
      break: [2],
      h_level: 4,
      header: true,
      ...
      para_data: {
        ...
        2: [
          `50%`,
          loc(`portal_mech_chassis_tread`),
          loc(`portal_mech_chassis_wheel`),
        ],
      },
    });
    ...
    infoBoxBuilder(hazard, {
      name: "h_steam",
      template: "hell",
      label: loc(`portal_spire_status_steam`),
      paragraphs: 2,
      break: [2],
      h_level: 4,
      header: true,
    ...
    infoBoxBuilder(hazard, {
      name: "h_flooded",
      template: "hell",
      label: loc(`portal_spire_status_flooded`),
      paragraphs: 1,
      h_level: 4,
      header: true,
      text: {
    ...
    infoBoxBuilder(hazard, {
      name: "h_fog",
      template: "hell",
      label: loc(`portal_spire_status_fog`),
      paragraphs: 2,
      break: [2],
      h_level: 4,
      header: true,
    ...
    infoBoxBuilder(hazard, {
      name: "h_rain",
      template: "hell",
      label: loc(`portal_spire_status_rain`),
      paragraphs: 2,
      break: [2],
      h_level: 4,
      header: true,
    ...
    infoBoxBuilder(hazard, {
      name: "h_hail",
      template: "hell",
      label: loc(`portal_spire_status_hail`),
      paragraphs: 1,
      h_level: 4,
      header: true,
      text: {
      ...
      para_data: {
        1: [
          `25%`,
          loc(`portal_mech_equip_ablative`),
          loc(`portal_mech_equip_shields`),
        ],
      },
    });
    ...
    infoBoxBuilder(hazard, {
      name: "h_chasm",
      template: "hell",
      label: loc(`portal_spire_status_chasm`),
      paragraphs: 2,
      break: [2],
      h_level: 4,
      header: true,
    ...
    infoBoxBuilder(hazard, {
      name: "h_dark",
      template: "hell",
      label: loc(`portal_spire_status_dark`),
      paragraphs: 3,
      break: [2, 3],
      h_level: 4,
      header: true,
    ...
    infoBoxBuilder(hazard, {
      name: "h_gravity",
      template: "hell",
      label: loc(`portal_spire_status_gravity`),
      paragraphs: 3,
      break: [2, 3],
      h_level: 4,
      header: true,
  ...
  {
    // Special Equipment
    let special = infoBoxBuilder(mainContent, {
      name: "equipment",
      template: "hell",
      paragraphs: 1,
      h_level: 2,
      para_data: {
        1: [
          loc(`portal_mech_equip_jumpjet`),
          loc(`portal_mech_equip_battery`),
          loc(`portal_mech_equip_target`),
        ],
      },
    });
    sideMenu("add", `hell-gameplay`, "equipment", loc("wiki_hell_equipment"));

    infoBoxBuilder(special, {
      name: `eq_jump`,
      template: "hell",
      label: loc(`portal_mech_equip_jumpjet`),
      paragraphs: 4,
      break: [4],
      h_level: 3,
      header: true,
      para_data: {
        1: [
          loc(`portal_mech_equip_jumpjet`),
          loc(`wiki_hell_scout`),
          loc(`wiki_hell_standard`),
          loc(`wiki_hell_collector`),
        ],
        2: [`20%`],
    ...
    infoBoxBuilder(special, {
      name: `eq_battery`,
      template: "hell",
      label: loc(`portal_mech_equip_battery`),
      paragraphs: 2,
      h_level: 3,
      header: true,
      para_data: {
    ...
    infoBoxBuilder(special, {
      name: `eq_target`,
      template: "hell",
      label: loc(`portal_mech_equip_target`),
      paragraphs: 3,
      h_level: 3,
      header: true,
      para_data: {
