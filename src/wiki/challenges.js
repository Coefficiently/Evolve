...
export function challengesPage(content) {
...

  {
    ...
    infoBoxBuilder(mainContent, {
      ...
      para_data: {
        ...
        3: [
          loc(`evo_challenge_genes`),
          loc(`evo_challenge_run`),
          loc(`evo_scenario`),
        ],
      },
      data_link: {
  ...
  {
    // Intro
    let genes = infoBoxBuilder(mainContent, {
      name: "genes_intro",
      template: "challenges",
      paragraphs: 5,
      break: [4],
    ...
    sideMenu(
      ...
      `challenges-gameplay`,
      "genes_intro",
      loc("wiki_challenges_genes_intro")
    );

    {
      // No Starting Plasmids
      infoBoxBuilder(genes, {
        name: "genes_plasmid",
        template: "challenges",
        paragraphs: 4,
        break: [4],
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "genes_plasmid",
        loc("wiki_challenges_genes_plasmid")
      );
    }

    {
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "genes_mastery",
        loc("wiki_challenges_genes_mastery")
      );
    }

    {
      ...
      infoBoxBuilder(genes, {
        ...
        para_data: {
          1: [
            ...
            loc(`wiki_challenges_gene`),
            loc(`resource_market_buy`),
            loc(`resource_market_sell`),
          ],
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "genes_trade",
        loc("wiki_challenges_genes_trade")
      );
    }

    {
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "genes_craft",
        loc("wiki_challenges_genes_craft")
      );
    }

    {
      // Junk Gene
      let crispr = infoBoxBuilder(genes, {
        name: "genes_crispr",
        template: "challenges",
        paragraphs: 2,
        h_level: 2,
      ...
      crispr
        .find(`div.para`)
        .append(`<span>${loc("wiki_challenges_genes_bad_para2")}</span>`);
      let traits = $(`
                <div class="para">
      ...
      neg_roll_traits.forEach(function (trait) {
        traits.append(
          `${
            comma ? ", " : ""
          }<a href="wiki.html#traits-species-major_${trait}" target="_blank" class="has-text-warning">${loc(
            "trait_" + trait + "_name"
          )}</a>`
        );
        comma = true;
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "genes_crispr",
        loc("wiki_challenges_genes_crispr")
      );
    }
...

    {
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "genes_weak",
        loc("wiki_challenges_genes_weak")
      );
    }
  }
  ...
  {
    // Intro
    let modes = infoBoxBuilder(mainContent, {
      name: "modes_intro",
      template: "challenges",
      paragraphs: 2,
      h_level: 2,
    ...
    sideMenu(
      ...
      `challenges-gameplay`,
      "modes_intro",
      loc("wiki_challenges_modes_intro")
    );

    {
      // Joyless
      let joyless = infoBoxBuilder(modes, {
        name: "modes_joyless",
        template: "challenges",
        paragraphs: 4,
        break: [3, 4],
        ...
        para_data: {
          1: [
            loc(`evo_challenge_joyless`),
            loc(`wiki_challenges_mode`),
            loc(`tech_theatre`),
          ],
          2: [
            loc(`job_entertainer`),
            loc(`morale_broadcast`),
            wardenLabel(),
            loc(`morale`),
          ],
          3: [
            loc(`wiki_challenges_mode`),
            actions.space.spc_red.biodome.title(),
            loc(`tech_theatre`),
          ],
          4: [
            loc(`wiki_challenges_scenarios_cataclysm`),
            loc(`wiki_challenges_scenario`),
          ],
        },
        data_link: {
          ...
          3: [
            false,
            "wiki.html#space-structures-biodome",
            "wiki.html#civilized-tech-theatre",
          ],
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "modes_joyless",
        loc("wiki_challenges_modes_joyless")
      );
    }

    {
      // Steelen
      let steelen = infoBoxBuilder(modes, {
        name: "modes_steelen",
        template: "challenges",
        paragraphs: 4,
        break: [4],
        ...
        para_data: {
          1: [
            loc(`evo_challenge_steelen`),
            loc(`wiki_challenges_mode`),
            loc("resource_Steel_name") + " " + loc("modal_smelting"),
            loc("resource_Steel_name"),
          ],
          2: [loc("resource_Steel_name")],
          3: [
            loc(`tech_steel`),
            loc(`tech_bessemer_process`),
            loc(`tech_oxygen_converter`),
            loc(`tech_electric_arc_furnace`),
          ],
          4: [loc(`wiki_challenges_mode`), loc(`wiki_resets_bioseed`)],
        },
        data_link: {
          3: [
            "wiki.html#civilized-tech-steel",
            "wiki.html#discovery-tech-bessemer_process",
            "wiki.html#industrialized-tech-oxygen_converter",
            "wiki.html#globalized-tech-electric_arc_furnace",
          ],
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "modes_steelen",
        loc("wiki_challenges_modes_steelen")
      );
    }

    {
      // Decay
      let decay = infoBoxBuilder(modes, {
        name: "modes_decay",
        template: "challenges",
        paragraphs: 6,
        break: [4, 6],
        ...
        para_data: {
          ...
          2: [
            ...
            loc(`wiki_calc_citizens`),
            loc(`resource_Knowledge_name`),
            loc(`resource_Zen_name`),
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "modes_decay",
        loc("wiki_challenges_modes_decay")
      );
    }

    {
      // EM Field
      let emfield = infoBoxBuilder(modes, {
        name: "modes_emfield",
        template: "challenges",
        paragraphs: 5,
        break: [5],
        ...
        para_data: {
          1: [
            loc(`evo_challenge_emfield`),
            loc(`wiki_challenges_mode`),
            `50%`,
            loc(`evo_challenge_discharge`),
            `50%`,
          ],
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "modes_emfield",
        loc("wiki_challenges_modes_emfield")
      );
    }

    {
      // Inflation
      let inflation = infoBoxBuilder(modes, {
        name: "modes_inflation",
        template: "challenges",
        paragraphs: 11,
        break: [4, 9, 10],
        h_level: 2,
        para_data: {
          ...
          10: [
            loc(`wiki_challenges_mode`),
            loc(`wiki_challenges_modes_inflation_para10_note1`),
          ],
          11: [loc(`evo_challenge_inflation`)],
        },
        data_link: {
          3: [
            "wiki.html#space-structures-world_collider",
    ...
    {
      // Failed Experiment
      let failed = infoBoxBuilder(modes, {
        name: "modes_sludge",
        template: "challenges",
        paragraphs: 7,
        break: [3, 4, 5, 6, 7],
        ...
        para_data: {
          1: [
            loc(`evo_challenge_sludge`),
            loc(`wiki_challenges_challenge`),
            loc(`race_sludge`),
          ],
      ...
      addAchievements(failed, false, ["extinct_sludge", "gross"], {
        gross: true,
      });
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "modes_sludge",
        loc("wiki_challenges_modes_sludge")
      );
    }

    {
      ...
      let failed = infoBoxBuilder(modes, {
        ...
        para_data: {
          1: [
            loc(`evo_challenge_ultra_sludge`),
            loc(`wiki_challenges_challenge`),
            loc(`race_ultra_sludge`),
          ],
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "modes_ultra_sludge",
        loc("wiki_challenges_modes_ultra_sludge")
      );
    }

    {
      // Orbital Decay
      let orbit = infoBoxBuilder(modes, {
        name: "modes_orbitdecay",
        template: "challenges",
        paragraphs: 14,
        break: [5, 8, 9, 10, 11, 12, 13, 14],
        h_level: 2,
        para_data: {
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "modes_orbitdecay",
        loc("wiki_challenges_modes_orbitdecay")
      );
    }

    {
      // Witch Hunter
      let witch = infoBoxBuilder(modes, {
        name: "modes_witchhunter",
        template: "challenges",
        paragraphs: 7,
        break: [4],
        h_level: 2,
      ...
      addRequirements(witch, [
        {
          ...
          subreqs: [
            {
              text: `${loc(`wiki_universe_magic`)} ${loc(
                `wiki_resets_ascension`
              )}`,
              color:
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "modes_witchhunter",
        loc("wiki_challenges_modes_witchhunter")
      );
    }

    {
      // Gravity Well
      let gravity = infoBoxBuilder(modes, {
        name: "modes_gravity_well",
        template: "challenges",
        paragraphs: 6,
        break: [4],
        h_level: 2,
      ...
      addRequirements(gravity, [
        {
          ...
          subreqs: [
            {
              text: `${loc(`wiki_universe_heavy`)} ${loc(
                `wiki_resets_bioseed`
              )}`,
              color:
                global.stats.achieve["seeder"] &&
                global.stats.achieve.seeder["h"]
                  ? true
                  : false,
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "modes_gravity_well",
        loc("wiki_challenges_modes_gravity_well")
      );
    }
  }
  ...
  {
    // Intro
    let scenarios = infoBoxBuilder(mainContent, {
      name: "scenarios_intro",
      template: "challenges",
      paragraphs: 3,
      h_level: 2,
      para_data: {
    ...
    sideMenu(
      ...
      `challenges-gameplay`,
      "scenarios_intro",
      loc("wiki_challenges_scenarios_intro")
    );

    {
      // Genetic Dead End
      let junker = infoBoxBuilder(scenarios, {
        name: "scenarios_junker",
        template: "challenges",
        paragraphs: 4,
        break: [3, 4],
        h_level: 2,
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "scenarios_junker",
        loc("wiki_challenges_scenarios_junker")
      );
    }

    {
      // Cataclysm
      let cataclysm = infoBoxBuilder(scenarios, {
        name: "scenarios_cataclysm",
        template: "challenges",
        paragraphs: 9,
        break: [4, 5, 6, 8, 9],
        h_level: 2,
        ...
        data_link: {
          ...
          8: [
            ...
            "wiki.html#resources-prestige-antiplasmids",
            false,
            false,
            "wiki.html#resources-prestige-phage",
          ],
    ...
    {
      // Banana Republic
      let banana = infoBoxBuilder(scenarios, {
        name: "scenarios_banana",
        template: "challenges",
        paragraphs: 18,
        break: [2, 4, 5, 8, 9, 10, 18],
        h_level: 2,
        para_data: {
          1: [
            loc(`evo_challenge_banana`),
            loc(`wiki_challenges_scenario`),
            loc(`resource_Money_name`),
            loc(`morale_tax`),
          ],
          ...
          4: [
            loc(`morale_tax`),
            `95%`,
            loc(`civics_tax_rates`),
            loc(`wiki_challenges_scenarios_banana_para4_note1`),
          ],
          5: [
            loc(`tab_market`),
            loc(`tech_sundial`),
          ...
          7: [
            loc(`resource_market_trade_routes`),
            10,
            25,
            loc(`tech_large_trades`),
            1000000,
            loc(`tech_massive_trades`),
          ],
        ...
        data_link: {
          ...
          5: [
            false,
            "wiki.html#primitive-tech-sundial",
            false,
            false,
            false,
            "wiki.html#civilized-tech-trade",
          ],
          7: [
            false,
            false,
            false,
            "wiki.html#civilized-tech-large_trades",
            false,
            "wiki.html#globalized-tech-massive_trades",
          ],
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "scenarios_banana",
        loc("wiki_challenges_scenarios_banana")
      );
    }

    {
      // Fasting
      let fasting = infoBoxBuilder(scenarios, {
        name: "scenarios_fasting",
        template: "challenges",
        paragraphs: 6,
        break: [1, 2, 3, 4, 5, 6],
        h_level: 2,
      ...
      subSideMenu(
        ...
        `challenges-gameplay`,
        "scenarios_fasting",
        loc("wiki_challenges_scenarios_fasting")
      );
    }

    {
      // True Path
      let truth = infoBoxBuilder(scenarios, {
        name: "scenarios_truepath",
        template: "challenges",
        paragraphs: 5,
        break: [5],
        h_level: 2,
      ...
      infoBoxBuilder(truth, {
        name: "scenarios_truepath_genes",
        template: "challenges",
        paragraphs: 1,
        h_level: 2,
        para_data: {
        ...
        data_link: {
          1: [
            "wiki.html#challenges-gameplay-genes_plasmid",
            "wiki.html#challenges-gameplay-genes_crispr",
            "wiki.html#challenges-gameplay-genes_bad",
            "wiki.html#challenges-gameplay-genes_weak",
          ],
        },
      });

      infoBoxBuilder(truth, {
        name: "scenarios_truepath_rival",
        template: "challenges",
        paragraphs: 5,
        break: [2, 3, 5],
        h_level: 2,
      ...
      infoBoxBuilder(truth, {
        name: "scenarios_truepath_syndicate",
        template: "challenges",
        paragraphs: 2,
        h_level: 2,
      });
      ...
      infoBoxBuilder(truth, {
        name: "scenarios_truepath_market",
        template: "challenges",
        paragraphs: 1,
        h_level: 2,
        para_data: {
      ...
      infoBoxBuilder(truth, {
        name: "scenarios_truepath_morale",
        template: "challenges",
        paragraphs: 1,
        h_level: 2,
        para_data: {
      ...
      infoBoxBuilder(truth, {
        name: "scenarios_truepath_foreign",
        template: "challenges",
        paragraphs: 1,
        h_level: 2,
      });
    ...
    {
      // Lone Survivor
      let lone = infoBoxBuilder(scenarios, {
        name: "scenarios_lone_survivor",
        template: "challenges",
        paragraphs: 4,
        break: [4],
        h_level: 2,
      ...
      subSideMenu(
        "add",
        `challenges-gameplay`,
        "scenarios_lone_survivor",
        loc("wiki_challenges_scenarios_lone_survivor")
      );
    }
  }
}
...
function addAchievements(content, feat, achievements, nolink) {
  ...
  let achieves = $(`
        <div class="reqs">
            <span class="has-text-caution">${loc(
              "wiki_challenges_" + (feat ? "feats" : "achievements")
            )}</span>
        </div>
    `);
  ...
  achievements.forEach(function (achieve) {
    let text = feat
      ? loc(`feat_${achieve}_name`)
      : nolink[achieve]
      ? loc(`achieve_${achieve}_name`)
      : `<a href="wiki.html#perks-prestige-${achieve}" target="_blank" class="has-text-warning">${loc(
          `achieve_${achieve}_name`
        )}</a>`;
    achieves.append(
      `${comma ? ", " : ""}<span class="has-text-warning">${text}</span>`
    );
    comma = true;
  });
}
...
function decayCalc(info) {
  ...
  var_input.append(`
        <div class="calcInput"><span>${loc(
          "wiki_calc_decay_amount"
        )}</span> <b-numberinput :input="val('amount')" min="0" v-model="i.amount.val" :controls="false"></b-numberinput></div>
    `);
  ...
  vBind({
    ...
    filters: {
      ...
      resLabel(res) {
        return res
          ? loc(`resource_${res}_name`)
          : loc("wiki_calc_decay_resource");
      },
      calc() {
        show.result.vis =
          inputs.resource.val !== undefined &&
          inputs.amount.val !== undefined &&
          inputs.amount.val >= 50;

        if (show.result.vis) {
          show.result.val =
            tradeRatio[inputs.resource.val] * 0.001 * (inputs.amount.val - 50);
...
function inflationCalc(info) {
  ...
  let show = {
    result: {
      ...
      cost: undefined,
      luxury: undefined,
      casino_prod: undefined,
      casino_store: undefined,
      bank_vault: undefined,
    },
  };
  ...
  formula.append(`
        ...
        <div>
            <h2 class="has-text-caution">${loc(
              "wiki_calc_inflation_casino_prod"
            )}</h2>
        </div>
        <div>
        ...
        <div>
            <h2 class="has-text-caution">${loc(
              "wiki_calc_inflation_casino_store"
            )}</h2>
        </div>
        <div>
        ...
        <div>
            <h2 class="has-text-caution">${loc(
              "wiki_calc_inflation_bank_vault"
            )}</h2>
        </div>
        <div>
  ...
  variables.append(`
        <div>
            <div class="calcInput"><span>${loc(
              "wiki_calc_inflation"
            )}</span> <b-numberinput :input="val('inflation')" min="0" v-model="i.inflation.val" :controls="false"></b-numberinput></div>
        </div>
        <div class="calcButton">
            <button class="button" @click="resetInputs()">${loc(
              "wiki_calc_reset"
