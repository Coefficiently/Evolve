...
export function mainEventsPage(content) {
  ...
  {
    // DNA Replication
    let section = infoBoxBuilder(mainContent, {
      name: "replication",
      template: "events",
      label: loc("wiki_events_replication"),
      paragraphs: 1,
      h_level: 2,
      para_data: {
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "replication_examples",
        template: "events",
        label: loc("wiki_events_replication"),
        h_level: 2,
        examples: [loc(`event_dna`, [10])],
      },
      section
    );
    sideMenu(
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "rna_meteor",
      template: "events",
      label: loc("wiki_events_rna_meteor"),
      paragraphs: 1,
      h_level: 2,
      para_data: {
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "rna_meteor_examples",
        template: "events",
        label: loc("wiki_events_rna_meteor"),
        h_level: 2,
        examples: [loc(`event_rna`, [22])],
      },
      section
    );
    sideMenu(
...

  {
    ...
    infoBoxBuilder(mainContent, {
      name: "inspiration",
      template: "events",
      label: loc("wiki_events_inspiration"),
      paragraphs: 1,
      h_level: 2,
      para_data: {
        1: [300, 600],
      },
      examples: [loc(`event_inspiration`)],
    });
    sideMenu(
      "add",
      `major-events`,
      `inspiration`,
      loc("wiki_events_inspiration")
    );
  }

  {
    ...
    infoBoxBuilder(mainContent, {
      name: "motivation",
      template: "events",
      label: loc("wiki_events_motivation"),
      paragraphs: 3,
      h_level: 2,
      para_data: {
        1: [300, 600],
      ...
      examples: [loc(`event_motivation`)],
    });
    sideMenu(
      "add",
      `major-events`,
      `motivation`,
      loc("wiki_events_motivation")
    );
  }

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        ...
        label: loc("wiki_events_fire"),
        h_level: 2,
        examples: [loc(`event_fire`, [(1337).toLocaleString()])],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "terrorist",
      template: "events",
      label: loc("wiki_events_terrorist"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "pillage_examples",
        template: "events",
        label: loc("wiki_events_pillage"),
        h_level: 2,
        examples: [
          loc(`event_pillaged1`, [
            loc(`civics_gov2`, [loc(`civics_gov_name4`)]),
            10,
            55,
          ]),
          loc(`event_pillaged2`, [
            loc(`civics_gov6`, [loc(`civics_gov_name9`)]),
            40,
            25,
            [
        ...
        examples: [
          loc("event_quake", [
            global.race["cataclysm"] || global.race["orbit_decayed"]
              ? races[global.race.species].solar.red
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "dhorde_examples",
        template: "events",
        label: loc("wiki_events_dhorde"),
        h_level: 2,
        examples: [loc("event_demon_influx", [(3456).toLocaleString()])],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "taxrevolt",
      template: "events",
      label: loc("wiki_events_taxrevolt"),
      paragraphs: 2,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "taxrevolt_examples",
        template: "events",
        label: loc("wiki_events_taxrevolt"),
        h_level: 2,
        examples: [loc("event_tax_revolt")],
      },
      section
    );
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        ...
        label: loc("wiki_events_spy"),
        h_level: 2,
        examples: [loc(`event_spy`, [govTitle(1)])],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "mine_collapse",
      template: "events",
      label: loc("wiki_events_mine_collapse"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "mine_collapse_examples",
        template: "events",
        label: loc("wiki_events_mine_collapse"),
        h_level: 2,
        examples: [loc(`event_mine_collapse`)],
      },
      section
    );
    sideMenu(
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "m_curious",
      template: "events",
      label: loc("wiki_events_m_curious"),
      paragraphs: 6,
      break: [2, 3, 4, 5, 6],
      h_level: 2,
      para_data: {
        2: [
          loc("wiki_events_m_curious_para2_note1", [
            (50000).toLocaleString(),
            (5000000).toLocaleString(),
          ...
          loc("wiki_events_m_curious_para2_note2", [
            1,
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "m_curious_examples",
        template: "events",
        label: loc("wiki_events_m_curious"),
        h_level: 2,
        examples: [
          loc(`event_m_curious0`, [
            races[global.race.species].name,
            (444015).toLocaleString(),
            loc("resource_Alloy_name"),
          ]),
...
export function minorEventsPage(content) {
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "slave_escape",
      template: "events",
      label: loc("wiki_events_slave_escape"),
      paragraphs: 2,
      break: [2],
      h_level: 2,
    });
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "shooting_star",
      template: "events",
      label: loc("wiki_events_shooting_star"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "shooting_star_examples",
        template: "events",
        label: loc("wiki_events_shooting_star"),
        h_level: 2,
        examples: [loc(`event_shooting_star`)],
      },
      section
    );
    sideMenu(
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "tumbleweed",
      template: "events",
      label: loc("wiki_events_tumbleweed"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "tumbleweed_examples",
        template: "events",
        label: loc("wiki_events_tumbleweed"),
        h_level: 2,
        examples: [loc(`event_tumbleweed`)],
      },
      section
    );
    sideMenu(
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "flashmob",
      template: "events",
      label: loc("wiki_events_flashmob"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "flashmob_examples",
        template: "events",
        label: loc("wiki_events_flashmob"),
        h_level: 2,
        examples: [loc(`event_flashmob`)],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "heatwave",
      template: "events",
      label: loc("wiki_events_heatwave"),
      paragraphs: 1,
      h_level: 2,
      para_data: {
        1: [loc(`hot`)],
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "heatwave_examples",
        template: "events",
        label: loc("wiki_events_heatwave"),
        h_level: 2,
        examples: [loc(`event_heatwave`)],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "coldsnap",
      template: "events",
      label: loc("wiki_events_coldsnap"),
      paragraphs: 1,
      h_level: 2,
      para_data: {
        1: [loc(`cold`)],
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "coldsnap_examples",
        template: "events",
        label: loc("wiki_events_coldsnap"),
        h_level: 2,
        examples: [loc(`event_coldsnap`)],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "cucumber",
      template: "events",
      label: loc("wiki_events_cucumber"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "cucumber_examples",
        template: "events",
        label: loc("wiki_events_cucumber"),
        h_level: 2,
        examples: [loc(`event_cucumber`)],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "planking",
      template: "events",
      label: loc("wiki_events_planking"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "planking_examples",
        template: "events",
        label: loc("wiki_events_planking"),
        h_level: 2,
        examples: [loc(`event_planking`)],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "furryfish",
      template: "events",
      label: loc("wiki_events_furryfish"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "furryfish_examples",
        template: "events",
        label: loc("wiki_events_furryfish"),
        h_level: 2,
        examples: [loc(`event_furryfish`)],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "meteor_shower",
      template: "events",
      label: loc("wiki_events_meteor_shower"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "meteor_shower_examples",
        template: "events",
        label: loc("wiki_events_meteor_shower"),
        h_level: 2,
        examples: [loc(`event_meteor_shower`)],
      },
      section
    );
    sideMenu(
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "bloodrain",
      template: "events",
      label: loc("wiki_events_bloodrain"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "bloodrain_examples",
        template: "events",
        label: loc("wiki_events_bloodrain"),
        h_level: 2,
        examples: [loc(`event_bloodrain`)],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "haunting",
      template: "events",
      label: loc("wiki_events_haunting"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "haunting_examples",
        template: "events",
        label: loc("wiki_events_haunting"),
        h_level: 2,
        examples: [loc(`event_haunting`)],
      },
      section
    );
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "mothman_examples",
        template: "events",
        label: loc("wiki_events_mothman"),
        h_level: 2,
        examples: [loc(`event_mothman`)],
      },
      section
    );
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "dejavu_examples",
        template: "events",
        label: loc("wiki_events_dejavu"),
        h_level: 2,
        examples: [loc(`event_dejavu`)],
      },
      section
    );
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "dollar_examples",
        template: "events",
        label: loc("wiki_events_dollar"),
        h_level: 2,
        examples: [loc(`event_dollar`, [6])],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "pickpocket",
      template: "events",
      label: loc("wiki_events_pickpocket"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "pickpocket_examples",
        template: "events",
        label: loc("wiki_events_pickpocket"),
        h_level: 2,
        examples: [loc(`event_pickpocket`, [9])],
      },
      section
    );
    sideMenu(
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "contest_examples",
        template: "events",
        label: loc("wiki_events_contest"),
        h_level: 2,
        examples: [
          loc(`event_contest`, [
            loc("event_contest_place0"),
            loc("event_contest_type0"),
          ]),
          loc(`event_contest`, [
            loc("event_contest_place1"),
            loc("event_contest_type1"),
          ]),
          loc(`event_contest`, [
            loc("event_contest_place2"),
            loc("event_contest_type2"),
          ]),
          loc(`event_contest`, [
            loc("event_contest_place0"),
            loc("event_contest_type3"),
          ]),
          loc(`event_contest`, [
            loc("event_contest_place1"),
            loc("event_contest_type4"),
          ]),
          loc(`event_contest`, [
            loc("event_contest_place2"),
            loc("event_contest_type5"),
          ]),
          loc(`event_contest`, [
            loc("event_contest_place0"),
            loc("event_contest_type6"),
          ]),
          loc(`event_contest`, [
            loc("event_contest_place1"),
            loc("event_contest_type7"),
          ]),
          loc(`event_contest`, [
            loc("event_contest_place2"),
            loc("event_contest_type8"),
          ]),
          loc(`event_contest`, [
            loc("event_contest_place0"),
            loc("event_contest_type9"),
          ]),
        ],
      },
      section
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "dark_cloud",
      template: "events",
      label: loc("wiki_events_dark_cloud"),
      paragraphs: 1,
      h_level: 2,
      para_data: {
        1: [loc(`rain`), loc(`snow`)],
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "dark_cloud_examples",
        template: "events",
        label: loc("wiki_events_dark_cloud"),
        h_level: 2,
        examples: [loc(`event_dark_cloud`)],
      },
      section
    );
    sideMenu(
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "tracks_examples",
        template: "events",
        label: loc("wiki_events_tracks"),
        h_level: 2,
        examples: [loc(`event_tracks`)],
      },
      section
    );
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "burial_examples",
        template: "events",
        label: loc("wiki_events_burial"),
        h_level: 2,
        examples: [loc(`event_burial`)],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "artifacts",
      template: "events",
      label: loc("wiki_events_artifacts"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "artifacts_examples",
        template: "events",
        label: loc("wiki_events_artifacts"),
        h_level: 2,
        examples: [loc(`event_artifacts`)],
      },
      section
    );
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "parade_examples",
        template: "events",
        label: loc("wiki_events_parade"),
        h_level: 2,
        examples: [loc(`event_parade`)],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "crop_circle",
      template: "events",
      label: loc("wiki_events_crop_circle"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "crop_circle_examples",
        template: "events",
        label: loc("wiki_events_crop_circle"),
        h_level: 2,
        examples: [loc(`event_crop_circle`)],
      },
      section
    );
    sideMenu(
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        ...
        para_data: {
          1: [
            loc(`trait_carnivore_name`),
            loc(`trait_soul_eater_name`),
            loc(`trait_detritivore_name`),
            loc(`trait_artifical_name`),
          ],
        },
        data_link: {
          1: [
            "wiki.html#traits-species-genus_carnivore",
            "wiki.html#traits-species-special_soul_eater",
            "wiki.html#traits-species-genus_detritivore",
            "wiki.html#traits-species-genus_artifical",
          ],
        },
      },
      section
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "compass_examples",
        template: "events",
        label: loc("wiki_events_compass"),
        h_level: 2,
        examples: [loc(`event_compass`)],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "delicacy",
      template: "events",
      label: loc("wiki_events_delicacy"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "delicacy_examples",
        template: "events",
        label: loc("wiki_events_delicacy"),
        h_level: 2,
        examples: [loc(`event_delicacy`)],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "graffiti",
      template: "events",
      label: loc("wiki_events_graffiti"),
      paragraphs: 1,
      h_level: 2,
    });
    infoBoxBuilder(
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "graffiti_examples",
        template: "events",
        label: loc("wiki_events_graffiti"),
        h_level: 2,
        examples: [loc(`event_graffiti`)],
      },
      section
    );
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "cheese_examples",
        template: "events",
        label: loc("wiki_events_cheese"),
        h_level: 2,
        examples: [loc(`event_cheese`)],
      },
      section
    );
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        name: "tremor_examples",
        template: "events",
        label: loc("wiki_events_tremor"),
        h_level: 2,
        examples: [loc(`event_tremor`)],
      },
      section
    );
...
export function progressEventsPage(content) {
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      ...
      para_data: {
        ...
        2: [
          loc(`space_belt_iron_ship_title`),
      ...
      data_link: {
        ...
        2: [
          "wiki.html#space-structures-iron_ship",
          "wiki.html#space-structures-iridium_ship",
        ],
      },
      examples: [loc(`discover_elerium`)],
    });
    ...
    let section = infoBoxBuilder(mainContent, {
      ...
      para_data: {
        1: [
          ...
          getSolarName("gas_moon"),
          loc(`space_gas_moon_oil_extractor_title`),
        ],
      ...
      examples: [loc(`discover_oil`, [getSolarName("gas_moon")])],
    });
...

  {
    ...
    infoBoxBuilder(
      mainContent,
      {
        ...
        examples: [loc(`portal_hell_pit_found`)],
      },
      section
    );
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      ...
      template: "events",
      label: loc("wiki_events_alien_encounter"),
      paragraphs: 2,
      break: [2],
      h_level: 2,
      para_data: {
        1: [
          loc(`galaxy_scout_ship`),
          loc(`tech_xeno_linguistics`),
          loc(`galaxy_corvette_ship`),
        ],
        2: [`10%`],
      },
      data_link: {
        1: [
          "wiki.html#intergalactic-structures-scout_ship",
          "wiki.html#intergalactic-tech-xeno_linguistics",
          "wiki.html#intergalactic-tech-corvette_ship",
        ],
      },
    });
    infoBoxBuilder(
      mainContent,
      {
        name: "alien_encounter_condition",
        template: "events",
        label: loc("wiki_events_alien_encounter"),
        paragraphs: 1,
        h_level: 2,
    ...
    sideMenu(
      ...
      `progress-events`,
      `alien_encounter`,
      loc("wiki_events_alien_encounter")
    );
  }
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "alien_database",
      template: "events",
      label: loc("wiki_events_alien_database"),
      paragraphs: 2,
      break: [2],
      h_level: 2,
      para_data: {
      ...
      examples: [loc(`galaxy_scavenger_find`)],
    });
    sideMenu(
      "add",
      `progress-events`,
      `alien_database`,
      loc("wiki_events_alien_database")
    );
  }

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "corrupt_gem",
      template: "events",
      label: loc("wiki_events_corrupt_gem"),
      paragraphs: 4,
      break: [2],
      h_level: 2,
      para_data: {
        ...
        2: [
          loc(`resource_Soul_Gem_name`),
          loc(`portal_soul_forge_title`),
          loc(`portal_soul_attractor_title`),
        ],
    ...
    infoBoxBuilder(
      mainContent,
      {
        ...
        examples: [loc(`portal_corrupt_gem`)],
      },
      section
    );
    sideMenu(
...

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "vault_find",
      template: "events",
      label: loc("wiki_events_vault_find"),
      paragraphs: 3,
      break: [2],
      h_level: 2,
      para_data: {
        1: [
          loc(`job_archaeologist`),
          loc(`portal_vault_title`),
          loc(`portal_ruins_name`),
        ],
        2: [loc(`job_archaeologist`), `2.5%`],
        3: [
          loc(`job_archaeologist`),
          loc(`portal_ruins_supressed`),
          loc(`portal_ruins_name`),
          `0%`,
          `2.5%`,
          `100%`,
      ...
      examples: [loc(`portal_ruins_vault`)],
    });
    sideMenu(
      "add",
      `progress-events`,
      `vault_find`,
      loc("wiki_events_vault_find")
    );
  }

  {
    ...
    let section = infoBoxBuilder(mainContent, {
      name: "syndicate",
      template: "events",
      label: loc("wiki_events_syndicate"),
      paragraphs: 2,
      break: [2],
      h_level: 2,
      para_data: {
    ...
    infoBoxBuilder(
      mainContent,
      {
        ...
        examples: [
          loc(`outer_syndicate`, [
            loc(`civics_gov5`, [loc(`civics_gov_name1`)]),
          ]),
        ],
      },
      section
...
export function specialEventsPage(content) {
...

    {
      ...
      let section = infoBoxBuilder(mainContent, {
        ...
        para_data: {
          ...
          5: [
            loc("trait_hyper_name"),
            loc("trait_fast_growth_name"),
            loc("trait_rainbow_name"),
            loc("trait_optimistic_name"),
          ],
          7: [
            loc("trait_cannibalize_name"),
            loc("trait_rage_name"),
            loc("trait_blood_thirst_name"),
            loc("trait_sticky_name"),
          ],
        },
      });
      ...
      let eggs = `<div class="has-text-warning">${loc(
        "wiki_feat_egghunt_found"
      )}</div>`;
      eggs = eggs + `<div class="tbl">`;
      for (let i = 1; i <= 18; i++) {
        let egg =
          global.special.egg.hasOwnProperty(year) &&
          global.special.egg[year][`egg${i}`]
            ? "has-text-success"
            : "has-text-danger";
        let found =
          global.special.egg.hasOwnProperty(year) &&
        ...
        let hint = `<span class="tcell">${loc("wiki_events_hint_avail")} ${loc(
          `month${easter.hintDate[0]}`
        )} ${easter.hintDate[1]}</span>`;
        if (easter.hint) {
        ...
        let sol = `<span class="tcell">${loc("wiki_events_sol_avail")} ${loc(
          `month${easter.solveDate[0]}`
        )} ${easter.solveDate[1]}</span>`;
        if (easter.solve) {
          sol = `<span class="tcell eggsol has-text-warning" data-sol="${
            solutions[i - 1]
          }">${loc("wiki_events_reveal_sol")}</span>`;
        }

        eggs =
          eggs +
          `<div class="trow"><span role="img" class="tcell ${egg}" aria-label="${loc(
            "wiki_feat_egghunt_num",
            [i]
          )} ${found}">${loc("wiki_feat_egghunt_num", [
            i,
          ])}</span>${hint}${sol}</div>`;
      }
      eggs = eggs + `</div>`;
      ...
      infoBoxBuilder(
        mainContent,
        {
          ...
          para_data: {
            1: [
              `${loc(`month${easter.date[0]}`)} ${easter.date[1]}`,
              `${loc(`month${easter.endDate[0]}`)} ${easter.endDate[1]}`,
            ],
          },
        },
        section
  ...
  {
    // Solstice
    let thermite = global.hasOwnProperty("stats")
      ? 100000 + global.stats.reset * 9000
      : 100000;
    if (thermite > 1000000) {
      thermite = 1000000;
    }
...

  {
    ...
    let treats = `<div class="has-text-warning">${loc(
      "wiki_feat_trick_found"
    )}</div>`;
    treats = treats + `<div class="tbl">`;
    for (let i = 1; i <= candy_hints.length; i++) {
      let treat =
        global.special.trick.hasOwnProperty(year) &&
        global.special.trick[year][`treat${i}`]
          ? "has-text-success"
          : "has-text-danger";
      let found =
        global.special.trick.hasOwnProperty(year) &&
      ...
      let hint = `<span class="tcell">${loc("wiki_events_hint_avail")} ${loc(
        `month${halloween.hintDate[0]}`
      )} ${halloween.hintDate[1]}</span>`;
      if (halloween.hint) {
      ...
      treats =
        treats +
        `<div class="trow"><span role="img" class="tcell ${treat}" aria-label="${loc(
          "wiki_feat_treat_num",
          [i]
        )} ${found}">${loc("wiki_feat_treat_num", [i])}</span>${hint}</div>`;

      let sol = `<span class="tcell">${loc("wiki_events_sol_avail")} ${loc(
        `month${halloween.solveDate[0]}`
      )} ${halloween.solveDate[1]}</span>`;
      if (halloween.solve) {
        sol = `<span class="tcell totsol has-text-warning" data-sol="${
          candy_solutions[i - 1]
        }">${loc("wiki_events_reveal_sol")}</span>`;
      }

      treats =
        treats + `<div class="trow"><span class="tcell"></span>${sol}</div>`;
    }
    treats = treats + `</div>`;
    section.append(treats);

    let tricks = `<div class="has-text-warning">${loc(
      "wiki_feat_treat_found"
    )}</div>`;
    tricks = tricks + `<div class="tbl">`;
    for (let i = 1; i <= ghost_hints.length; i++) {
      let trick =
        global.special.trick.hasOwnProperty(year) &&
        global.special.trick[year][`trick${i}`]
          ? "has-text-success"
          : "has-text-danger";
      let found =
        global.special.trick.hasOwnProperty(year) &&
      ...
      tricks =
        tricks +
        `<div class="trow"><span role="img" class="tcell ${trick}" aria-label="${loc(
          "wiki_feat_trick_num",
          [i]
        )} ${found}">${loc("wiki_feat_trick_num", [i])}</span>${hint}</div>`;
      ...
      tricks =
        tricks + `<div class="trow"><span class="tcell"></span>${sol}</div>`;
    }
    tricks = tricks + `</div>`;
    ...
    ["human", "tortoisan", "unicorn"].forEach(function (species) {
      infoBoxBuilder(section, {
        name: species,
        template: `events_${event}`,
        label: loc(`wiki_events_${event}`),
        paragraphs: 2,
        h_level: 0,
        para_data: {
    ...
    infoBoxBuilder(
      mainContent,
      {
        ...
        para_data: {
          1: [
            `${loc(`month${halloween.date[0]}`)} ${halloween.date[1]}`,
            `${loc(`month${halloween.endDate[0]}`)} ${halloween.endDate[1]}`,
          ],
        },
      },
      section
...

  {
    ...
    ["elven", "centaur", "capybara", "wendigo", "yeti", "entish"].forEach(
      function (species) {
        infoBoxBuilder(section, {
          name: species,
          template: `events_${event}`,
