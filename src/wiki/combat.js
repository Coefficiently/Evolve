...
export function combatPage(content) {
  ...
  infoBoxBuilder(mainContent, {
    name: "campaign",
    template: "combat",
    label: loc("wiki_combat_campaign"),
    paragraphs: 14,
    break: [5, 11],
    h_level: 2,
    para_data: {
      1: [
        5,
        loc("civics_garrison_tactic_ambush"),
        loc("civics_garrison_tactic_raid"),
        loc("civics_garrison_tactic_pillage"),
        loc("civics_garrison_tactic_assault"),
  ...
  infoBoxBuilder(mainContent, {
    name: "loot",
    template: "combat",
    label: loc("wiki_combat_loot"),
    paragraphs: 30,
    break: [3, 5, 10, 13, 16, 19, 22, 26, 27, 28, 29, 30],
    h_level: 2,
    para_data: {
      2: [
        3,
        loc("civics_garrison_campaign"),
        loc("civics_gov_eco_rate"),
        loc("civics_garrison_battalion"),
      ],
      3: [loc("civics_garrison_campaign")],
      4: [
        4,
        loc("wiki_combat_loot_money"),
        loc("wiki_combat_loot_basic"),
        loc("wiki_combat_loot_common"),
      ...
      8: [
        loc("wiki_universe_magic"),
        loc("wiki_combat_loot_rare"),
        loc("resource_Crystal_name"),
        loc("trait_terrifying_name"),
      ...
      11: [
        loc("trait_beast_of_burden_name"),
        loc("wiki_combat_loot_money"),
        loc("wiki_combat_loot_basic"),
        loc("wiki_combat_loot_common"),
      ],
