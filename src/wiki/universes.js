...
export function universePage(content) {
  ...
  infoBoxBuilder(mainContent, {
    ...
    para_data: {
      ...
      3: [
        loc("wiki_p_res_dark"),
        +((darkEffect("standard", false, true) - 1) * 100).toFixed(3) + "%",
      ],
    },
    data_color: {
      1: ["caution"],
  ...
  sideMenu(
    ...
    `universes-gameplay`,
    "standard",
    loc("wiki_universe_standard")
  );

  let heavy_space =
    +((1.25 + 0.5 * darkEffect("heavy", false, true) - 1) * 100).toFixed(3) +
    "%";
  let heavy_int =
    +((1.2 + 0.3 * darkEffect("heavy", false, true) - 1) * 100).toFixed(3) +
    "%";
  infoBoxBuilder(mainContent, {
    name: "heavy",
    template: "universe",
    ...
    data_link: {
      6: [
        ...
        "wiki.html#resources-prestige-dark",
      ],
  ...
  infoBoxBuilder(mainContent, {
    ...
    para_data: {
      ...
      9: [
        loc("wiki_p_res_dark"),
        +((darkEffect("antimatter", false, true) - 1) * 100).toFixed(3) + "%",
      ],
    },
    data_color: {
      1: ["caution"],
  ...
  infoBoxBuilder(mainContent, {
    ...
    para_data: {
      ...
      7: [
        loc("wiki_p_res_dark"),
        +((darkEffect("evil", false, true) - 1) * 100).toFixed(3) + "%",
      ],
    },
  });
  ...
  infoBoxBuilder(mainContent, {
    ...
    para_data: {
      ...
      5: [
        loc("wiki_p_res_dark"),
        darkEffect("micro", false, true),
        darkEffect("micro", true, true),
      ],
      6: ["1.005"],
    },
  });
  ...
  infoBoxBuilder(mainContent, {
    ...
    para_data: {
      ...
      8: [
        loc("wiki_p_res_dark"),
        +((darkEffect("magic", false, true) - 1) * 100).toFixed(3) + "%",
      ],
    },
  });
