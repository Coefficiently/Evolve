...
const extraInformation = {
  ...
  housing: [loc(`wiki_tech_building_unlock`, [housingLabel("small")])],
  cottage: [loc(`wiki_tech_building_unlock`, [housingLabel("medium")])],
  captive_housing: [
    loc(`wiki_tech_building_unlock`, [loc("city_captive_housing")]),
  ],
  torture: [
    // displayed as "torment"
    loc(`wiki_tech_job_unlock`, [loc(`job_torturer`)]),
  ],
  thrall_quarters: [loc("wiki_tech_thrall_quarters")],
  psychic_stun: [loc("wiki_tech_psychic_stun")],
  psychic_attack: [loc("wiki_tech_psychic_attack")],
  psychic_finance: [loc("wiki_tech_psychic_finance")],
  psychic_channeling: [loc("wiki_tech_psychic_channeling")],
  psychic_efficiency: [loc("wiki_tech_psychic_efficiency")],
  mind_break: [loc("wiki_tech_mind_break")],
  psychic_energy: [
  ...
  apartment: [loc(`wiki_tech_building_unlock`, [housingLabel("large")])],
  arcology: [loc(`wiki_tech_building_unlock`, [loc(`portal_arcology_title`)])],
  steel_beams: [
    loc(`wiki_tech_steel_beams`, [
      housingLabel("small"),
      housingLabel("medium"),
    ]),
  ],
  ...
  aphrodisiac: [loc(`wiki_tech_aphrodisiac`)],
  fertility_clinic: [loc(`wiki_tech_fertility_clinic`)],
  smokehouse: [loc(`wiki_tech_building_unlock`, [loc(`city_smokehouse`)])],
  lodge: [loc(`wiki_tech_building_unlock`, [loc(`city_lodge`)])],
  alt_lodge: [loc(`wiki_tech_building_unlock`, [loc(`city_lodge`)])],
  soul_well: [loc(`wiki_tech_building_unlock`, [loc(`city_soul_well`)])],
  compost: [loc(`wiki_tech_building_unlock`, [loc(`city_compost_heap`)])],
  hot_compost: [loc(`wiki_tech_hot_compost`, [100])],
  mulching: [loc(`wiki_tech_hot_compost`, [50])],
  adv_mulching: [loc(`wiki_tech_hot_compost`, [33.33])],
  agriculture: [loc(`wiki_tech_building_unlock`, [loc(`city_farm`)])],
  farm_house: [loc(`wiki_tech_farm_house`)],
  irrigation: [loc(`wiki_tech_irrigation`)],
  silo: [loc(`wiki_tech_building_unlock`, [loc(`city_silo`)])],
  mill: [loc(`wiki_tech_building_unlock`, [loc(`city_mill_title1`)])],
  windmill: [loc(`wiki_tech_windmill1`), loc(`wiki_tech_windmill2`)],
  windturbine: [loc(`wiki_tech_windturbine`)],
  wind_plant: [loc(`wiki_tech_building_unlock`, [loc(`city_mill_title2`)])],
  evil_wind_plant: [
    loc(`wiki_tech_building_unlock`, [loc(`city_mill_title2`)]),
  ],
  gmfood: [loc(`wiki_tech_gmfood`)],
  foundry: [loc(`wiki_tech_building_unlock`, [loc(`city_foundry`)])],
  artisans: [loc(`wiki_tech_artisans`)],
  apprentices: [loc(`wiki_tech_apprentices`)],
  carpentry: [loc(`wiki_tech_carpentry`)],
  demonic_craftsman: [loc(`wiki_tech_master_craftsman`)],
  master_craftsman: [loc(`wiki_tech_master_craftsman`)],
  brickworks: [loc(`wiki_tech_brickworks`)],
  machinery: [loc(`wiki_tech_machinery`)],
  cnc_machine: [loc(`wiki_tech_cnc_machine`)],
  vocational_training: [loc(`wiki_tech_vocational_training`)],
  stellar_forge: [
  ...
  theatre: [loc(`wiki_tech_building_unlock`, [loc(`city_amphitheatre`)])],
  playwright: [loc(`wiki_tech_entertain1`, [2])],
  magic: [loc(`wiki_tech_entertain1`, [3])],
  superstars: [loc(`wiki_tech_entertain2`, [1])],
  radio: [loc(`wiki_tech_entertain3`, [1])],
  tv: [loc(`wiki_tech_entertain3`, [2])],
  vr_center: [
    loc(`wiki_tech_building_unlock`, [loc(`space_red_vr_center_title`)]),
    loc(`wiki_tech_entertain3`, [3]),
  ],
  zoo: [loc(`wiki_tech_building_unlock`, [loc(`tech_zoo`)])],
  casino: [loc(`wiki_tech_building_unlock`, [loc(`city_casino`)])],
  dazzle: [loc(`wiki_tech_dazzle`, [50])],
  casino_vault: [loc(`wiki_tech_casino_vault`, [40000, 60000])],
  otb: [loc(`wiki_tech_otb`)],
  online_gambling: [
    loc(`wiki_tech_dazzle`, [33.33]),
    loc(`wiki_tech_casino_vault`, [60000, 120000]),
  ],
  bolognium_vaults: [loc(`wiki_tech_casino_vault`, [120000, 240000])],
  mining: [loc(`wiki_tech_building_unlock`, [loc(`city_rock_quarry`)])],
  bayer_process: [
    loc(`wiki_tech_building_unlock`, [loc(`city_metal_refinery`)]),
  ],
  elysis_process: [loc(`wiki_tech_elysis_process`)],
  smelting: [loc(`wiki_tech_building_unlock`, [loc(`city_smelter`)])],
  steel: [loc(`wiki_tech_steel`)],
  blast_furnace: [loc(`wiki_tech_smelt_boost1`, [loc(`resource_Iron_name`)])],
  bessemer_process: [
  ...
  hellfire_furnace: [loc(`wiki_tech_smelt_boost2`)],
  infernium_fuel: [
    loc(`wiki_tech_fuel_unlock`, [loc(`modal_smelter_inferno`)]),
  ],
  iridium_smelting_perk: [loc(`wiki_tech_iridium_smelting`)],
  rotary_kiln: [loc(`wiki_tech_rotary_kiln`)],
  metal_working: [loc(`wiki_tech_building_unlock`, [loc(`city_mine`)])],
  iron_mining: [
  ...
  storage: [loc(`wiki_tech_building_unlock`, [loc(`city_shed_title1`)])],
  reinforced_shed: [
    loc(`wiki_tech_store_upgrade`, [loc(`city_shed_title1`), 125]),
  ],
  barns: [
    loc(`wiki_tech_name_change`, [
  ...
  cameras: [loc(`wiki_tech_store_upgrade`, [loc(`city_shed_title3`), 26])],
  pocket_dimensions: [
    loc(`wiki_tech_store_upgrade`, [loc(`city_shed_title3`), 21]),
    loc(`wiki_tech_pocket_dimensions`),
  ],
  ai_logistics: [loc(`wiki_tech_ai_logistics`)],
  containerization: [
    loc(`wiki_tech_building_unlock`, [loc(`city_storage_yard`)]),
  ],
  reinforced_crates: [
    loc(`wiki_tech_containerized_upgrade`, [
  ...
  steel_containers: [loc(`wiki_tech_building_unlock`, [loc(`city_warehouse`)])],
  gantry_crane: [
    loc(`wiki_tech_cranes`, [
      loc(`city_warehouse`),
  ...
  evil_planning: [loc(`wiki_tech_urban_planning`)],
  urban_planning: [loc(`wiki_tech_urban_planning`)],
  zoning_permits: [
  ...
  assistant: [loc(`wiki_tech_assistant`)],
  government: [loc(`wiki_tech_government`)],
  theocracy: [loc(`wiki_tech_gov_unlock`, [loc(`govern_theocracy`)])],
  republic: [loc(`wiki_tech_gov_unlock`, [loc(`govern_republic`)])],
  socialist: [loc(`wiki_tech_gov_unlock`, [loc(`govern_socialist`)])],
  corpocracy: [loc(`wiki_tech_gov_unlock`, [loc(`govern_corpocracy`)])],
  technocracy: [loc(`wiki_tech_gov_unlock`, [loc(`govern_technocracy`)])],
  federation: [loc(`wiki_tech_gov_unlock`, [loc(`govern_federation`)])],
  magocracy: [loc(`wiki_tech_gov_unlock`, [loc(`govern_magocracy`)])],
  governor: [loc(`wiki_tech_governor`)],
  spy: [loc(`wiki_tech_spy`)],
  espionage: [loc(`wiki_tech_espionage`)],
  spy_training: [loc(`wiki_tech_spy_training`)],
  spy_gadgets: [loc(`wiki_tech_spy_gadgets`)],
  code_breakers: [loc(`wiki_tech_code_breakers`)],
  currency: [loc(`wiki_tech_resource_unlock`, [loc(`resource_Money_name`)])],
  market: [
    loc(`wiki_tech_subtab_unlock`, [loc(`tab_market`), loc(`tab_resources`)]),
  ],
  tax_rates: [loc(`wiki_tech_tax_rates`)],
  large_trades: [loc(`wiki_tech_large_trades`, [5000, 100])],
  corruption: [loc(`wiki_tech_corruption`)],
  massive_trades: [loc(`wiki_tech_large_trades`, [1000000, 1000000])],
  trade: [loc(`wiki_tech_building_unlock`, [loc(`city_trade`)])],
  diplomacy: [loc(`wiki_tech_diplomacy`)],
  freight: [loc(`wiki_tech_freight`)],
  wharf: [loc(`wiki_tech_building_unlock`, [loc(`city_wharf`)])],
  banking: [loc(`wiki_tech_building_unlock`, [loc(`city_bank`)])],
  investing: [loc(`wiki_tech_job_unlock`, [loc(`job_banker`)])],
  vault: [loc(`wiki_tech_vault`, [1800, 4000])],
  bonds: [loc(`wiki_tech_bonds`, [250])],
  steel_vault: [loc(`wiki_tech_vault`, [4000, 9000])],
  eebonds: [loc(`wiki_tech_bonds`, [600])],
  swiss_banking: [loc(`wiki_tech_swiss_banking`)],
  safety_deposit: [loc(`wiki_tech_safety_deposit`)],
  stock_market: [
    loc(`wiki_tech_project_unlock`, [
      loc(`arpa_projects_stock_exchange_title`),
    ]),
  ],
  hedge_funds: [loc(`wiki_tech_hedge_funds`)],
  four_oh_one: [loc(`wiki_tech_bonds`, [1000])],
  exchange: [
  ...
  crypto_currency: [loc(`wiki_tech_crypto_currency`)],
  mythril_vault: [loc(`wiki_tech_vault`, [9000, 15000])],
  neutronium_vault: [loc(`wiki_tech_vault`, [15000, 22500])],
  adamantite_vault: [loc(`wiki_tech_vault`, [22500, 30000])],
  graphene_vault: [loc(`wiki_tech_vault`, [30000, 37500])],
  home_safe: [
  ...
  tourism: [loc(`wiki_tech_building_unlock`, [loc(`city_tourist_center`)])],
  xeno_tourism: [loc(`wiki_tech_xeno_tourism`)],
  science: [loc(`wiki_tech_building_unlock`, [loc(`city_university`)])],
  library: [loc(`wiki_tech_building_unlock`, [loc(`city_library`)])],
  thesis: [loc(`wiki_tech_thesis`)],
  research_grant: [loc(`wiki_tech_research_grant`)],
  scientific_journal: [loc(`wiki_tech_scientific_journal`)],
  adjunct_professor: [loc(`wiki_tech_adjunct_professor`)],
  tesla_coil: [loc(`wiki_tech_tesla_coil`)],
  internet: [
  ...
  virtual_assistant: [loc(`wiki_tech_virtual_assistant`)],
  ...
  quantum_entanglement: [loc(`wiki_tech_quantum_entanglement`)],
  expedition: [loc(`wiki_tech_expedition`)],
  subspace_sensors: [loc(`wiki_tech_subspace_sensors`)],
  orichalcum_capacitor: [loc(`wiki_tech_orichalcum_capacitor`)],
  advanced_biotech: [loc(`wiki_tech_advanced_biotech`)],
  codex_infinium: [loc(`wiki_tech_codex_infinium`)],
  hell_oven: [loc("wiki_tech_building_unlock", [loc("portal_oven_title")])],
  preparation_methods: [
  ...
  final_ingredient: [loc("wiki_tech_final_ingredient")],
  bioscience: [loc(`wiki_tech_building_unlock`, [loc(`city_biolab`)])],
  genetics: [
    loc(`wiki_tech_subtab_unlock`, [
      loc(`tab_arpa_genetics`),
      loc(`tech_arpa`),
    ]),
  ],
  crispr: [
  ...
  shotgun_sequencing: [loc(`wiki_tech_shotgun_sequencing`)],
  de_novo_sequencing: [loc(`wiki_tech_de_novo_sequencing`)],
  dna_sequencer: [loc(`wiki_tech_dna_sequencer`)],
  rapid_sequencing: [loc(`wiki_tech_rapid_sequencing`)],
  mad_science: [
  ...
  fission: [loc(`wiki_tech_building_unlock`, [loc(`city_fission_power`)])],
  arpa: [
    loc(`wiki_tech_tab_unlock`, [loc(`tech_arpa`)]),
    loc(`wiki_tech_subtab_unlock`, [
      loc(`tab_arpa_projects`),
      loc(`tech_arpa`),
    ]),
  ...
  rocketry: [
    loc(`wiki_tech_project_unlock`, [
      loc(`arpa_projects_launch_facility_title`),
    ]),
  ],
  quantum_computing: [loc(`wiki_tech_quantum_computing`)],
  virtual_reality: [
    loc(`wiki_tech_gov_upgrade`, [loc("govern_autocracy")]),
    loc(`wiki_tech_gov_upgrade`, [loc("govern_democracy")]),
    loc(`wiki_tech_gov_upgrade`, [loc("govern_oligarchy")]),
  ...
  shields: [
    loc(`wiki_tech_destination_unlock`, [
      loc(`space_mission_title`, [loc(`interstellar_neutron_name`)]),
      loc(`interstellar_neutron_name`),
    ]),
    loc(`wiki_tech_destination_unlock`, [
      loc(`space_mission_title`, [loc(`interstellar_blackhole_name`)]),
      loc(`interstellar_blackhole_name`),
    ]),
  ],
  ai_core: [
  ...
  cybernetics: [loc(`wiki_tech_cybernetics`)],
  blood_pact: [
    loc(`wiki_tech_subtab_unlock`, [loc("tab_arpa_blood"), loc(`tech_arpa`)]),
  ],
  purify: [loc(`wiki_tech_purify`)],
  waygate: [loc(`wiki_tech_building_unlock`, [loc(`portal_waygate_title`)])],
  demonic_infusion: [loc(`wiki_tech_demonic_infusion`)],
  dark_bomb: [
  ...
  hell_search: [
    loc(`wiki_tech_destination_unlock`, [
      loc(`portal_ruins_mission_title`),
      loc(`portal_ruins_name`),
    ]),
    loc(`wiki_tech_hell_search`),
    loc(`wiki_tech_building_unlock`, [loc(`portal_guard_post_title`)]),
  ],
  lake_threat: [loc(`wiki_tech_building_unlock`, [loc(`portal_bireme_title`)])],
  lake_transport: [
  ...
  miasma: [loc(`wiki_tech_building_unlock`, [loc(`portal_port_title`)])],
  tech_ascension: [
    loc(`wiki_tech_destination_unlock`, [
      loc(`space_mission_title`, [loc(`interstellar_sirius_name`)]),
      loc(`interstellar_sirius_b_name`),
    ]),
  ],
  cement_processing: [loc(`wiki_tech_cement_processing`)],
  adamantite_processing: [loc(`wiki_tech_adamantite_processing`)],
  graphene_processing: [loc(`wiki_tech_graphene_processing`)],
  crypto_mining: [loc(`wiki_tech_crypto_mining`)],
  fusion_power: [
  ...
  thermomechanics: [loc(`wiki_tech_thermomechanics`)],
  quantum_manufacturing: [loc(`wiki_tech_quantum_manufacturing`)],
  worker_drone: [
    loc(`wiki_tech_building_unlock`, [loc(`space_gas_moon_drone_title`)]),
  ],
  uranium: [loc(`wiki_tech_resource_unlock`, [loc(`resource_Uranium_name`)])],
  uranium_storage: [loc(`wiki_tech_uranium_storage`)],
  uranium_ash: [loc(`wiki_tech_uranium_ash`)],
  breeder_reactor: [loc(`wiki_tech_breeder_reactor`)],
  mine_conveyor: [
  ...
  oil_well: [loc(`wiki_tech_building_unlock`, [loc(`city_oil_well`)])],
  oil_depot: [loc(`wiki_tech_building_unlock`, [loc(`city_oil_depot`)])],
  oil_power: [loc(`wiki_tech_building_unlock`, [loc(`city_oil_power`)])],
  titanium_drills: [loc(`wiki_tech_titanium_drills`)],
  alloy_drills: [loc(`wiki_tech_alloy_drills`)],
  fracking: [loc(`wiki_tech_fracking`)],
  mythril_drills: [loc(`wiki_tech_mythril_drills`)],
  mass_driver: [loc(`wiki_tech_building_unlock`, [loc(`city_mass_driver`)])],
  orichalcum_driver: [
  ...
  fluidized_bed_reactor: [loc(`wiki_tech_fluidized_bed_reactor`)],
  synthetic_fur: [loc(`wiki_tech_factory_unlock`, [loc(`resource_Furs_name`)])],
  nanoweave: [
  ...
  pillars: [loc(`wiki_tech_pillars`)],
  reclaimer: [
    loc(`wiki_tech_job_unlock`, [loc(`job_reclaimer`)]),
    loc(`wiki_tech_building_unlock`, [loc(`city_graveyard`)]),
  ],
  shovel: [loc(`wiki_tech_shovel`, [40])],
  iron_shovel: [loc(`wiki_tech_shovel`, [80])],
  steel_shovel: [loc(`wiki_tech_shovel`, [120])],
  titanium_shovel: [loc(`wiki_tech_shovel`, [160])],
  alloy_shovel: [loc(`wiki_tech_shovel`, [200])],
  mythril_shovel: [loc(`wiki_tech_shovel`, [240])],
  adamantite_shovel: [loc(`wiki_tech_shovel`, [280])],
  stone_axe: [loc(`wiki_tech_building_unlock`, [loc(`city_lumber_yard`)])],
  copper_axes: [loc(`wiki_tech_copper_axes`, [35])],
  iron_saw: [loc(`wiki_tech_building_unlock`, [loc(`city_sawmill`)])],
  steel_saw: [loc(`wiki_tech_steel_saw`)],
  iron_axes: [loc(`wiki_tech_copper_axes`, [70])],
  steel_axes: [loc(`wiki_tech_copper_axes`, [105])],
  titanium_axes: [loc(`wiki_tech_copper_axes`, [140])],
  chainsaws: [loc(`wiki_tech_copper_axes`, [175])],
  copper_sledgehammer: [loc(`wiki_tech_copper_sledgehammer`, [40])],
  iron_sledgehammer: [loc(`wiki_tech_copper_sledgehammer`, [80])],
  steel_sledgehammer: [loc(`wiki_tech_copper_sledgehammer`, [120])],
  titanium_sledgehammer: [loc(`wiki_tech_copper_sledgehammer`, [160])],
  copper_pickaxe: [
  ...
  copper_hoe: [loc(`wiki_tech_copper_hoe`, [33.33])],
  iron_hoe: [loc(`wiki_tech_copper_hoe`, [66.67])],
  steel_hoe: [loc(`wiki_tech_copper_hoe`, [100])],
  titanium_hoe: [loc(`wiki_tech_copper_hoe`, [133.33])],
  adamantite_hoe: [loc(`wiki_tech_copper_hoe`, [166.67])],
  cyber_limbs: [loc(`wiki_tech_cyber_limbs`)],
  slave_pens: [
    loc(`wiki_tech_building_unlock`, [
      loc(`city_slave_housing`, [global.resource.Slave.name]),
    ]),
  ],
  slave_market: [loc(`wiki_tech_slave_market`)],
  ceremonial_dagger: [loc(`wiki_tech_ceremonial_dagger`, [600, 1500])],
  last_rites: [loc(`wiki_tech_ceremonial_dagger`, [1800, 3600])],
  ancient_infusion: [loc(`wiki_tech_ceremonial_dagger`, [5400, 16200])],
  garrison: [loc(`wiki_tech_building_unlock`, [loc(`city_garrison`)])],
  mercs: [loc(`wiki_tech_mercs`)],
  signing_bonus: [loc(`wiki_tech_signing_bonus`)],
  hospital: [loc(`wiki_tech_building_unlock`, [loc(`city_hospital`)])],
  bac_tanks: [
    loc(`wiki_tech_bac_tanks`, [
      races[global.race.species].type === "synthetic"
        ? loc(`city_boot_camp_art`)
        : loc(`tech_hospital`),
      10,
    ]),
  ],
  boot_camp: [loc(`wiki_tech_building_unlock`, [loc(`city_boot_camp`)])],
  vr_training: [
  ...
  bows: [loc(`wiki_tech_bows`, [100])],
  flintlock_rifle: [loc(`wiki_tech_bows`, [200])],
  machine_gun: [loc(`wiki_tech_bows`, [300])],
  bunk_beds: [loc(`wiki_tech_bunk_beds`)],
  rail_guns: [loc(`wiki_tech_bows`, [400])],
  laser_rifles: [loc(`wiki_tech_bows`, [500])],
  plasma_rifles: [loc(`wiki_tech_bows`, [600])],
  disruptor_rifles: [loc(`wiki_tech_bows`, [700])],
  gauss_rifles: [loc(`wiki_tech_bows`, [800])],
  cyborg_soldiers: [loc(`wiki_tech_bows`, [900])],
  ethereal_weapons: [loc(`wiki_tech_bows`, [1000])],
  space_marines: [
  ...
  armor: [loc(`wiki_tech_armor`, [1])],
  plate_armor: [loc(`wiki_tech_armor`, [2])],
  kevlar: [loc(`wiki_tech_armor`, [3])],
  nanoweave_vest: [loc(`wiki_tech_armor`, [4])],
  laser_turret: [
    loc(`wiki_tech_name_change`, [
      loc(`portal_turret_title1`),
      loc(`portal_turret_title2`),
    ]),
  ...
  mad: [loc(`wiki_tech_mad`)],
  cement: [loc(`wiki_tech_building_unlock`, [loc(`city_cement_plant`)])],
  rebar: [loc(`wiki_tech_rebar`, [10])],
  steel_rebar: [loc(`wiki_tech_rebar`, [20])],
  portland_cement: [loc(`wiki_tech_portland_cement`)],
  screw_conveyor: [
    loc(`wiki_tech_power_upgrade`, [loc(`city_cement_plant`), 2]),
    loc(`wiki_tech_screw_conveyor`, [5]),
  ],
  adamantite_screws: [loc(`wiki_tech_screw_conveyor`, [8])],
  otherworldly_binder: [loc(`wiki_tech_otherworldly_binder`)],
  hunter_process: [
  ...
  matter_compression: [
    loc(`wiki_tech_matter_compression`, [
      loc(`resource_Crates_name`),
      loc(`city_storage_yard`),
    ]),
    loc(`wiki_tech_matter_compression`, [
  ...
  higgs_boson: [loc(`wiki_tech_higgs_boson`)],
  dimensional_compression: [loc(`wiki_tech_dimensional_compression`)],
  theology: [loc(`wiki_tech_building_unlock`, [loc(`city_temple`)])],
  fanaticism: [loc(`wiki_tech_fanaticism`)],
  alt_fanaticism: [loc(`wiki_tech_fanaticism`)],
  ancient_theology: [
    loc(`wiki_tech_building_unlock`, [loc(`space_red_ziggurat_title`)]),
  ],
  study: [loc(`wiki_tech_study`)],
  encoding: [loc(`wiki_tech_encoding`)],
  deify: [loc(`wiki_tech_deify`)],
  infusion: [loc(`wiki_tech_infusion`)],
  indoctrination: [
    global.race["no_plasmid"]
      ? loc(`wiki_tech_indoctrination2`)
      : loc(`wiki_tech_indoctrination1`),
  ],
  missionary: [loc(`wiki_tech_missionary`)],
  zealotry: [loc(`wiki_tech_zealotry`)],
  anthropology: [
    global.race["no_plasmid"]
      ? loc(`wiki_tech_anthropology2`)
      : loc(`wiki_tech_anthropology1`),
  ],
  alt_anthropology: [
    global.race["no_plasmid"]
      ? loc(`wiki_tech_anthropology2`)
  ...
  mythology: [loc(`wiki_tech_mythology`)],
  archaeology: [loc(`wiki_tech_archaeology`)],
  merchandising: [loc(`wiki_tech_merchandising`)],
  astrophysics: [
    loc(`wiki_tech_building_unlock`, [
      loc(`space_home_propellant_depot_title`),
    ]),
  ],
  rover: [
    loc(`wiki_tech_destination_unlock`, [
      loc(`space_moon_mission_title`),
      loc(`space_moon_info_name`),
    ]),
  ],
  probes: [
    loc(`wiki_tech_destination_unlock`, [
      loc(`space_mission_title`, [getSolarName("red")]),
      getSolarName("red"),
    ]),
    loc(`wiki_tech_destination_unlock`, [
      loc(`space_mission_title`, [getSolarName("hell")]),
      getSolarName("hell"),
    ]),
    loc(`wiki_tech_gov_time`),
  ],
  starcharts: [
    loc(`wiki_tech_destination_unlock`, [
      loc(`space_mission_title`, [loc(`space_sun_info_name`)]),
      loc(`space_sun_info_name`),
    ]),
    loc(`wiki_tech_destination_unlock`, [
      loc(`space_mission_title`, [getSolarName("gas")]),
      getSolarName("gas"),
    ]),
  ],
  colonization: [
  ...
  red_tower: [loc(`wiki_tech_building_unlock`, [loc(`space_red_tower_title`)])],
  space_manufacturing: [
  ...
  hydroponics: [loc(`wiki_tech_hydroponics`)],
  dyson_swarm: [
  ...
  space_sourced: [loc(`wiki_tech_space_sourced`)],
  swarm_plant_ai: [loc(`wiki_tech_swarm_plant_ai`)],
  swarm_control_ai: [loc(`wiki_tech_swarm_control_ai`)],
  quantum_swarm: [loc(`wiki_tech_quantum_swarm`)],
  perovskite_cell: [loc(`wiki_tech_perovskite_cell`, [0.5])],
  swarm_convection: [loc(`wiki_tech_perovskite_cell`, [0.65])],
  orichalcum_panels: [loc(`wiki_tech_perovskite_cell`, [0.8])],
  dyson_net: [
    loc(`wiki_tech_building_unlock`, [loc(`interstellar_dyson_title`)]),
  ],
  dyson_sphere2: [
    loc(`wiki_tech_name_change`, [
      loc(`interstellar_dyson_title`),
      loc(`interstellar_dyson_sphere_title`),
    ]),
    loc(`wiki_tech_dyson_sphere2`),
  ],
  orichalcum_sphere: [loc(`wiki_tech_dyson_sphere2`)],
  elysanite_sphere: [loc(`wiki_tech_elysanite_sphere`)],
  gps: [loc(`wiki_tech_building_unlock`, [loc(`space_home_gps_title`)])],
  nav_beacon: [
    loc(`wiki_tech_building_unlock`, [loc(`space_home_nav_beacon_title`)]),
  ],
  subspace_signal: [loc(`wiki_tech_subspace_signal`, [getSolarName("red")])],
  atmospheric_mining: [
    loc(`wiki_tech_building_unlock`, [loc(`space_gas_mining_title`)]),
    loc(`wiki_tech_building_unlock`, [
      loc(`space_gas_storage_title`, [getSolarName("gas")]),
    ]),
  ],
  helium_attractor: [loc(`wiki_tech_helium_attractor`)],
  ram_scoops: [loc(`wiki_tech_ram_scoops`)],
  elerium_prospecting: [
    loc(`wiki_tech_building_unlock`, [
      loc(`interstellar_elerium_prospector_title`),
    ]),
  ],
  zero_g_mining: [
  ...
  laser_mining: [
    loc(`wiki_tech_laser_mining`, [
      loc(`space_belt_elerium_ship_title`),
      0.0075,
      0.005,
    ]),
    loc(`wiki_tech_laser_mining`, [
      loc(`space_belt_iridium_ship_title`),
      0.08,
      0.055,
    ]),
  ...
  elerium_tech: [
    loc(`wiki_tech_destination_unlock`, [
      loc(`space_mission_title`, [getSolarName("dwarf")]),
      getSolarName("dwarf"),
    ]),
  ],
  elerium_reactor: [
  ...
  neutronium_housing: [loc(`wiki_tech_neutronium_housing`)],
  unification2: [
  ...
  interstellar: [loc(`wiki_tech_interstellar`)],
  genesis_ship: [loc(`wiki_tech_genesis_ship`)],
  genetic_decay: [loc(`wiki_tech_genetic_decay`)],
  stabilize_decay: [loc(`wiki_tech_stabilize_decay`)],
  warp_drive: [
    loc(`wiki_tech_subtab_unlock`, [loc(`tab_interstellar`), loc(`tab_civil`)]),
    loc(`wiki_tech_destination_unlock`, [
      loc(`space_mission_title`, [loc(`interstellar_alpha_name`)]),
  ...
  aerogel: [loc(`wiki_tech_resource_unlock`, [loc(`resource_Aerogel_name`)])],
  mega_manufacturing: [
    loc(`wiki_tech_building_unlock`, [loc(`interstellar_int_factory_title`)]),
  ],
  luxury_condo: [loc(`wiki_tech_building_unlock`, [loc(`tech_luxury_condo`)])],
  stellar_engine: [
  ...
  asteroid_redirect: [
    loc(`wiki_tech_project_unlock`, [
      loc(`arpa_projects_roid_eject_title`, [
        loc(`arpa_projects_roid_eject_asteroid`),
      ]),
    ]),
  ],
  exotic_infusion: [loc(`wiki_tech_confirmation`)],
  infusion_check: [loc(`wiki_tech_confirmation`)],
  infusion_confirm: [loc(`wiki_tech_infusion_confirm`)],
  stabilize_blackhole: [
    loc(`wiki_tech_stabilize_blackhole1`),
    loc(`wiki_tech_stabilize_blackhole2`),
    loc(`wiki_tech_stabilize_blackhole3`),
  ],
  mana_syphon: [loc(`wiki_tech_project_unlock`, [loc(`arpa_syphon_title`)])],
  gravity_convection: [loc(`wiki_tech_gravitational_convection`)],
  wormholes: [
  ...
  advanced_predators: [loc(`wiki_tech_advanced_predators`)],
  enhanced_droids: [loc(`wiki_tech_enhanced_droids`)],
  sensor_drone: [
    loc(`wiki_tech_building_unlock`, [loc(`portal_sensor_drone_title`)]),
  ],
  map_terrain: [loc(`wiki_tech_map_terrain`)],
  calibrated_sensors: [loc(`wiki_tech_calibrated_sensors`, [20])],
  shield_generator: [loc(`wiki_tech_shield_generator`)],
  enhanced_sensors: [
  ...
  xeno_linguistics: [
    loc(`wiki_tech_destination_unlock`, [
      loc(`galaxy_gorddon_mission`),
      loc(`galaxy_gorddon`),
    ]),
  ],
  xeno_culture: [loc(`wiki_tech_building_unlock`, [loc(`galaxy_embassy`)])],
  cultural_exchange: [
    loc(`wiki_tech_building_unlock`, [loc(`galaxy_dormitory`)]),
    loc(`wiki_tech_building_unlock`, [loc(`galaxy_symposium`)]),
  ],
  shore_leave: [loc(`wiki_tech_shore_leave`)],
  xeno_gift: [
    loc(`wiki_tech_xeno_gift`, [
      global.galaxy["alien1"]
        ? races[global.galaxy.alien1.id].name
        : loc(`galaxy_alien1_proxy`),
    ]),
  ...
  embassy_housing: [loc(`wiki_tech_embassy_housing`)],
  advanced_telemetry: [loc(`wiki_tech_advanced_telemetry`)],
  defense_platform: [
    loc(`wiki_tech_building_unlock`, [loc(`galaxy_defense_platform`)]),
  ],
  scout_ship: [loc(`wiki_tech_building_unlock`, [loc(`galaxy_scout_ship`)])],
  corvette_ship: [
  ...
  dreadnought: [loc(`wiki_tech_building_unlock`, [loc(`galaxy_dreadnought`)])],
  ship_dock: [loc(`wiki_tech_building_unlock`, [loc(`galaxy_ship_dock`)])],
  ore_processor: [
    loc(`wiki_tech_building_unlock`, [loc(`galaxy_ore_processor`)]),
  ],
  scavenger: [loc(`wiki_tech_building_unlock`, [loc(`galaxy_scavenger`)])],
  coordinates: [
    loc(`wiki_tech_destination_unlock`, [
      loc("galaxy_alien2_mission", [loc("galaxy_chthonian")]),
  ...
  soul_absorption: [loc(`wiki_tech_soul_absorption`)],
  soul_link: [loc(`wiki_tech_soul_link1`), loc(`wiki_tech_soul_link2`)],
  soul_bait: [loc(`wiki_tech_soul_bait`)],
  gun_emplacement: [
  ...
  rituals: [loc(`wiki_tech_rituals`)],
  crafting_ritual: [loc(`wiki_tech_crafting_ritual`)],
  mana_nexus: [loc(`wiki_tech_project_unlock`, [loc(`tech_mana_nexus`)])],
  clerics: [loc(`wiki_tech_clerics`)],
  conjuring: [
    loc(
      `wiki_tech_conjuring`,
      isHalloween.active
        ? [loc(`city_trick`), loc(`city_trick_conjure`)]
        : [loc(`city_food`), loc(`city_food_conjure`)]
    ),
  ],
  res_conjuring: [
    loc(
      `wiki_tech_conjuring`,
      isHalloween.active
        ? [loc(`city_dig`), loc(`city_dig_conjour`)]
        : [loc(`city_lumber`), loc(`city_lumber_conjure`)]
    ),
    loc(
      `wiki_tech_conjuring`,
      global.race["sappy"]
        ? [loc(`city_amber`), loc(`city_amber_conjour`)]
        : [loc(`city_stone`), loc(`city_stone_conjour`)]
    ),
  ],
  alchemy: [
  ...
  bribe_sphinx: [loc(`wiki_tech_bribe_sphinx`)],
  alien_biotech: [loc(`wiki_tech_alien_biotech`)],
  zero_g_lab: [loc(`wiki_tech_building_unlock`, [loc("tech_zero_g_lab")])],
  operating_base: [
  ...
  fob: [loc(`wiki_tech_building_unlock`, [loc("space_fob_title")])],
  bac_tanks_tp: [
    loc(`wiki_tech_bac_tanks`, [
      races[global.race.species].type === "synthetic"
        ? loc(`city_boot_camp_art`)
  ...
  sam_site: [loc(`wiki_tech_building_unlock`, [loc("space_sam_title")])],
  data_cracker: [
    loc(`wiki_tech_building_unlock`, [loc("space_decoder_title")]),
  ],
  ai_core_tp: [loc(`wiki_tech_building_unlock`, [loc("space_ai_core")])],
  ai_optimizations: [loc(`wiki_tech_ai_optimizations`)],
  synthetic_life: [
    loc(`wiki_tech_building_unlock`, [loc("space_ai_colonist_title")]),
  ],
  protocol66a: [loc(`wiki_tech_protocol66a`)],
  quantium: [
  ...
  higgs_boson_tp: [loc(`wiki_tech_higgs_boson`)],
  strange_signal: [
    loc(`wiki_tech_destination_unlock`, [
  ...
  nav_data: [
    loc(`wiki_tech_destination_unlock`, [
      loc(`space_mission_title`, [getSolarName("eris")]),
      getSolarName("eris"),
    ]),
    loc(`wiki_tech_destination_unlock`, [
      loc(`space_mission_title`, [loc(`space_kuiper_title`)]),
      loc(`space_kuiper_title`),
    ]),
  ],
  dronewar: [
    loc(`wiki_tech_building_unlock`, [
      loc("space_drone_control", [getSolarName("eris")]),
    ]),
    loc(`wiki_tech_building_unlock`, [loc("space_shock_trooper_title")]),
    loc(`wiki_tech_control_unlock`, [loc("space_digsite_title")]),
  ],
  drone_tank: [loc(`wiki_tech_building_unlock`, [loc("space_tank_title")])],
  stanene_tp: [
    loc(`wiki_tech_resource_unlock`, [loc(`resource_Stanene_name`)]),
    loc(`wiki_tech_factory_unlock`, [loc(`resource_Stanene_name`)]),
  ],
  ...
  adamantite_vault_tp: [loc(`wiki_tech_vault`, [22500, 30000])],
  titan_bank: [loc(`wiki_tech_building_unlock`, [loc("city_bank")])],
  hydrogen_plant: [
  ...
  mercury_smelting: [
    loc(`wiki_tech_building_unlock`, [
      loc("space_hell_smelter_title", [getSolarName("hell")]),
    ]),
  ],
  iridium_smelting: [loc(`wiki_tech_iridium_smelting`)],
  adamantite_crates: [
    loc(`wiki_tech_containerized_upgrade`, [
      loc(`resource_Crates_name`),
      1500,
  ...
  reinforced_shelving: [loc(`wiki_tech_reinforced_shelving`)],
  garage_shelving: [loc(`wiki_tech_garage_shelving`)],
  warehouse_shelving: [
  ...
  orichalcum_panels_tp: [loc(`wiki_tech_perovskite_cell`, [0.8])],
  shipyard: [loc(`wiki_tech_building_unlock`, [loc("outer_shipyard_title")])],
  ship_lasers: [
  ...
  ship_disruptor: [
    loc(`wiki_tech_ship_weapon_unlock`, [
      loc("outer_shipyard_weapon_disruptor"),
    ]),
  ],
  destroyer_ship: [
  ...
  h_cruiser_ship: [
    loc(`wiki_tech_ship_class_unlock`, [
      loc("outer_shipyard_class_battlecruiser"),
    ]),
  ],
  dreadnought_ship: [
    loc(`wiki_tech_ship_class_unlock`, [
      loc("outer_shipyard_class_dreadnought"),
    ]),
  ],
  pulse_engine: [
  ...
  system_survey: [
    loc(`wiki_tech_destination_unlock`, [
      loc("tau_gas_contest_title"),
      loc(`tau_gas_title`),
    ]),
    loc(`wiki_tech_destination_unlock`, [
      loc(`space_mission_title`, [loc("tau_roid_title")]),
      loc("tau_roid_title"),
    ]),
  ],
  repository: [loc(`wiki_tech_building_unlock`, [loc("tech_repository")])],
  fusion_generator: [
  ...
  jeff: [loc(`wiki_tech_jeff`)],
  womling_fun: [
    loc(`wiki_tech_building_unlock`, [
      loc("wiki_tech_multi_unlock", [
        loc("wiki_tech_multi_unlock", [
          loc("tau_red_womling_fun1"),
          loc("tau_red_womling_fun2"),
        ]),
        loc("tau_red_womling_fun3"),
      ]),
    ]),
  ],
  womling_lab: [
  ...
  womling_firstaid: [loc(`wiki_tech_womling_firstaid`)],
  womling_logistics: [loc(`wiki_tech_womling_logistics`)],
  womling_repulser: [loc(`wiki_tech_womling_repulser`)],
  womling_farming: [
    loc(`wiki_tech_womling_farming1`),
    loc(`wiki_tech_womling_farming2`),
  ],
  womling_housing: [loc(`wiki_tech_womling_housing`)],
  womling_support: [
    loc(`wiki_tech_building_unlock`, [loc("tau_gas_womling_station_title")]),
  ],
  womling_recycling: [loc(`wiki_tech_womling_recycling`)],
  belt_mining: [
    loc(`wiki_tech_building_unlock`, [loc("tau_gas_ore_refinery_title")]),
  ],
  adv_belt_mining: [loc(`wiki_tech_adv_belt_mining`)],
  space_whaling: [
  ...
  vaccine_campaign: [
    loc(`wiki_tech_vaccine_campaign1`, [
      races[global.race.species].type === "synthetic"
        ? loc(`city_boot_camp_art`)
        : loc(`tech_hospital`),
    ]),
    loc(`wiki_tech_vaccine_campaign2`, [
      races[global.race.species].type === "synthetic"
        ? loc(`city_boot_camp_art`)
        : loc(`tech_hospital`),
    ]),
  ...
  cloning: [loc(`wiki_tech_building_unlock`, [loc("tau_home_cloning")])],
  ringworld: [
    loc(`wiki_tech_destination_unlock2`, [loc("tab_tauceti")]),
    loc(`wiki_tech_building_unlock`, [loc("tau_star_ringworld")]),
  ],
  iso_gambling: [loc(`wiki_tech_iso_gambling`)],
  outpost_boost: [loc(`wiki_tech_outpost_boost`)],
  cultural_center: [
    loc(`wiki_tech_building_unlock`, [loc("tech_cultural_center")]),
  ],
  outer_tau_survey: [
    loc(`wiki_tech_destination_unlock`, [
      loc("tau_gas2_contest_title"),
      loc(`tau_gas2_title`),
    ]),
  ],
  alien_research: [loc(`wiki_tech_alien_research`)],
  ...
  food_culture: [loc(`wiki_tech_food_culture`)],
  advanced_refinery: [loc(`wiki_tech_advanced_refinery`)],
  advanced_pit_mining: [loc(`wiki_tech_advanced_pit_mining`)],
  useless_junk: [loc(`wiki_tech_useless_junk`)],
  advanced_asteroid_mining: [loc(`wiki_tech_advanced_asteroid_mining`)],
  matrioshka_brain: [
  ...
  replicator: [loc(`wiki_tech_replicator`)],
  womling_unlock: [
    loc(`wiki_tech_destination_unlock2`, [
      loc("tau_planet", [getSolarName("red")]),
    ]),
  ...
  geck: [loc(`wiki_tech_geck`)],
  asphodel_flowers: [loc(`wiki_tech_asphodel_flowers`)],
  ghost_traps: [loc(`wiki_tech_ghost_traps`)],
  research_station: [loc(`wiki_tech_research_station`)],
  spirit_box: [loc(`wiki_tech_spirit_box`)],
  spirit_researcher: [loc(`wiki_tech_spirit_researcher`)],
  dimensional_tap: [loc(`wiki_tech_dimensional_tap`)],
  soul_engine: [loc(`wiki_tech_soul_engine`)],
  railway_to_hell: [loc(`wiki_tech_railway_to_hell`)],
  purification: [loc(`wiki_tech_purification`)],
  asphodel_mech: [loc(`wiki_tech_asphodel_mech`)],
  asphodel_storage: [loc(`wiki_tech_asphodel_storage`)],
  asphodel_stabilizer: [loc(`wiki_tech_asphodel_stabilizer`)],
  edenic_bunker: [loc(`wiki_tech_edenic_bunker`)],
  bliss_den: [loc(`wiki_tech_bliss_den`)],
  hallowed_housing: [loc(`wiki_tech_hallowed_housing`)],
  outer_plane_study: [loc(`wiki_tech_outer_plane_study`)],
  camouflage: [loc(`wiki_tech_celestial_tactics`)],
  celestial_tactics: [loc(`wiki_tech_celestial_tactics`)],
  active_camouflage: [loc(`wiki_tech_celestial_tactics`)],
  special_ops_training: [loc(`wiki_tech_celestial_tactics`)],
  spectral_training: [loc(`wiki_tech_spectral_training`)],
  elysanite_mining: [loc(`wiki_tech_elysanite_mining`)],
  sacred_smelter: [loc(`wiki_tech_sacred_smelter`)],
  fire_support_base: [loc(`wiki_tech_fire_support_base`)],
  pillbox: [loc(`wiki_tech_pillbox`)],
  elerium_cannon: [loc(`wiki_tech_elerium_cannon`)],
  elerium_containment: [loc(`wiki_tech_elerium_containment`)],
  ambrosia: [loc(`wiki_tech_ambrosia`)],
  eternal_bank: [loc(`wiki_tech_eternal_bank`)],
  wisdom: [loc(`wiki_tech_wisdom`)],
  spirit_syphon: [loc(`wiki_tech_spirit_syphon`)],
  spirit_capacitor: [loc(`wiki_tech_spirit_capacitor`)],
  suction_force: [loc(`wiki_tech_suction_force`)],
  rushmore: [loc(`wiki_tech_rushmore`)],
  reincarnation: [loc(`wiki_tech_reincarnation`)],
  otherworldly_cement: [loc(`wiki_tech_otherworldly_cement`)],
  tomb: [loc(`wiki_tech_tomb`)],
  energy_drain: [loc(`wiki_tech_energy_drain`)],
  divine_infuser: [loc(`wiki_tech_divine_infuser`)],
  minor_wish: [loc(`wiki_tech_minor_wish`)],
  major_wish: [loc(`wiki_tech_major_wish`)],
};
...
const extraInformationTP = {
  ...
  merchandising: [loc("tech_merchandising_effect_tp")],
  starcharts: [
    loc(`wiki_tech_destination_unlock`, [
      loc(`space_mission_title`, [loc(`space_sun_info_name`)]),
      loc(`space_sun_info_name`),
    ...
    loc(`wiki_tech_subtab_unlock`, [
      loc(`outer_sol_system`, [getSolarName("home")]),
      loc(`tab_civil`),
    ]),
  ],
};
...
const extraRequirements = {
  ...
  space4: {
    title: loc("wiki_tech_req_mission", [
      loc("space_mission_title", [getSolarName("red")]),
    ]),
  ...
  gas_moon1: {
    title: loc("wiki_tech_req_mission", [
      loc("space_mission_title", [getSolarName("gas_moon")]),
    ]),
  ...
  science11: {
    title: loc("wiki_tech_req_megabuilding", [
      loc("space_dwarf_collider_title"),
    ]),
  ...
  alpha2: {
    title: loc("wiki_tech_req_building", [
      loc("interstellar_alpha_starport_title"),
    ]),
    link: "wiki.html#interstellar-structures-starport",
  },
  droids1: {
    title: loc("wiki_tech_req_building", [
      loc("interstellar_mining_droid_title"),
    ]),
    link: "wiki.html#interstellar-structures-mining_droid",
  },
  proxima2: {
    title: loc("wiki_tech_req_building", [
      loc("interstellar_xfer_station_title"),
    ]),
  ...
  chthonian2: {
    title: loc("wiki_tech_req_mission", [
      loc("space_mission_title", [loc("galaxy_chthonian")]),
    ]),
  ...
  outer6: {
    title: loc("wiki_tech_req_megabuilding", [
      loc("space_dwarf_mass_relay_title"),
    ]),
    link: "wiki.html#space-tp_structures-mass_relay",
  },
  titan1: {
    title: loc("wiki_tech_req_mission", [
      loc("space_mission_title", [getSolarName("titan")]),
    ]),
  ...
  enceladus1: {
    title: loc("wiki_tech_req_mission", [
      loc("space_mission_title", [getSolarName("enceladus")]),
    ]),
  ...
  bone_tools: [
    {
      ...
      subreqs: [
        ...
        {
          title: loc(`wiki_tech_special_trait_not`, [
            loc(`trait_soul_eater_name`),
          ]),
  ...
  alt_lodge: [
    {
      ...
      subreqs: [
        ...
        {
          title: loc(`wiki_tech_special_trait`, [
            loc(`trait_detritivore_name`),
          ]),
...
function getTechTrees(path) {
  ...
  Object.keys(techs).forEach(function (actionName) {
    ...
    let text =
      typeof actions.tech[actionName].title === "string"
        ? actions.tech[actionName].title
        : actions.tech[actionName].title();
  ...
  techTrees["theology"][3] = [
    ...
    {
      name: actions.tech["anthropology"].wiki
        ? "anthropology"
        : "alt_anthropology",
...
function addRequirements(parent, key, keyName, path) {
  ...
  if (Object.keys(key.reqs).length > 0) {
    ...
    Object.keys(key.reqs).forEach(function (req) {
      let color =
        global.tech[req] && global.tech[req] >= key.reqs[req]
          ? "success"
          : "danger";
    ...
    if (Object.keys(techReqs).length > 0) {
      let comma = false;
      let techReq = $(
        `<div class="reqs"><span class="has-text-caution">${loc(
          "wiki_tech_req_tech"
        )}</span></div>`
      );
      ...
      Object.keys(techReqs).forEach(function (req) {
        ...
        techReqs[req].forEach(function (subReq) {
          let subText = `<a href="wiki.html#${subReq.era}-${
            path === "truepath" ? "tp_tech" : "tech"
          }-${subReq.name}" class="has-text-${subReq.color}" target="_blank">${
            subReq.title
          }</a>`;
          color = subReq.color;
          if (isOr) {
        ...
        techReq.append(
          `${
            comma ? `, ` : ``
          }<span class="has-text-${color}">${reqText}</span>`
        );
        comma = true;
      });
    }
    ...
    if (Object.keys(otherReqs).length > 0) {
      ...
      Object.keys(otherReqs).forEach(function (req) {
        ...
        let reqText = link
          ? `<a href="${link}" class="has-text-${otherReqs[req].color}" target="_blank">${otherReqs[req].title}</a>`
          : otherReqs[req].title;
        otherReq.append(
          `${comma ? `, ` : ``}<span class="has-text-${
            otherReqs[req].color
          }">${reqText}</span>`
        );
        comma = true;
  ...
  if (specialRequirements.hasOwnProperty(keyName)) {
    ...
    specialRequirements[keyName].forEach(function (req) {
      ...
      req.subreqs.forEach(function (subreq) {
        ...
        switch (req.category) {
          ...
          case "trait":
            ...
            link = `wiki.html#traits-species-${traits[subreq.name].type}_${
              subreq.name
            }`;
          ...
          case "tech":
            subText =
              typeof actions.tech[subreq.name].title === "string"
                ? actions.tech[subreq.name].title
                : actions.tech[subreq.name].title();
            link = `wiki.html#${actions.tech[subreq.name].era}-tech-${
              subreq.name
            }`;
            color =
              global.tech[subreq.tree] &&
              global.genes[subreq.tree] >= subreq.val;
            break;
          case "universe":
          ...
          case "crispr":
            ...
            color =
              global.genes[subreq.tree] &&
              global.genes[subreq.tree] >= subreq.val;
            break;
          case "achieve":
            subText =
              subreq.val +
              ` <span class="flair" aria-label="star"><svg class="star${
                subreq.val
              }" version="1.1" x="0px" y="0px" width="16px" height="16px" viewBox="${svgViewBox(
                "star"
              )}" xml:space="preserve">${svgIcons("star")}</svg></span> ` +
              loc(`achieve_${subreq.name}_name`);
            link = `wiki.html#perks-prestige-${subreq.name}`;
            color =
              global.stats.achieve[subreq.name] &&
              global.stats.achieve[subreq.name].l >= subreq.val;
            break;
          case "government":
            ...
            color =
              ...
              global.civic.govern.type === subreq.name;
            break;
          case "scenario":
      ...
      if (req.category !== "unique") {
        reqText = loc(
          `wiki_tech_special_${req.category}${req.not ? "_not" : ""}`,
          [reqText]
        );
      }
      specialReq.append(
        `${
          comma ? `, ` : ``
        }<span class="has-text-${totalColor}">${reqText}</span>`
      );
      comma = true;
    });
    if (hasReq) {
...
export function renderTechPage(era, path) {
  ...
  Object.keys(techs).forEach(function (actionName) {
    ...
    if (
      action.hasOwnProperty("era") &&
      (action.era === era || action.era === alt_era[era]) &&
      (!action.hasOwnProperty("wiki") || action.wiki)
    ) {
      ...
      if (action.cost["Knowledge"]) {
        if (techListing.length === 0) {
          ...
          while (
            insertPos >= 0 &&
            techListing[insertPos][0].cost.Knowledge() > knowledgeCost
          ) {
      ...
      Object.keys(extraTechPositions).forEach(function (extraTech) {
        if (!sorted && otherTechs[i][0].id === `${prefix}-` + extraTech) {
          ...
          for (let i = 0; i < techListing.length; i++) {
            if (
              techListing[i][0].id ===
              `${prefix}-` + extraTechPositions[extraTech]
            ) {
              insertPos = i + 1;
              break;
            }
  ...
  for (let i = 0; i < techListing.length; i++) {
    let era =
      path === "truepath" && alt_era_r[techListing[i][0].era]
        ? alt_era_r[techListing[i][0].era]
        : techListing[i][0].era;
    ...
    sideMenu(
      ...
      `${era}-${prefix}`,
      id[1],
      typeof techListing[i][0].title === "function"
        ? techListing[i][0].title()
        : techListing[i][0].title
    );
  }
}
