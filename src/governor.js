...
export const gmen = {
  soldier: {
    ...
    title: [
      loc("governor_soldier_t1"),
      loc("governor_soldier_t2"),
      loc("governor_soldier_t3"),
    ],
    traits: {
      tactician: 1,
      militant: 1,
  ...
  criminal: {
    ...
    title: [
      loc("governor_criminal_t1"),
      loc("governor_criminal_t2"),
      { m: loc("governor_criminal_t3m"), f: loc("governor_criminal_t3f") },
    ],
    traits: {
      noquestions: 1,
      racketeer: 1,
  ...
  entrepreneur: {
    ...
    title: [
      loc("governor_entrepreneur_t1"),
      loc("governor_entrepreneur_t2"),
      {
        m: loc("governor_entrepreneur_t3m"),
        f: loc("governor_entrepreneur_t3f"),
      },
    ],
    traits: {
      dealmaker: 1,
  ...
  educator: {
    ...
    title: [
      loc("governor_educator_t1"),
      loc("governor_educator_t2"),
      loc("governor_educator_t3"),
    ],
    traits: {
      teacher: 1,
      theorist: 1,
  ...
  spiritual: {
    ...
    title: [
      loc("governor_spiritual_t1"),
      loc("governor_spiritual_t2"),
      loc("governor_spiritual_t3"),
    ],
    traits: {
      inspirational: 1,
      pious: 1,
  ...
  bluecollar: {
    ...
    title: [
      { m: loc("governor_bluecollar_t1m"), f: loc("governor_bluecollar_t1f") },
      loc("governor_bluecollar_t2"),
      { m: loc("governor_bluecollar_t3m"), f: loc("governor_bluecollar_t3f") },
    ],
    traits: {
      pragmatist: 1,
      dirty_jobs: 1,
  ...
  noble: {
    ...
    title: [
      { m: loc("governor_noble_t1m"), f: loc("governor_noble_t1f") },
      { m: loc("governor_noble_t2m"), f: loc("governor_noble_t2f") },
      { m: loc("governor_noble_t3m"), f: loc("governor_noble_t3f") },
      { m: loc("governor_noble_t4m"), f: loc("governor_noble_t4f") },
    ],
    traits: {
      extravagant: 1,
      aristocrat: 1,
  ...
  media: {
    ...
    title: [
      loc("governor_media_t1"),
      { m: loc("governor_media_t2m"), f: loc("governor_media_t2f") },
      loc("governor_media_t3"),
    ],
    traits: {
      gaslighter: 1,
      muckraker: 1,
  ...
  sports: {
    ...
    title: [
      loc("governor_sports_t1"),
      loc("governor_sports_t2"),
      loc("governor_sports_t3"),
    ],
    traits: {
      athleticism: 1,
      nopain: 1,
  ...
  bureaucrat: {
    ...
    title: [
      loc("governor_bureaucrat_t1"),
      { m: loc("governor_bureaucrat_t2m"), f: loc("governor_bureaucrat_t2f") },
      loc("governor_bureaucrat_t3"),
    ],
    traits: {
      organizer: 1,
    },
...
export const gov_traits = {
  tactician: {
    ...
    vars(b) {
      if (typeof b === "undefined") {
        b =
          global.genes.hasOwnProperty("governor") && global.genes.governor >= 3
            ? true
            : false;
      }
      return b ? [30] : [25];
  ...
  militant: {
    ...
    effect(b) {
      return loc(`gov_trait_militant_effect`, [
        $(this)[0].vars(b)[0],
        $(this)[0].vars(b)[1],
      ]);
    },
  ...
  racketeer: {
    ...
    effect(b) {
      return loc(`gov_trait_racketeer_effect`, [
        $(this)[0].vars(b)[0],
        $(this)[0].vars(b)[1],
      ]);
    },
  ...
  teacher: {
    ...
    effect(b) {
      return loc(`gov_trait_teacher_effect`, [$(this)[0].vars(b)[0]]);
    },
    vars(b) {
      return [6];
    },
  ...
  theorist: {
    ...
    effect(b) {
      return loc(`gov_trait_theorist_effect`, [
        $(this)[0].vars(b)[0],
        $(this)[0].vars(b)[1],
      ]);
    },
  ...
  pragmatist: {
    ...
    effect(b) {
      return loc(`gov_trait_pragmatist_effect`, [
        $(this)[0].vars(b)[0],
        $(this)[0].vars(b)[1],
      ]);
    },
  ...
  dirty_jobs: {
    ...
    effect(b) {
      return loc(`gov_trait_dirty_jobs_effect`, [
        $(this)[0].vars(b)[0],
        $(this)[0].vars(b)[1],
        $(this)[0].vars(b)[2],
      ]);
  ...
  extravagant: {
    ...
    effect(b) {
      return loc(`gov_trait_extravagant_effect`, [
        $(this)[0].vars(b)[0],
        housingLabel("large", true),
        $(this)[0].vars(b)[1],
        jobScale($(this)[0].vars(b)[2] + 5),
      ]);
    },
    vars(b) {
      if (typeof b === "undefined") {
  ...
  aristocrat: {
    ...
    effect(b) {
      return loc(`gov_trait_aristocrat_effect`, [
        $(this)[0].vars(b)[0],
        $(this)[0].vars(b)[1],
        $(this)[0].vars(b)[2],
      ]);
  ...
  gaslighter: {
    ...
    effect(b) {
      return loc(`gov_trait_gaslighter_effect`, [
        $(this)[0].vars(b)[0],
        wardenLabel(),
        $(this)[0].vars(b)[1],
        $(this)[0].vars(b)[2],
  ...
  muckraker: {
    ...
    effect(b) {
      return loc(`gov_trait_muckraker_effect`, [
        $(this)[0].vars(b)[1],
        $(this)[0].vars(b)[2],
      ]);
    },
  ...
  athleticism: {
    ...
    effect(b) {
      return loc(`gov_trait_athleticism_effect`, [
        $(this)[0].vars(b)[0],
        jobScale($(this)[0].vars(b)[1]),
        $(this)[0].vars(b)[2],
        wardenLabel(),
      ]);
    },
  ...
  nopain: {
    ...
    effect(b) {
      return loc(`gov_trait_nopain_effect`, [
        $(this)[0].vars(b)[0],
        $(this)[0].vars(b)[1],
      ]);
    },
  ...
  organizer: {
    ...
    vars(b) {
      if (typeof b === "undefined") {
        b =
          global.genes.hasOwnProperty("governor") && global.genes.governor >= 2
            ? true
            : false;
      }
      return [b ? 2 : 1];
...
function genGovernor(setSize) {
  ...
  for (let i = 0; i < setSize; i++) {
    ...
    let title =
      gmen[bg].title[Math.floor(seededRandom(0, gmen[bg].title.length))];
...
export function govern() {
  if (
    global.genes["governor"] &&
    global.tech["governor"] &&
    global.race["governor"] &&
    global.race.governor["g"] &&
    ...
    cnt.forEach(function (n) {
      if (
        gov_tasks[global.race.governor.tasks[`t${n}`]] &&
        gov_tasks[global.race.governor.tasks[`t${n}`]].req()
      ) {
...
export function defineGovernor() {
  ...
  if (global.genes["governor"] && global.tech["governor"]) {
    ...
    if (
      ...
      !global.race.governor.hasOwnProperty("candidates")
    ) {
      drawnGovernOffice();
    } else {
      appointGovernor();
...
export function drawnGovernOffice() {
  ...
  governorTitle.append(
    $(
      `<div class="has-text-caution">${loc(`governor_office`, [
        global.race.governor.g.n,
      ])}</div>`
    )
  );
  governorTitle.append(
    $(
      `<div><span class="has-text-warning">${loc(
        ...
        gmen[global.race.governor.g.bg].name
      }</span></div>`
    )
  );
  ...
  govHeader.append(
    $(
      `<div class="fire"><b-button v-on:click="fire" v-html="fireText()">${loc(
        `governor_fire`
      )}</b-button></div>`
    )
  );
  ...
  cnt.forEach(function (num) {
    ...
    govern.append(`<div class="govTask"><span>${loc(`gov_task`, [
      num + 1,
  ...
  //Configs
  {
    ...
    let storeContain = $(
      `<div class="tConfig" v-show="showTask('storage')"><div class="has-text-warning">${loc(
        `gov_task_storage`
      )}</div></div>`
    );
    ...
    storage.append(
      $(
        `<b-field>${loc(`gov_task_storage_reserve`, [
          global.resource[crt_mat].name,
        ])}<b-numberinput min="0" :max="Number.MAX_SAFE_INTEGER" v-model="c.storage.crt" :controls="false"></b-numberinput></b-field>`
      )
    );
    storage.append(
      $(
        `<b-field>${loc(`gov_task_storage_reserve`, [
          global.resource[cnt_mat].name,
        ])}<b-numberinput min="0" :max="Number.MAX_SAFE_INTEGER" v-model="c.storage.cnt" :controls="false"></b-numberinput></b-field>`
      )
    );
  }

  {
    ...
    let storeContain = $(
      `<div class="tConfig" v-show="showTask('bal_storage')"><div class="hRow"><div class="has-text-warning">${loc(
        `gov_task_bal_storage`
      )}</div><div class="chk"><b-checkbox v-model="c.bal_storage.adv">${loc(
        `advanced`
      )}</b-checkbox></div></div></div>`
    );
    options.append(storeContain);
    ...
    Object.keys(global.resource).forEach(function (res) {
      if (global.resource[res].stackable) {
        ...
        storage.append(
          $(`<div class="ccmOption" :class="bStrEx()" v-show="showStrRes('${res}')"><span>${global.resource[res].name}</span>
                <b-field>
...

  {
    ...
    let contain = $(
      `<div class="tConfig" v-show="showTask('merc')"><div class="has-text-warning">${loc(
        `gov_task_merc`
      )}</div></div>`
    );
    ...
    merc.append(
      $(
        `<b-field>${loc(
          `gov_task_merc_buffer`
        )}<b-numberinput min="0" :max="Number.MAX_SAFE_INTEGER" v-model="c.merc.buffer" :controls="false"></b-numberinput></b-field>`
      )
    );
    merc.append(
      $(
        `<b-field>${loc(
          `gov_task_merc_reserve`
        )}<b-numberinput min="0" :max="100" v-model="c.merc.reserve" :controls="false"></b-numberinput></b-field>`
      )
    );
  }

  {
    ...
    let contain = $(
      `<div class="tConfig" v-show="showTask('spy')"><div class="has-text-warning">${loc(
        `gov_task_spy`
      )}</div></div>`
    );
    options.append(contain);
    ...
    spy.append(
      $(
        `<b-field>${loc(
          `gov_task_merc_reserve`
        )}<b-numberinput min="0" :max="100" v-model="c.spy.reserve" :controls="false"></b-numberinput></b-field>`
      )
    );
  }

  {
    ...
    if (!global.race.governor.config.hasOwnProperty("spyop")) {
      ...
      Object.keys(global.civic.foreign).forEach(function (gov) {
        global.race.governor.config.spyop[gov] =
          gov === "gov3"
            ? ["influence", "sabotage"]
            : ["sabotage", "incite", "influence"];
      });
    }

    let contain = $(
      `<div class="tConfig" v-show="showTask('spyop')"><div class="has-text-warning">${loc(
        `gov_task_spyop`
      )}</div></div>`
    );
    options.append(contain);
    Object.keys(global.civic.foreign).forEach(function (gov) {
      if (
        (gov.substr(3, 1) < 3 && !global.tech["world_control"]) ||
        (gov === "gov3" && global.tech["rival"])
      ) {
        let spyop = $(`<div></div>`);
        contain.append(spyop);
        spyop.append(`
                    <h2 class="has-text-caution">${loc(
                      "gov_task_spyop_priority",
                      [govTitle(gov.substring(3))]
                    )}</h2>
...

  {
    ...
    let contain = $(
      `<div class="tConfig" v-show="showTask('tax')"><div class="has-text-warning">${loc(
        `gov_task_tax`
      )}</div></div>`
    );
    options.append(contain);
    ...
    tax.append(
      $(
        `<b-field>${loc(
          `gov_task_tax_min`
        )}<b-numberinput min="0" :max="20" v-model="c.tax.min" :controls="false"></b-numberinput></b-field>`
      )
    );
  }

  {
    ...
    let contain = $(
      `<div class="tConfig" v-show="showTask('slave')"><div class="has-text-warning">${loc(
        `gov_task_slave`,
        [global.resource.Slave.name]
      )}</div></div>`
    );
    options.append(contain);
    ...
    slave.append(
      $(
        `<b-field>${loc(
          `gov_task_merc_reserve`
        )}<b-numberinput min="0" :max="100" v-model="c.slave.reserve" :controls="false"></b-numberinput></b-field>`
      )
    );
  }

  {
    ...
    ["Infernite", "Elerium", "Copper", "Iron"].forEach(function (res) {
      if (
        !global.race.governor.config.trash.hasOwnProperty(res) ||
        typeof global.race.governor.config.trash[res] !== "object" ||
        global.race.governor.config.trash[res] === null
      ) {
    ...
    let advanced =
      global.genes.hasOwnProperty("governor") && global.genes.governor >= 3
        ? `<div class="chk"><b-checkbox v-model="c.trash.stab">${loc(
            `gov_task_auto_stabilize`
          )}</b-checkbox></div>`
        : ``;

    let contain = $(
      `<div class="tConfig" v-show="showTask('trash')"><div class="hRow"><div class="has-text-warning">${loc(
        `gov_task_trash`
      )}</div>${advanced}</div></div>`
    );
    options.append(contain);
    ...
    ["Infernite", "Elerium", "Copper", "Iron"].forEach(function (res) {
      trash.append(
        $(
          `<b-field class="trash"><div class="trashButton" role="button" @click="trashStrat('${res}')" v-html="$options.methods.trashLabel('${res}')"></div><b-numberinput min="0" :max="1000000" v-model="c.trash.${res}.v" :controls="false"></b-numberinput></b-field>`
        )
      );
    });
  }

  {
    ...
    if (!global.race.governor.config.replicate.hasOwnProperty("pow")) {
      global.race.governor.config.replicate["pow"] = {
        on: false,
        cap: 10000,
        buffer: 0,
      };
    ...
    if (!global.race.governor.config.replicate.hasOwnProperty("res")) {
      global.race.governor.config.replicate["res"] = {
        que: true,
        neg: true,
        cap: true,
      };
    ...
    let contain = $(
      `<div class="tConfig" v-show="showTask('replicate')"><div class="has-text-warning">${loc(
        `gov_task_replicate`
      )}</div></div>`
    );
    options.append(contain);
    ...
    replicate.append(
      $(
        `<div class="chk"><b-checkbox v-model="c.replicate.pow.on">${loc(
          `gov_task_replicate_auto`
        )}</b-checkbox></div>`
      )
    );
    replicate.append(
      $(
        `<b-field>${loc(
          `gov_task_replicate_pmax`
        )}<b-numberinput min="0" v-model="c.replicate.pow.cap" :controls="false"></b-numberinput></b-field>`
      )
    );
    replicate.append(
      $(
        `<b-field>${loc(
          `gov_task_replicate_buff`
        )}<b-numberinput min="0" v-model="c.replicate.pow.buffer" :controls="false"></b-numberinput></b-field>`
      )
    );
    ...
    res_bal.append(
      $(
        `<div class="chk"><b-checkbox v-model="c.replicate.res.que">${loc(
          `gov_task_replicate_que`
        )}</b-checkbox></div>`
      )
    );
    res_bal.append(
      $(
        `<div class="chk"><b-checkbox v-model="c.replicate.res.neg">${loc(
          `gov_task_replicate_neg`
        )}</b-checkbox></div>`
      )
    );
    res_bal.append(
      $(
        `<div class="chk"><b-checkbox v-model="c.replicate.res.cap">${loc(
          `gov_task_replicate_cap`
        )}</b-checkbox></div>`
      )
    );
  }
  ...
  vBind({
    ...
    methods: {
      setTask(t, n) {
        ...
        if (t === "combo_storage") {
          Object.keys(global.race.governor.tasks).forEach(function (ts) {
            if (
              global.race.governor.tasks[ts] === "storage" ||
              global.race.governor.tasks[ts] === "bal_storage"
            ) {
        ...
        if (t === "combo_spy") {
          Object.keys(global.race.governor.tasks).forEach(function (ts) {
            if (
              global.race.governor.tasks[ts] === "spy" ||
              global.race.governor.tasks[ts] === "spyop"
            ) {
              global.race.governor.tasks[ts] = "none";
            }
          });
      ...
      showTask(t) {
        return (
          Object.values(global.race.governor.tasks).includes(t) ||
          (Object.values(global.race.governor.tasks).includes(
            "combo_storage"
          ) &&
            ["storage", "bal_storage"].includes(t)) ||
          (Object.values(global.race.governor.tasks).includes("combo_spy") &&
            ["spy", "spyop"].includes(t))
        );
      },
      activeTask(t) {
        let activeTasks = [];
      ...
      fire() {
        let inc = global.race.governor.hasOwnProperty("f")
          ? global.race.governor.f
          : 0;
        let cost = (10 + inc) ** 2 - 50;
        let res =
          global.race.universe === "antimatter" ? "AntiPlasmid" : "Plasmid";
      ...
      fireText() {
        let inc = global.race.governor.hasOwnProperty("f")
          ...
          : 0;
        let cost = (10 + inc) ** 2 - 50;
        return `<div>${loc(`governor_fire`)}</div><div>${cost} ${loc(
      ...
      trashStrat(r) {
        global.race.governor.config.trash[r].s = global.race.governor.config
          .trash[r].s
          ? false
          : true;
      },
      trashLabel(r) {
        return loc(
          global.race.governor.config.trash[r].s
            ? `gov_task_trash_max`
            : `gov_task_trash_min`,
    ...
    filters: {
      label(t) {
        return gov_tasks[t]
          ? typeof gov_tasks[t].name === "string"
            ? gov_tasks[t].name
            : gov_tasks[t].name()
          : loc(`gov_task_${t}`);
      },
  ...
  popover(
    ...
    function () {
      ...
      Object.keys(gmen[global.race.governor.g.bg].traits).forEach(function (t) {
        desc +=
          (gov_traits[t].hasOwnProperty("effect")
            ? gov_traits[t].effect()
            : "") + " ";
      });
      return desc;
...
function appointGovernor() {
  ...
  govern.append(
    $(
      `<div class="appoint header"><span class="has-text-caution">${loc(
        `governor_candidate`
  ...
  for (let i = 0; i < global.race.governor.candidates.length; i++) {
    ...
    govern.append(
      $(
        `<div class="appoint ${gov.bg}"><span class="has-text-warning">${
          gov.t
        } ${gov.n}</span><span class="bg">${
          gmen[gov.bg].name
        }</span><span><button class="button" v-on:click="appoint(${i})">${loc(
          `governor_appoint`
        )}</button></span><div>`
      )
    );
...
export function govActive(trait, val) {
  if (
    global.race.hasOwnProperty("governor") &&
    global.race.governor.hasOwnProperty("g")
  ) {
    return gmen[global.race.governor.g.bg].traits[trait]
      ? gov_traits[trait].vars()[val]
      : false;
  }
  return false;
}
...
export const gov_tasks = {
      ...
      if ($(this)[0].req()) {
        ...
        if (
          ...
          global.civic.taxes.tax_rate >
            (global.civic.govern.type === "oligarchy" ? 45 : 25)
        ) {
          while (
            global.city.morale.current < 100 &&
            global.civic.taxes.tax_rate >
          ...
          global.city.morale.potential >= global.city.morale.cap + add_morale &&
          global.civic.taxes.tax_rate < max
        ) {
          govCivics("adj_tax", "add");
        } else if (
          global.city.morale.current < global.city.morale.cap &&
          global.civic.taxes.tax_rate > global.race.governor.config.tax.min
        ) {
          govCivics("adj_tax", "sub");
        }
      }
  ...
  storage: {
    ...
    req() {
      return checkCityRequirements("storage_yard") &&
        global.tech["container"] &&
      ...
      if ($(this)[0].req()) {
        if (global.resource.Crates.amount < global.resource.Crates.max) {
          ...
          if (global.resource[mat].amount > reserve + cost) {
            let build = Math.floor(
              (global.resource[mat].amount - reserve) / cost
            );
            crateGovHook("crate", build);
          }
        }
        if (
          checkCityRequirements("warehouse") &&
          global.resource.Containers.display &&
          ...
          if (global.resource.Steel.amount > reserve + cost) {
            let build = Math.floor(
              (global.resource.Steel.amount - reserve) / cost
            );
  ...
  bal_storage: {
    ...
    task() {
      if ($(this)[0].req()) {
        ...
        Object.keys(global.race.governor.config.bal_storage).forEach(function (
          res
        ) {
        ...
        res_list.forEach(function (res) {
          ...
          if (global.resource[res].display && global.resource[res].stackable) {
            ...
            let crtAssign = Math.floor(
              crateSet > 0 ? crateSet * multiplier : 0
            );
            global.resource[res].crates = crtAssign;
            if (global.resource.Containers.display) {
              let cntAssign = Math.floor(
                containerSet > 0 ? containerSet * multiplier : 0
              );
  ...
  assemble: {
    ...
    req() {
      return global.race["artifical"] &&
        (!global.tech["focus_cure"] || global.tech.focus_cure < 7)
        ? true
        : false;
    },
    task() {
  ...
  merc: {
    ...
    req() {
      return checkCityRequirements("garrison") && global.tech["mercs"]
        ? true
        : false;
    },
    task() {
      if ($(this)[0].req()) {
        let cashCap =
          global.resource.Money.max *
          (global.race.governor.config.merc.reserve / 100);
        while (
          global.civic.garrison.max >
            global.civic.garrison.workers +
              global.race.governor.config.merc.buffer &&
          global.resource.Money.amount >= govCivics("m_cost") &&
          (global.resource.Money.amount + global.resource.Money.diff >=
            cashCap ||
            global.resource.Money.diff >= govCivics("m_cost"))
        ) {
          govCivics("m_buy");
        }
      }
  ...
  spy: {
    ...
    task() {
      if ($(this)[0].req()) {
        let cashCap =
          global.resource.Money.max *
          (global.race.governor.config.spy.reserve / 100);
        ...
        for (let i = min; i < max; i++) {
          ...
          if (
            ...
            (global.resource.Money.diff >= cost ||
              global.resource.Money.amount + global.resource.Money.diff >=
                cashCap)
          ) {
            govCivics("t_spy", i);
  ...
  spyop: {
    ...
    task() {
      if ($(this)[0].req()) {
        let range =
          global.race["truepath"] && global.tech["rival"]
            ? [0, 1, 2, 3]
            : [0, 1, 2];
        ...
        range.forEach(function (gov) {
          if (
            ...
            global.civic.foreign[`gov${gov}`].spy > 0 &&
            !global.civic.foreign[`gov${gov}`].anx &&
            !global.civic.foreign[`gov${gov}`].buy &&
            !global.civic.foreign[`gov${gov}`].occ
          ) {
            global.race.governor.config.spyop[`gov${gov}`].every(function (
              mission
            ) {
              switch (mission) {
                case "influence":
                  if (
                    global.civic.foreign[`gov${gov}`].hstl > 0 &&
  ...
  slave: {
    ...
    req() {
      return !global.race["orbit_decayed"] &&
        checkCityRequirements("slave_market") &&
        global.race["slaver"] &&
    ...
    task() {
      let cashCap =
        global.resource.Money.max *
        (global.race.governor.config.slave.reserve / 100);
      let slaveCost = 25000;
      ...
      if (
        $(this)[0].req() &&
        global.resource.Money.amount >= slaveCost &&
  ...
  sacrifice: {
    ...
    req() {
      return checkCityRequirements("s_alter") &&
      ...
      if (
        ...
        if (
          (!global.race["kindling_kindred"] &&
            !global.race["smoldering"] &&
            global.city.s_alter.harvest <= 10000) ||
          global.city.s_alter.mind <= 10000 ||
          global.city.s_alter.mine <= 10000 ||
          global.city.s_alter.rage <= 10000 ||
          global.city.s_alter.regen <= 10000
        ) {
    ...
    task() {
      ...
      if ($(this)[0].req() && checkAffordable(cost)) {
        ...
        if (
          ...
          (global.resource[res].diff >= amount ||
  ...
  trash: {
    ...
    req() {
      return global.interstellar["mass_ejector"] &&
    ...
    task() {
      let mass = function (m) {
        return global.race.universe === "magic"
          ? atomic_mass[m]
          : ["Elerium", "Infernite"].includes(m)
          ? atomic_mass[m] * 10
          : atomic_mass[m];
      };
      let remain = p_on["mass_ejector"] * 1000;
      Object.keys(atomic_mass)
        .sort((a, b) => (mass(a) < mass(b) ? 1 : -1))
        .forEach(function (res) {
          let trade = breakdown.p.consume[res].hasOwnProperty(loc("trade"))
            ? breakdown.p.consume[res][loc("trade")]
            : 0;
          let craft = breakdown.p.consume[res].hasOwnProperty(
            loc("job_craftsman")
          )
            ? breakdown.p.consume[res][loc("job_craftsman")]
            : 0;
          if (trade < 0) {
            trade = 0;
          }
          ...
          if (
            global.race.governor.config.trash[res] ||
            (global.interstellar.mass_ejector.hasOwnProperty(res) &&
              ...
              global.interstellar.mass_ejector[res] +
                ...
                0 &&
              global.resource[res].amount + trade - craft >=
                global.resource[res].max * 0.999 - 1)
          ) {
            let set =
              global.resource[res].amount + trade - craft >=
                global.resource[res].max * 0.999 - 1 ||
              (global.race.governor.config.trash[res] &&
                !global.race.governor.config.trash[res].s)
                ? Math.floor(
                    global.interstellar.mass_ejector[res] +
                      global.resource[res].diff
                  )
  ...
  mech: {
    ...
    req() {
      return global.stats.achieve.hasOwnProperty("corrupted") &&
        global.stats.achieve.corrupted.l > 0 &&
        checkHellRequirements("prtl_spire", "mechbay") &&
    ...
    task() {
      if ($(this)[0].req()) {
        ...
        ["small", "medium", "large", "titan", "collector"].forEach(function (
          ...
          ["hover", "spider", "wheel", "tread", "biped", "quad"].forEach(
            function (chassis) {
        ...
        if (
          (mechs.type.large >= 6 && mechs.type.small < 12) ||
          (mechs.type.large >= 12 &&
            mechs.type.titan >= 2 &&
            mechs.type.small < 24)
        ) {
        ...
        if (
          ...
          for (let i = 0; i < global.portal.mechbay.mechs.length; i++) {
            if (!global.portal.mechbay.mechs[i]["infernal"]) {
              ...
              if (
                supply >= cost &&
                global.resource.Soul_Gem.amount + gems >= soul
              ) {
                ...
                if (pattern.size === "small" && pattern.equip.length === 0) {
                  ...
                  (pattern.size === "medium" && pattern.equip.length === 1) ||
                  (pattern.size === "large" && pattern.equip.length === 2) ||
                  (pattern.size === "titan" && pattern.equip.length < 5)
                ) {
                  let equip = "???";
                  Object.keys(mechs[ctype].equip).forEach(function (val) {
                    if (
                      equip === "???" ||
                      mechs[ctype].equip[val] < mechs[ctype].equip[equip]
                    ) {
                      if (equip !== val) {
                        equip = val;
                      }
          ...
          for (let i = 0; i < wCap; i++) {
            Object.keys(mechs[ctype].weapon).forEach(function (val) {
              if (
                weapons[i] === "???" ||
                mechs[ctype].weapon[val] < mechs[ctype].weapon[weapons[i]]
              ) {
          ...
          for (let i = 0; i < 4; i++) {
            Object.keys(mechs[ctype].equip).forEach(function (val) {
              if (
                equip[i] === "???" ||
                mechs[ctype].equip[val] < mechs[ctype].equip[equip[i]]
              ) {
          ...
          let equipment = global.blood["prepared"]
            ? equip
            : [equip[0], equip[1]];
          if (ctype === "small") {
            weapons = [weapons[0]];
            ...
            weapons = [weapons[0]];
            equipment = global.blood["prepared"]
              ? ["special", equip[0]]
              : ["special"];
          } else if (ctype === "large") {
            equipment = global.blood["prepared"]
              ? ["special", equip[0], equip[1]]
              : ["special", equip[0]];
          } else if (ctype === "titan") {
            equipment = global.blood["prepared"]
              ? ["special", equip[0], equip[1], equip[2], equip[3]]
              : ["special", equip[0], equip[1], equip[2]];
          }
  ...
  replicate: {
    ...
    req() {
      return global.tech["replicator"] && global.race["replicator"]
        ? true
        : false;
    },
    task() {
      ...
      for (
        let idx = 0;
        global.race.governor.config.replicate.res.que &&
        idx < global.queue.queue.length;
        idx++
      ) {
        ...
        for (let i = 0; i < resSorted.length; i++) {
          if (
            global.resource[resSorted[i]] &&
            global.resource[resSorted[i]].display &&
            atomic_mass[resSorted[i]] &&
            !(resSorted[i] === "Food" && global.race["fasting"])
          ) {
      ...
      if (!rBal) {
        ...
        resSorted = resSorted.filter(
          (item) => global.resource[item] && global.resource[item].display
        );

        if (
          global.race.governor.config.replicate.res.neg &&
          resSorted[0] &&
          global.resource[resSorted[0]].diff < 0 &&
          (global.resource[resSorted[0]].amount <=
            global.resource[resSorted[0]].max * 0.95 ||
            global.resource[resSorted[0]].max === -1)
        ) {
          global.race.replicator.res = resSorted[0];
        } else if (
          global.resource[global.race.replicator.res].max !== -1 &&
          global.race.governor.config.replicate.res.cap &&
          global.resource[global.race.replicator.res].amount >=
            global.resource[global.race.replicator.res].max
        ) {
          let cappable = resSorted.filter(
            (item) => global.resource[item].max > 0
          );
          for (let i = 0; i < cappable.length; i++) {
            if (
              global.resource[cappable[i]].amount <
              global.resource[cappable[i]].max
            ) {
          ...
          if (!rBal) {
            let uncappable = resSorted.filter(
              (item) => global.resource[item].max === -1
            );
