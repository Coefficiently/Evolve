...
export function altRace(race, set) {
  ...
  switch (race) {
    ...
    case "yeti": {
      if (
        (date.getMonth() === 11 && date.getDate() >= 17) ||
        (global.race["hrt"] && global.race.hrt === race)
      ) {
        if (set) {
    ...
    case "seraph": {
      if (
        (date.getMonth() === 1 && date.getDate() === 14) ||
        (global.race["hrt"] && global.race.hrt === race)
      ) {
        if (set) {
          global.race["hrt"] = race;
...
export const traits = {
  ...
  blurry: {
    // Increased success chance of spies
...
export const races = {
  ...
  human: {
    ...
    solar: {
      red: loc(
        altRace("human") ? "race_zombie_solar_red" : "race_human_solar_red"
      ),
      hell: loc(
        altRace("human") ? "race_zombie_solar_hell" : "race_human_solar_hell"
      ),
      gas: loc(
        altRace("human") ? "race_zombie_solar_gas" : "race_human_solar_gas"
      ),
      gas_moon: loc(
        altRace("human")
          ? "race_zombie_solar_gas_moon"
          : "race_human_solar_gas_moon"
      ),
      dwarf: loc(
        altRace("human") ? "race_zombie_solar_dwarf" : "race_human_solar_dwarf"
      ),
    },
    fanaticism: "creative",
    basic() {
  ...
  elven: {
    ...
    entity: altRace("elven")
      ? loc("race_xmas_elf_entity")
      : loc("race_elven_entity"),
    traits: {
      studious: 1,
      arrogant: 1,
    },
    solar: {
      red: loc(
        altRace("elven") ? "race_xmas_elf_solar_red" : "race_elven_solar_red"
      ),
      hell: loc(
        altRace("elven") ? "race_xmas_elf_solar_hell" : "race_elven_solar_hell"
      ),
      gas: loc(
        altRace("elven") ? "race_xmas_elf_solar_gas" : "race_elven_solar_gas"
      ),
      gas_moon: loc(
        altRace("elven")
          ? "race_xmas_elf_solar_gas_moon"
          : "race_elven_solar_gas_moon"
      ),
      dwarf: loc(
        altRace("elven")
          ? "race_xmas_elf_solar_dwarf"
          : "race_elven_solar_dwarf"
      ),
    },
    fanaticism: "studious",
    basic() {
  ...
  wolven: {
    ...
    entity: altRace("wolven")
      ? loc("race_rabbit_entity")
      : loc("race_wolven_entity"),
    traits: {
      pack_mentality: 1,
      tracker: 1,
    },
    solar: {
      red: altRace("wolven")
        ? loc("race_rabbit_solar_red")
        : loc("race_wolven_solar_red"),
      hell: altRace("wolven")
        ? loc("race_rabbit_solar_hell")
        : loc("race_wolven_solar_hell"),
      gas: altRace("wolven")
        ? loc("race_rabbit_solar_gas")
        : loc("race_wolven_solar_gas"),
      gas_moon: altRace("wolven")
        ? loc("race_rabbit_solar_gas_moon")
        : loc("race_wolven_solar_gas_moon"),
      dwarf: altRace("wolven")
        ? loc("race_rabbit_solar_dwarf")
        : loc("race_wolven_solar_dwarf"),
    },
    fanaticism: "tracker",
    basic() {
      return true;
  ...
  vulpine: {
    name: altRace("vulpine")
      ? loc("race_chocolate_rabbit")
      : loc(global.race.universe === "magic" ? "race_kitsune" : "race_vulpine"),
    desc() {
      return altRace("vulpine")
        ? loc("race_chocolate_rabbit_desc")
        : loc("race_vulpine_desc", [
            loc(
              global.race.universe === "magic" ? "race_kitsune" : "race_vulpine"
            ),
            foxColor(),
          ]);
    },
    type: "carnivore",
    home: altRace("vulpine")
      ? loc("race_chocolate_rabbit_home")
      : loc("race_vulpine_home"),
    entity: altRace("vulpine")
      ? loc("race_chocolate_rabbit_entity")
      : loc("race_vulpine_entity"),
    traits: {
      playful: 1,
      freespirit: 1,
    },
    solar: {
      red: altRace("vulpine")
        ? loc("race_chocolate_rabbit_solar_red")
        : loc("race_vulpine_solar_red"),
      hell: altRace("vulpine")
        ? loc("race_chocolate_rabbit_solar_hell")
        : loc("race_vulpine_solar_hell"),
      gas: altRace("vulpine")
        ? loc("race_chocolate_rabbit_solar_gas")
        : loc("race_vulpine_solar_gas"),
      gas_moon: altRace("vulpine")
        ? loc("race_chocolate_rabbit_solar_gas_moon")
        : loc("race_vulpine_solar_gas_moon"),
      dwarf: altRace("vulpine")
        ? loc("race_chocolate_rabbit_solar_dwarf")
        : loc("race_vulpine_solar_dwarf"),
    },
    fanaticism: "playful",
    basic() {
      return true;
  ...
  centaur: {
    ...
    entity: loc(
      altRace("centaur") ? "race_reindeer_entity" : "race_centaur_entity"
    ),
    traits: {
      sniper: 1,
      hooved: 1,
    ...
    solar: {
      red: loc(
        altRace("centaur")
          ? "race_reindeer_solar_red"
          : "race_centaur_solar_red"
      ),
      hell: loc(
        altRace("centaur")
          ? "race_reindeer_solar_hell"
          : "race_centaur_solar_hell"
      ),
      gas: loc(
        altRace("centaur")
          ? "race_reindeer_solar_gas"
          : "race_centaur_solar_gas"
      ),
      gas_moon: loc(
        altRace("centaur")
          ? "race_reindeer_solar_gas_moon"
          : "race_centaur_solar_gas_moon"
      ),
      dwarf: loc(
        altRace("centaur")
          ? "race_reindeer_solar_dwarf"
          : "race_centaur_solar_dwarf"
      ),
    },
    fanaticism: "sniper",
    basic() {
  ...
  capybara: {
    ...
    entity: loc(
      altRace("capybara") ? "race_donkey_entity" : "race_capybara_entity"
    ),
    traits: {
      gnawer: 1,
      calm: 1,
    ...
    solar: {
      red: loc(
        altRace("capybara")
          ? "race_donkey_solar_red"
          : "race_capybara_solar_red"
      ),
      hell: loc(
        altRace("capybara")
          ? "race_donkey_solar_hell"
          : "race_capybara_solar_hell"
      ),
      gas: loc(
        altRace("capybara")
          ? "race_donkey_solar_gas"
          : "race_capybara_solar_gas"
      ),
      gas_moon: loc(
        altRace("capybara")
          ? "race_donkey_solar_gas_moon"
          : "race_capybara_solar_gas_moon"
      ),
      dwarf: loc(
        altRace("capybara")
          ? "race_donkey_solar_dwarf"
          : "race_capybara_solar_dwarf"
      ),
    },
    fanaticism: "calm",
    basic() {
  ...
  tortoisan: {
    ...
    desc() {
      return altRace("tortoisan")
        ? loc("race_ninja_turtle_desc", [shellColor()])
        : loc("race_tortoisan_desc", [shellColor()]);
    },
    type: "reptilian",
    home: loc(
      altRace("tortoisan") ? "race_ninja_turtle_home" : "race_tortoisan_home"
    ),
    entity: loc(
      altRace("tortoisan")
        ? "race_ninja_turtle_entity"
        : "race_tortoisan_entity"
    ),
    traits: {
      slow: 1,
      armored: 1,
    ...
    solar: {
      red: loc(
        altRace("tortoisan")
          ? "race_ninja_turtle_solar_red"
          : "race_tortoisan_solar_red"
      ),
      hell: loc(
        altRace("tortoisan")
          ? "race_ninja_turtle_solar_hell"
          : "race_tortoisan_solar_hell"
      ),
      gas: loc(
        altRace("tortoisan")
          ? "race_ninja_turtle_solar_gas"
          : "race_tortoisan_solar_gas"
      ),
      gas_moon: loc(
        altRace("tortoisan")
          ? "race_ninja_turtle_solar_gas_moon"
          : "race_tortoisan_solar_gas_moon"
      ),
      dwarf: loc(
        altRace("tortoisan")
          ? "race_ninja_turtle_solar_dwarf"
          : "race_tortoisan_solar_dwarf"
      ),
    },
    fanaticism: "armored",
    basic() {
  ...
  arraak: {
    ...
    entity: altRace("arraak")
      ? loc("race_turkey_entity")
      : loc("race_arraak_entity"),
    traits: {
      resourceful: 1,
      selenophobia: 1,
    },
    solar: {
      red: loc(
        altRace("arraak") ? "race_turkey_solar_red" : "race_arraak_solar_red"
      ),
      hell: loc(
        altRace("arraak") ? "race_turkey_solar_hell" : "race_arraak_solar_hell"
      ),
      gas: loc(
        altRace("arraak") ? "race_turkey_solar_gas" : "race_arraak_solar_gas"
      ),
      gas_moon: loc(
        altRace("arraak")
          ? "race_turkey_solar_gas_moon"
          : "race_arraak_solar_gas_moon"
      ),
      dwarf: loc(
        altRace("arraak")
          ? "race_turkey_solar_dwarf"
          : "race_arraak_solar_dwarf"
      ),
    },
  ...
  entish: {
    ...
    entity: loc(
      altRace("entish") ? "race_spruce_entity" : "race_entish_entity"
    ),
    traits: {
      kindling_kindred: 1,
      pyrophobia: 1,
    ...
    solar: {
      red: loc(
        altRace("entish") ? "race_spruce_solar_red" : "race_entish_solar_red"
      ),
      hell: loc(
        altRace("entish") ? "race_spruce_solar_hell" : "race_entish_solar_hell"
      ),
      gas: loc(
        altRace("entish") ? "race_spruce_solar_gas" : "race_entish_solar_gas"
      ),
      gas_moon: loc(
        altRace("entish")
  ...
  dryad: {
    ...
    fanaticism: "befuddle",
    basic() {
      return ["forest", "swamp", "taiga"].includes(global.city.biome)
        ? true
        : false;
    },
  },
  ...
  yeti: {
    ...
    solar: {
      red: loc(
        altRace("yeti") ? "race_snowman_solar_red" : "race_yeti_solar_red"
      ),
      hell: loc(
        altRace("yeti") ? "race_snowman_solar_hell" : "race_yeti_solar_hell"
      ),
      gas: loc(
        altRace("yeti") ? "race_snowman_solar_gas" : "race_yeti_solar_gas"
      ),
      gas_moon: loc(
        altRace("yeti")
          ? "race_snowman_solar_gas_moon"
          : "race_yeti_solar_gas_moon"
      ),
      dwarf: loc(
        altRace("yeti") ? "race_snowman_solar_dwarf" : "race_yeti_solar_dwarf"
      ),
    },
    fanaticism: "blurry",
    basic() {
  ...
  wendigo: {
    ...
    entity: loc(
      altRace("wendigo") ? "race_krampus_entity" : "race_wendigo_entity"
    ),
    traits: {
      ravenous: 1,
      ghostly: 1,
    ...
    solar: {
      red: loc(
        altRace("wendigo") ? "race_krampus_solar_red" : "race_wendigo_solar_red"
      ),
      hell: loc(
        altRace("wendigo")
          ? "race_krampus_solar_hell"
          : "race_wendigo_solar_hell"
      ),
      gas: loc(
        altRace("wendigo") ? "race_krampus_solar_gas" : "race_wendigo_solar_gas"
      ),
      gas_moon: loc(
        altRace("wendigo")
          ? "race_krampus_solar_gas_moon"
          : "race_wendigo_solar_gas_moon"
      ),
      dwarf: loc(
        altRace("wendigo")
          ? "race_krampus_solar_dwarf"
          : "race_wendigo_solar_dwarf"
      ),
    },
    fanaticism: "ghostly",
    basic() {
  ...
  seraph: {
    ...
    entity: loc(
      altRace("seraph") ? "race_cherub_entity" : "race_seraph_entity"
    ),
    traits: {
      unified: 1,
      spiritual: 1,
    ...
    solar: {
      red: loc(
        altRace("seraph") ? "race_cherub_solar_red" : "race_seraph_solar_red"
      ),
      hell: loc(
        altRace("seraph") ? "race_cherub_solar_hell" : "race_seraph_solar_hell"
      ),
      gas: loc(
        altRace("seraph") ? "race_cherub_solar_gas" : "race_seraph_solar_gas"
      ),
      gas_moon: loc(
        altRace("seraph")
          ? "race_cherub_solar_gas_moon"
          : "race_seraph_solar_gas_moon"
      ),
      dwarf: loc(
        altRace("seraph")
          ? "race_cherub_solar_dwarf"
          : "race_seraph_solar_dwarf"
      ),
    },
  ...
  unicorn: {
    ...
    entity: loc(
      altRace("unicorn") ? "race_emocorn_entity" : "race_unicorn_entity"
    ),
    traits: {
      rainbow: 1,
      magnificent: 1,
    ...
    solar: {
      red: loc(
        altRace("unicorn") ? "race_emocorn_solar_red" : "race_unicorn_solar_red"
      ),
      hell: loc(
        altRace("unicorn")
          ? "race_emocorn_solar_hell"
          : "race_unicorn_solar_hell"
      ),
      gas: loc(
        altRace("unicorn") ? "race_emocorn_solar_gas" : "race_unicorn_solar_gas"
      ),
      gas_moon: loc(
        altRace("unicorn")
          ? "race_emocorn_solar_gas_moon"
          : "race_unicorn_solar_gas_moon"
      ),
      dwarf: loc(
        altRace("unicorn")
          ? "race_emocorn_solar_dwarf"
          : "race_unicorn_solar_dwarf"
      ),
    },
  ...
  synth: {
    name: loc("race_synth"),
    desc() {
      let race = global.race.hasOwnProperty("srace")
        ? global.race.srace
        : "human";
  ...
  junker: {
    ...
    type: (function () {
      return global.race.hasOwnProperty("jtype")
        ? global.race.jtype
        : "humanoid";
    })(),
    home: altRace("junker") ? loc("race_ghoul_home") : loc("race_junker_home"),
    entity: altRace("junker")
      ? loc("race_ghoul_entity")
      : loc("race_junker_entity"),
    traits: {
      diverse: 1,
      arrogant: 1,
      angry: 1,
    ...
    solar: {
      red: altRace("junker")
        ? loc("race_ghoul_solar_red")
        : loc("race_junker_solar_red"),
      hell: altRace("junker")
        ? loc("race_ghoul_solar_hell")
        : loc("race_junker_solar_hell"),
      gas: altRace("junker")
        ? loc("race_ghoul_solar_gas")
        : loc("race_junker_solar_gas"),
      gas_moon: altRace("junker")
        ? loc("race_ghoul_solar_gas_moon")
        : loc("race_junker_solar_gas_moon"),
      dwarf: altRace("junker")
        ? loc("race_ghoul_solar_dwarf")
        : loc("race_junker_solar_dwarf"),
    },
    fanaticism: "none",
    basic() {
      return false;
...
export function setJType() {
  races.junker.type = global.race.hasOwnProperty("jtype")
    ? global.race.jtype
    : "humanoid";
  races.sludge.type = global.race.hasOwnProperty("jtype")
    ? global.race.jtype
    : "humanoid";
  races.ultra_sludge.type = global.race.hasOwnProperty("jtype")
    ? global.race.jtype
    : "humanoid";
}
...
export function racialTrait(workers, type) {
  ...
  if (
    theoryVal &&
    (type === "factory" || type === "miner" || type === "lumberjack")
  ) {
  ...
  if (
    global.race["rejuvenated"] &&
    ["lumberjack", "miner", "factory"].includes(type)
  ) {
    modifier *= 1.1;
  }
  if (
  ...
  if (global.race["analytical"] && type === "science") {
    modifier *=
      1 + (traits.analytical.vars()[0] * global.race["analytical"]) / 100;
  }
  if (global.race["ooze"]) {
  ...
  if (
    global.tech["cyber_worker"] &&
    (type === "lumberjack" || type === "miner" || type === "forager")
  ) {
    modifier *= 1.25;
  }
  if (
    ...
    global.race.ocularPowerConfig.t &&
  ...
  if (global.race.universe === "magic") {
    ...
    if (
      global.race.hasOwnProperty("casting") &&
      global.race.casting[type === "hellArmy" ? "army" : type]
    ) {
    ...
    let tusk = global.race["tusk"]
      ? 1 +
        (traits.tusk.vars()[0] / 100) *
          (armyRating(jobScale(1), "army", 0) / 100)
      : 1;
    let lt = global.race["living_tool"]
      ? 1 +
        traits.living_tool.vars()[0] *
          (global.tech["science"] && global.tech.science > 0
            ? global.tech.science * 0.12
            : 0)
      : 1;
  ...
  if (
    ...
    ["farmer", "miner", "lumberjack", "factory", "hunting", "forager"].includes(
      type
    )
  ) {
...
function purgeLumber() {
  ...
  if (global.civic.d_job === "lumberjack") {
    global.civic.d_job =
      global.race["carnivore"] || global.race["soul_eater"]
        ? "hunter"
        : "unemployed";
  }
...
function releaseResource(res) {
  ...
  if (
    ...
    global.interstellar.mass_ejector.hasOwnProperty(res)
  ) {
    global.interstellar.mass_ejector.total -=
      global.interstellar.mass_ejector[res];
    global.interstellar.mass_ejector[res] = 0;
  }
  if (
    global.city["nanite_factory"] &&
    global.city.nanite_factory.hasOwnProperty(res)
  ) {
    global.city.nanite_factory[res] = 0;
  }
  if (
    global.portal["transport"] &&
    global.portal.transport.cargo.hasOwnProperty(res)
  ) {
...
function adjustFood() {
  ...
  let lumberEnabled =
    checkTechQualifications(actions.tech.reclaimer) ||
    checkTechQualifications(actions.tech.stone_axe);
  ...
  if (!global.race["artifical"]) {
    ...
    if (altLodge) {
      ...
      let minAltLodge =
        getPurgatory("tech", "farm") >= 1 ||
        getPurgatory("tech", "hunting") >= 2
          ? 1
          : 0;
      if (
        minAltLodge > 0 &&
        (!global.tech["s_lodge"] || global.tech["s_lodge"] < minAltLodge)
      ) {
    ...
    if (huntingEnabled) {
      ...
      let minHunting =
        getPurgatory("tech", "farm") >= 1 ||
        getPurgatory("tech", "s_lodge") >= 1
          ? 2
          : getPurgatory("tech", "agriculture") >= 3
          ? 1
          : 0;
      if (
        minHunting > 0 &&
        (!global.tech["hunting"] || global.tech["hunting"] < minHunting)
      ) {
    ...
    if (farmersEnabled) {
      ...
      if (
        minFarm > 0 &&
        (!global.tech["farm"] || global.tech["farm"] < minFarm)
      ) {
        global.tech["farm"] = minFarm;
      }
      checkPurgatory("tech", "agriculture");
      let minAgriculture =
        getPurgatory("tech", "hunting") >= 1
          ? 3
          : getPurgatory("tech", "s_lodge") >= 1
          ? 1
          : 0;
  ...
  if (
    (global.race["carnivore"] && !global.race["herbivore"]) ||
    global.race["soul_eater"] ||
...
export function cleanAddTrait(trait) {
  switch (trait) {
    case "high_pop":
      global.resource[global.race.species].amount = Math.round(
        global.resource[global.race.species].amount * traits.high_pop.vars()[0]
      );
      if (global.civic.hasOwnProperty("garrison")) {
        global.civic.garrison.workers = Math.round(
          global.civic.garrison.workers * traits.high_pop.vars()[0]
        );
      }
      break;
    ...
    case "unfathomable":
      ...
      while (
        ...
        global.city.surfaceDwellers.push(
          basicRace(global.city.surfaceDwellers)
        );
      }
    ...
    case "calm":
      if (global.tech["primitive"] >= 3) {
        checkPurgatory(
          "city",
          "meditation",
          actions.city.meditation.struct().d
        );
  ...
  switch (trait) {
    case "high_pop":
      global.resource[global.race.species].amount = Math.round(
        global.resource[global.race.species].amount /
          traits.high_pop.vars(rank)[0]
      );
      if (global.civic.hasOwnProperty("garrison")) {
        global.civic.garrison.workers = Math.round(
          global.civic.garrison.workers / traits.high_pop.vars(rank)[0]
        );
      }
      break;
    case "kindling_kindred":
      ...
      if (
        (global.tech["axe"] || global.tech["reclaimer"]) &&
        !global.race["orbit_decayed"]
      ) {
    ...
    case "sappy":
      ...
      if (global.tech["mining"] >= 1) {
        ...
        if (
          (global.city["rock_quarry"] && global.city.rock_quarry.count > 0) ||
          global.race["lone_survivor"]
        ) {
...
export function setImitation(mod) {
  if (global.race["imitation"] && global.race["srace"]) {
    ...
    if (global.race["shapeshifter"]) {
      if (
        (races[global.race["srace"]].type === "hybrid" &&
          races[global.race["srace"]].hybrid.includes(
            global.race["ss_genus"]
          )) ||
    ...
    if (races[global.race["srace"]].type === "hybrid") {
      ...
      if (genusList.includes("carnivore") && genusList.includes("herbivore")) {
        genusList = ["omnivore"];
      }
      ...
      Object.keys(genus_traits[races[global.race["srace"]].type]).forEach(
        function (trait) {
          if (!global.race[trait]) {
            i_traits.push(trait);
          }
    ...
    for (let trait of i_traits) {
      if (!["evil", "imitation"].includes(trait)) {
        ...
        let rank =
          traits[trait].val < 0
            ? traits.imitation.vars()[1]
            : traits.imitation.vars()[0];
...
export function shapeShift(genus, setup, forceClean) {
  let shifted = global.race.hasOwnProperty("ss_traits")
    ? global.race.ss_traits
    : [];
  if (!setup || forceClean) {
  ...
  if (setup) {
    clearElement($("#sshifter"));
    global.race["ss_genus"] = global.race.hasOwnProperty("ss_genus")
      ? global.race.ss_genus
      : "none";

    let drop = ``;
    const imitation = global.race["imitation"]
      ? races[global.race["srace"]].type === "hybrid"
        ? races[global.race["srace"]].hybrid
        : [races[global.race["srace"]].type]
      : [];
    const base =
    ...
    Object.keys(genus_traits).forEach(function (gen) {
      if (
        !["synthetic", "eldritch", ...base, ...imitation].includes(gen) &&
        global.stats.achieve[`genus_${gen}`] &&
        global.stats.achieve[`genus_${gen}`].l > 0
      ) {
...
export function traitRank(trait) {
  if (global.race["empowered"] && trait !== "empowered") {
    switch (global.race[trait]) {
      ...
      case 1:
        return traits.empowered.vars()[0] >= 1
          ? traits.empowered.vars()[0] >= 2
            ? 3
            : 2
          : 1;
      case 2:
...
export function fathomCheck(race) {
  if (
    global.race["unfathomable"] &&
    global.city["surfaceDwellers"] &&
    global.city.surfaceDwellers.includes(race) &&
...
export function traitSkin(type, trait, species) {
  let artificial = species
    ? genus_traits[races[species].type].artifical
  ...
  switch (type) {
    case "name": {
      let name = {
        ...
        promiscuous: artificial
          ? loc("trait_promiscuous_synth_name")
          : traits.promiscuous.name,
    ...
    case "desc": {
      let desc = {
        ...
        promiscuous: artificial
          ? loc("trait_promiscuous_synth")
          : traits["promiscuous"].desc,
...
export function hoovedReskin(desc, species = global.race.species) {
  let type =
    species === global.race.species
      ? global.race.maintype || races[species].type
      : races[species].type;
  if (species === "sludge" || species === "ultra_sludge") {
    ...
    return desc
      ? loc(`trait_hooved_${species}`)
      : loc(`trait_hooved_${species}_name`);
  } else if (
    [
      "humanoid",
      "avian",
    ...
    return desc
      ? loc(`trait_hooved_${type}`)
      : loc(`trait_hooved_${type}_name`);
  } else {
...
export const biomes = {
  ...
  oceanic: {
    ...
    vars() {
      return global.race["rejuvenated"]
        ? [1.25, 1.12, 0.92]
        : [1.12, 1.06, 0.95];
...
export function basicRace(skip) {
  ...
  let basicList = Object.keys(races).filter(function (r) {
    return (
      !["custom", "hybrid"].includes(r) && !skip.includes(r) && races[r].basic()
    );
  });
...
export function renderSupernatural() {
  if (
    ...
    (global.settings.civTabs !== 2 || global.settings.govTabs !== 7)
  ) {
    return;
  }
...
function minorWish(parent) {
  ...
  container.append(
    $(
      `<div class="header"><span class="has-text-warning">${loc(
        "tech_minor_wish"
      )}</span> - <span v-html="$options.filters.wish(minor)"></span></div>`
    )
  );
  ...
  spells.append(
    `<div><b-button id="wishMoney" v-html="$options.filters.money()" @click="money()"></b-button></div>`
  );
  spells.append(
    `<div><b-button id="wishRes" v-html="$options.filters.label('resources')" @click="res()"></b-button></div>`
  );
  spells.append(
    `<div><b-button id="wishKnow" v-html="$options.filters.know()" @click="know()"></b-button></div>`
  );
  spells.append(
    `<div><b-button id="wishFame" v-html="$options.filters.label('fame')" @click="famous()"></b-button></div>`
  );
  spells.append(
    `<div><b-button id="wishStrength" v-html="$options.filters.label('strength')" @click="strength()"></b-button></div>`
  );
  spells.append(
    `<div><b-button id="wishInfluence" v-html="$options.filters.label('influence')" @click="influence()"></b-button></div>`
  );
  spells.append(
    `<div><b-button id="wishExcite" v-html="$options.filters.label('event')" @click="excite()"></b-button></div>`
  );
  spells.append(
    `<div><b-button id="wishLove" v-html="$options.filters.label('love')" @click="love()"></b-button></div>`
  );
  ...
  vBind({
    ...
    methods: {
        ...
        if (global.race.wishStats.minor === 0) {
          ...
          if (global.tech["science"]) {
            if (global.tech.science >= 1 && global.tech.science <= 3) {
              ...
              global.tech.science >= 4 &&
              global.tech.science <= 6
            ) {
              options.push("science");
            } else if (
              global.tech["high_tech"] &&
              ...
              global.tech.science === 12
            ) {
              options.push("science");
            } else if (
              global.tech["infernite"] &&
              global.tech.infernite >= 2 &&
              global.tech.science === 13
            ) {
              options.push("science");
              ...
              global.tech["xeno"] &&
              global.tech.xeno >= 4 &&
              global.tech.science === 15
            ) {
              options.push("science");
            } else if (
              global.tech["high_tech"] &&
              global.tech.high_tech >= 16 &&
              global.tech.science === 16
            ) {
              options.push("science");
            } else if (
              ...
              global.tech.science === 19
            ) {
              options.push("science");
            } else if (
              global.tech["asphodel"] &&
              global.tech.asphodel >= 3 &&
              global.tech.science === 21
            ) {
              options.push("science");
            } else if (
              global.tech["asphodel"] &&
              global.tech.asphodel >= 8 &&
          ...
          switch (spell) {
            ...
            case "know": {
              let gain = Math.floor(
                seededRandom(
                  global.resource.Knowledge.max / 5,
                  global.resource.Knowledge.max / 2
                )
              );
            ...
            case "science": {
              ...
              let tech =
                typeof actions.tech[techs[global.tech.science]].title ===
                "function"
                  ? actions.tech[techs[global.tech.science]].title()
                  : actions.tech[techs[global.tech.science]].title;
              messageQueue(loc("wish_tech", [tech]), "warning", false, [
                "progress",
              ]);
              break;
            }
      ...
      money() {
        if (global.race.wishStats.minor === 0) {
          ...
          switch (spell) {
            case "money": {
              let cash = Math.floor(
                seededRandom(1, Math.round(global.resource.Money.max / 8))
              );
              ...
              messageQueue(
                loc("wish_cash", [sizeApproximation(cash)]),
                "warning",
                false,
                ["events"]
              );
            ...
            case "robbery": {
              ...
              messageQueue(
                loc("wish_robbery", [
                  loc(`wish_robbery${victim}`),
                  sizeApproximation(cash),
                ]),
                "warning",
                false,
                ["events"]
        ...
        if (global.race.wishStats.minor === 0) {
          ...
          [
            ...
            if (
              ...
              global.resource[res].amount * 1.05 < global.resource[res].max
            ) {
              resList.push(res);
            }
          });
          ...
          if (spell === "useless" || resList.length === 0) {
            ...
            picked.forEach(function (res) {
              ...
              if (res === "Soul_Gem") {
                ...
                gain = Math.floor(
                  seededRandom(1, Math.floor(global.resource[res].max * 0.25))
                );
                global.resource[res].amount += gain;
            ...
            if (["2xcommon", "2xrare"].includes(spell)) {
              messageQueue(
                loc("wish_gain_double", [
                  sizeApproximation(gains[0]),
                  global.resource[picked[0]].name,
                  sizeApproximation(gains[1]),
                  global.resource[picked[1]].name,
                ]),
                "warning",
                false,
                ["events"]
      ...
      love() {
        if (global.race.wishStats.minor === 0) {
          ...
          rivals.forEach(function (gov) {
            if (
              global.civic.foreign[gov].hstl > 0 &&
              !global.civic.foreign[gov].anx &&
              !global.civic.foreign[gov].buy &&
              !global.civic.foreign[gov].occ
            ) {
              options.push(gov);
            }
          });
      ...
      famous() {
        if (global.race.wishStats.minor === 0) {
          ...
          let cheese =
            cheeseList[Math.floor(seededRandom(0, cheeseList.length))];
          ...
          switch (spell) {
            case "notorious": {
              ...
              messageQueue(
                loc("wish_famous", [loc(`wish_notorious${event}`, args)]),
                "warning",
                false,
                ["events"]
              );
            ...
            case "reputable": {
              ...
              messageQueue(
                loc("wish_famous", [loc(`wish_reputable${event}`, args)]),
                "warning",
                false,
                ["events"]
              );
        ...
        if (global.race.wishStats.minor === 0) {
          ...
          switch (spell) {
            ...
            case "military": {
              ...
              let tech =
                typeof actions.tech[techs[global.tech.military]].title ===
                "function"
                  ? actions.tech[techs[global.tech.military]].title()
                  : actions.tech[techs[global.tech.military]].title;
              messageQueue(loc("wish_tech", [tech]), "warning", false, [
                "progress",
              ]);
      ...
      influence() {
        if (global.race.wishStats.minor === 0) {
          ...
          if (
            global.race.wishStats.prof < 25 &&
            global.civic.professor.display
          ) {
          ...
          switch (spell) {
            case "magazine": {
              messageQueue(
                loc("wish_magazine", [races[global.race.species].name]),
                "warning",
                false,
                ["events"]
              );
    ...
    filters: {
      wish(v) {
        return v === 0
          ? `<span class="has-text-success">${loc(`power_available`)}</span>`
          : `<span class="has-text-danger">${v}</span>`;
      },
      label(v) {
        return loc(`wish_${v}`);
      },
...
function majorWish(parent) {
  ...
  container.append(
    $(
      `<div class="header"><span class="has-text-warning">${loc(
        "tech_major_wish"
      )}</span> - <span v-html="$options.filters.wish(major)"></span></div>`
    )
  );
  let spells = $(`<div class="flexWrap"></div>`);
  container.append(spells);
  ...
  spells.append(
    `<div><b-button id="wishBigMoney" v-html="$options.filters.money()" @click="money()"></b-button></div>`
  );
  spells.append(
    `<div><b-button id="wishBigRes" v-html="$options.filters.label('resources')" @click="res()"></b-button></div>`
  );
  spells.append(
    `<div><b-button id="wishPlasmid" v-html="$options.filters.label('plasmid')" @click="plasmid()"></b-button></div>`
  );
  spells.append(
    `<div><b-button id="wishPower" v-html="$options.filters.label('power')" @click="power()"></b-button></div>`
  );
  spells.append(
    `<div><b-button id="wishAdoration" v-html="$options.filters.label('adoration')" @click="adoration()"></b-button></div>`
  );
  spells.append(
    `<div><b-button id="wishThrill" v-html="$options.filters.label('thrill')" @click="thrill()"></b-button></div>`
  );
  spells.append(
    `<div><b-button id="wishPeace" v-html="$options.filters.label('peace')" @click="peace()"></b-button></div>`
  );
  spells.append(
    `<div><b-button id="wishGreatness" v-html="$options.filters.label('greatness')" @click="greatness()"></b-button></div>`
  );
    ...
    methods: {
        ...
        if (global.race.wishStats.major === 0) {
          ...
          switch (spell) {
            case "money": {
              let cash = Math.floor(
                seededRandom(
                  Math.round(global.resource.Money.max / 12),
                  Math.round(global.resource.Money.max / 4)
                )
              );
              global.resource.Money.amount += cash;
              if (global.resource.Money.amount > global.resource.Money.max) {
            ...
            picked.forEach(function (res) {
              ...
              if (res === "Soul_Gem") {
                gain = Math.floor(
                  seededRandom(
                    1,
                    global.tech["science"] + global.tech["high_tech"] || 2
                  )
                );
                global.resource[res].amount += gain;
              } else {
                gain = Math.floor(
                  seededRandom(
                    10000,
                    Math.floor(global.resource[res].max * 0.5)
                  )
                );
                global.resource[res].amount += gain;
                if (global.resource[res].amount > global.resource[res].max) {
      ...
      plasmid() {
        if (global.race.wishStats.major === 0) {
          ...
          if (
            ...
            global.tech.blackhole >= 5 &&
            global.interstellar["mass_ejector"] &&
            global.interstellar.mass_ejector.count >= 1
          ) {
          ...
          switch (spell) {
            case "fake": {
              ...
              messageQueue(
                loc("wish_plasmid_gain", [
                  gain,
                  loc(`resource_Knockoff_plural_name`),
                ]),
                "warning",
                false,
                ["events"]
                ...
                loc("wish_plasmid_gain", [
                  ...
                  loc(
                    global.race.universe === "antimatter"
                      ? `resource_AntiPlasmid_plural_name`
      ...
      power() {
        if (global.race.wishStats.major === 0) {
          ...
          if (
            ...
            (global.tech["shipyard"] ||
              (global.tech["science"] && global.tech.science >= 16))
          ) {
            options.push("ship");
          }
          ...
          switch (spell) {
            case "priest": {
              if (
                ...
                global.race.wishStats.priest < 25
              ) {
                global.race.wishStats.priest++;
                messageQueue(loc("wish_priest"), "warning", false, ["events"]);
              } else {
                messageQueue(loc("wish_priest_fail"), "warning", false, [
                  "events",
                ]);
              }
              break;
            ...
            case "temple": {
              ...
              messageQueue(
                loc("wish_temple", [structName("temple")]),
                "warning",
                false,
                ["events"]
              );
            ...
            case "zigg": {
              ...
              messageQueue(
                loc("wish_temple", [loc("space_red_ziggurat_title")]),
                "warning",
                false,
                ["events"]
              );
      ...
      peace() {
        if (global.race.wishStats.major === 0) {
          ...
          if (
            ...
            !global.tech["isolation"] &&
            global.tech["rival"] &&
            global.civic.foreign.gov3.hstl > 0
          ) {
            options.push("gov3");
          }
          ...
          if (["gov0", "gov1", "gov2"].includes(spell)) {
            ...
            messageQueue(
              loc("wish_peace_join", [govTitle(spell.substring(3))]),
              "warning",
              false,
              ["events"]
            );
            ...
            switch (spell) {
              case "flower":
                messageQueue(
                  loc("wish_peace_flower", [govTitle(spell.substring(3))]),
                  "warning",
                  false,
                  ["events"]
                );
              ...
              case "gov3":
                ...
                break;
              case "piracy":
                global.tech.piracy = Math.floor(
                  seededRandom(1, global.tech.piracy)
                );
              ...
              case "syndicate":
                Object.keys(global.space.syndicate).forEach(function (synd) {
                  if (global.space.syndicate[synd] > 10) {
                    global.space.syndicate[synd] = Math.floor(
                      seededRandom(10, global.space.syndicate[synd])
                    );
                  }
                });
                messageQueue(loc("wish_piracy"), "warning", false, ["events"]);
      ...
      greatness() {
        if (global.race.wishStats.major === 0) {
          ...
          let a_level = alevel();
          if (
            (!global.race["lone_survivor"] && !global.stats.feat["wish"]) ||
            (global.stats.feat["wish"] && global.stats.feat["wish"] < a_level)
          ) {
            options.push("feat");
          }
          ...
          switch (spell) {
            case "wonder": {
              ...
              if (!global.race["lone_survivor"]) {
                let hasCity =
                  global.race["cataclysm"] || global.race["orbit_decay"]
                    ? false
                    : true;
                let hasMars = global.tech["mars"] ? true : false;
                if (
                  !global.city.hasOwnProperty("wonder_lighthouse") &&
                  hasCity
                ) {
                ...
                if (
                  !global.race["truepath"] &&
                  !global.interstellar.hasOwnProperty("wonder_gardens") &&
                  global.tech["alpha"] &&
                  global.tech.alpha >= 2
                ) {
                ...
                if (
                  global.race["truepath"] &&
                  !global.space.hasOwnProperty("wonder_gardens") &&
                  global.tech["titan"] &&
                  global.tech.titan >= 2
                ) {
                  wonders.push("gardens");
              ...
              if (wonders.length > 0) {
                let monument =
                  wonders[Math.floor(seededRandom(0, wonders.length))];
                switch (monument) {
                  case "lighthouse":
                  ...
                  case "statue":
                    ...
                    break;
                  case "gardens":
                    global[global.race["truepath"] ? "space" : "interstellar"][
                      "wonder_gardens"
                    ] = { count: 1 };
                    break;
                }
                ...
                messageQueue(loc("wish_no_wonder"), "warning", false, [
                  "events",
                ]);
              }
              break;
...
function ocularPower(parent) {
  ...
  container.append(
    $(
      `<div class="header"><span class="has-text-warning">${loc(
        "trait_ocular_power_name"
      )}</span> - <span v-html="$options.filters.max()"></span></div>`
    )
  );
  ...
  powers.append(
    `<div id="oculardisintegration" class="chk"><b-checkbox v-model="d" @input="pow('d')">${loc(
      `ocular_disintegration`
    )}</b-checkbox></div>`
  );
  powers.append(
    `<div id="ocularpetrification" class="chk"><b-checkbox v-model="p" @input="pow('p')">${loc(
      `ocular_petrification`
    )}</b-checkbox></div>`
  );
  powers.append(
    `<div id="ocularwound" class="chk"><b-checkbox v-model="w" @input="pow('w')">${loc(
      `ocular_wound`
    )}</b-checkbox></div>`
  );
  powers.append(
    `<div id="oculartelekinesis" class="chk"><b-checkbox v-model="t" @input="pow('t')">${loc(
      `ocular_telekinesis`
    )}</b-checkbox></div>`
  );
  powers.append(
    `<div id="ocularfear" class="chk"><b-checkbox v-model="f" @input="pow('f')">${loc(
      `ocular_fear`
    )}</b-checkbox></div>`
  );
  powers.append(
    `<div id="ocularcharm" class="chk"><b-checkbox v-model="c" @input="pow('c')">${loc(
      `ocular_charm`
    )}</b-checkbox></div>`
  );
...
export function renderPsychicPowers() {
  if (
    !global.settings.tabLoad &&
    (global.settings.civTabs !== 2 || global.settings.govTabs !== 6)
  ) {
    return;
  }
...
function psychicBoost(parent) {
  ...
  container.append(
    $(
      `<div class="header">${loc(
        "psychic_boost_title"
      )} <span v-html="$options.filters.boostTime()"></span></div>`
    )
  );
  ...
  content.append(
    `<div id="psyhscrolltarget" class="left hscroll"><b-field class="buttonList">${scrollMenu}</b-field></div>`
  );

  container.append(
    `<div><b-button v-html="$options.filters.boost(b.r)" @click="boostVal()"></b-button></div>`
  );
  ...
  if (global.tech.psychic >= 4) {
    ...
    let sub = $(
      `<span role="button" class="sub" @click="sub" aria-label="Decresae Energy reserved for ${loc(
        `psychic_attack`
      )}"><span>&laquo;</span></span>`
    );
    let add = $(
      `<span role="button" class="add" @click="add" aria-label="Increase Energy reserved for ${loc(
        `psychic_attack`
  ...
  vBind({
    ...
    filters: {
      boost(r) {
        return loc(`psychic_boost_button`, [
          global.resource[r] ? global.resource[r].name : "N/A",
          cost,
        ]);
      },
      boostTime() {
        return global.race.psychicPowers.boostTime > 0
          ? loc(`psychic_boost_time`, [global.race.psychicPowers.boostTime])
          : "";
      },
    },
  });
...
function psychicKill(parent) {
  ...
  container.append(
    $(`<div class="header">${loc("psychic_murder_title")}</div>`)
  );
  container.append(
    `<div><b-button v-html="$options.filters.kill()" @click="murder()"></b-button></div>`
  );
...
function psychicAssault(parent) {
  ...
  container.append(
    $(
      `<div class="header">${loc(
        "psychic_assault_title"
      )} <span v-html="$options.filters.boostTime()"></span></div>`
    )
  );
  container.append(
    `<div><b-button v-html="$options.filters.boost()" @click="boostVal()"></b-button></div>`
  );
  ...
  vBind({
    ...
    filters: {
      ...
      boostTime() {
        return global.race.psychicPowers.assaultTime > 0
          ? loc(`psychic_boost_time`, [global.race.psychicPowers.assaultTime])
          : "";
      },
    },
  });
...
function psychicFinance(parent) {
  ...
  vBind({
    ...
    filters: {
      ...
      boostTime() {
        return global.race.psychicPowers.cash > 0
          ? loc(`psychic_boost_time`, [global.race.psychicPowers.cash])
          : "";
      },
    },
  });
...
function psychicMindBreak(parent) {
  ...
  container.append(
    $(`<div class="header">${loc("psychic_mind_break_title")}</div>`)
  );
  container.append(
    `<div><b-button v-html="$options.filters.break()" @click="breakMind()"></b-button></div>`
  );
...
function psychicCapture(parent) {
  ...
  container.append(
    `<div><b-button v-html="$options.filters.break()" @click="stun()"></b-button></div>`
  );
