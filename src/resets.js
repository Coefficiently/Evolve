...
export function warhead() {
  if (!global.civic.mad.armed && !global.race["cataclysm"]) {
    ...
    let corruption =
      global.race.hasOwnProperty("corruption") && global.race.corruption > 1
        ? global.race.corruption - 1
        : 0;
    global["race"] = {
      species: "protoplasm",
      gods: god,
...
export function bioseed() {
  ...
  let gecks = global.starDock.hasOwnProperty("geck")
...
export function big_bang() {
  ...
  if (
    global.space.hasOwnProperty("spaceport") &&
    global.space.spaceport.count === 0
  ) {
  ...
  global.stats.pdebt = gains.pdebt;
  global.prestige.Dark.count = +(
    global.prestige.Dark.count + gains.dark
  ).toFixed(3);
...
export function ascend() {
  ...
  global.stats.pdebt = gains.pdebt;
  global.prestige.Harmony.count = parseFloat(
    (global.prestige.Harmony.count + gains.harmony).toFixed(2)
  );
  global.stats.harmony = parseFloat(
    (global.stats.harmony + gains.harmony).toFixed(2)
  );
  ...
  if (
    !global.galaxy.hasOwnProperty("dreadnought") ||
    global.galaxy.dreadnought.count === 0
  ) {
  ...
  if (
    ...
    (global.race.species === "synth" || global.race.species === "nano") &&
    global.race["emfield"]
  ) {
...
export function aiApocalypse() {
  ...
  let srace =
    ...
    !["junker", "sludge", "ultra_sludge"].includes(god)
      ? god
...
function trackWomling() {
  ...
  if (
    global.stats.womling.friend.l > 0 &&
    global.stats.womling.lord.l > 0 &&
    global.stats.womling.god.l > 0
  ) {
