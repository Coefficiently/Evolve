...
export const arpaProjects = {
  lhc: {
    title() {
      return eventActive("fool", 2022)
        ? loc("arpa_projects_railway_title")
        : loc("arpa_projects_lhc_title");
    },
    desc() {
      return eventActive("fool", 2022)
        ? loc("arpa_projects_railway_desc")
        : loc("arpa_projects_lhc_desc");
    },
    reqs: { high_tech: 6 },
    grant: "supercollider",
    effect(nofool) {
      ...
      if (global.tech["storage"] >= 6) {
        if (global.tech["particles"] && global.tech["particles"] >= 4) {
          return global.race["cataclysm"]
            ? loc("arpa_projects_lhc_cataclysm3", [sc])
            : loc("arpa_projects_lhc_effect3", [
                sc,
                global.race["orbit_decayed"]
                  ? loc("space_home_satellite_title")
                  : wardenLabel(),
              ]);
        } else {
          return global.race["cataclysm"]
            ? loc("arpa_projects_lhc_cataclysm2", [sc])
            : loc("arpa_projects_lhc_effect2", [
                sc,
                global.race["orbit_decayed"]
                  ? loc("space_home_satellite_title")
                  : wardenLabel(),
        ...
        return global.race["cataclysm"]
          ? loc("arpa_projects_lhc_cataclysm1", [sc])
          : global.tech["isolation"]
          ? loc("arpa_projects_lhc_iso1", [
              sc,
              loc("tech_infectious_disease_lab_alt"),
            ])
          : loc("arpa_projects_lhc_effect1", [
              sc,
              global.race["orbit_decayed"]
                ? loc("space_home_satellite_title")
                : wardenLabel(),
    ...
    cost: {
      Money(offset, wiki) {
        return costMultiplier("lhc", offset, 2500000, 1.05, wiki);
      },
      Knowledge(offset, wiki) {
        return costMultiplier("lhc", offset, 500000, 1.05, wiki);
      },
      Copper(offset, wiki) {
        return costMultiplier("lhc", offset, 125000, 1.05, wiki);
      },
      Cement(offset, wiki) {
        return costMultiplier("lhc", offset, 250000, 1.05, wiki);
      },
      Aluminium(offset, wiki) {
        return costMultiplier("lhc", offset, 350000, 1.05, wiki);
      },
      Titanium(offset, wiki) {
        return costMultiplier("lhc", offset, 50000, 1.05, wiki);
      },
      Polymer(offset, wiki) {
        return costMultiplier("lhc", offset, 12000, 1.05, wiki);
      },
    },
  },
  stock_exchange: {
      ...
      if (global.tech["banking"] >= 10) {
        if (global.race["cataclysm"]) {
          return global.tech["gambling"] && global.tech["gambling"] >= 4
            ? loc("arpa_projects_stock_exchange_cataclysm2", [
            ...
            : loc("arpa_projects_stock_exchange_cataclysm1", [
                loc("space_red_spaceport_title"),
                10,
              ]);
        } else {
          return global.tech["gambling"] && global.tech["gambling"] >= 4
            ? loc("arpa_projects_stock_exchange_effect3", [
                loc("city_bank"),
                10,
                loc(`job_banker`),
                2,
            ...
            : loc("arpa_projects_stock_exchange_effect2", [
                loc("city_bank"),
                10,
                loc(`job_banker`),
                2,
    ...
    cost: {
      Money(offset, wiki) {
        return costMultiplier("stock_exchange", offset, 3000000, 1.06, wiki);
      },
      Plywood(offset, wiki) {
        return costMultiplier("stock_exchange", offset, 25000, 1.06, wiki);
      },
      Brick(offset, wiki) {
        return costMultiplier("stock_exchange", offset, 20000, 1.06, wiki);
      },
      Wrought_Iron(offset, wiki) {
        return costMultiplier("stock_exchange", offset, 10000, 1.06, wiki);
      },
    },
  },
  tp_depot: {
    ...
    effect() {
      return loc(
        global.tech["isolation"]
          ? "arpa_projects_depot_effect_iso"
          : "arpa_projects_depot_effect",
        [5, 50]
      );
    },
    cost: {
      Money(offset, wiki) {
        return costMultiplier("tp_depot", offset, 1800000, 1.08, wiki);
      },
      Stone(offset, wiki) {
        return costMultiplier("tp_depot", offset, 750000, 1.08, wiki);
      },
      Iron(offset, wiki) {
        return costMultiplier("tp_depot", offset, 250000, 1.08, wiki);
      },
      Alloy(offset, wiki) {
        return costMultiplier("tp_depot", offset, 30000, 1.08, wiki);
      },
    },
  },
  launch_facility: {
    ...
    reqs: { high_tech: 7 },
    condition() {
      return global.race["cataclysm"] || global.race["lone_survivor"]
        ? false
        : true;
    },
    ...
    cost: {
      Money(offset) {
        return costMultiplier("launch_facility", offset, 2000000, 1.1);
      },
      Knowledge(offset) {
        return costMultiplier("launch_facility", offset, 500000, 1.1);
      },
      Cement(offset) {
        return costMultiplier("launch_facility", offset, 150000, 1.1);
      },
      Oil(offset) {
        return costMultiplier("launch_facility", offset, 20000, 1.1);
      },
      Sheet_Metal(offset) {
        return costMultiplier("launch_facility", offset, 15000, 1.1);
      },
      Alloy(offset) {
        return costMultiplier("launch_facility", offset, 25000, 1.1);
      },
    },
  },
  monument: {
  ...
  railway: {
    ...
    effect(nofool) {
      ...
      let routes =
        global.stats.achieve["banana"] && global.stats.achieve.banana.l >= 2
          ? 1
          : 0;
      let profit =
      ...
      if (global.tech["hell_lake"] && global.tech.hell_lake >= 7) {
        desc += ` ${loc("arpa_projects_railway_highway", [
          1,
    ...
    cost: {
      Money(offset, wiki) {
        return costMultiplier("railway", offset, 2500000, 1.08, wiki);
      },
      Lumber(offset, wiki) {
        return costMultiplier("railway", offset, 750000, 1.08, wiki);
      },
      Iron(offset, wiki) {
        return costMultiplier("railway", offset, 300000, 1.08, wiki);
      },
      Steel(offset, wiki) {
        return costMultiplier("railway", offset, 450000, 1.08, wiki);
      },
    },
  },
  roid_eject: {
    ...
    desc() {
      return loc(
        global.tech["roid_eject"] <= 10
          ? "arpa_projects_roid_eject_desc"
          : "arpa_projects_roid_eject_desc2",
        [roid_eject_type()]
      );
    },
    ...
    effect() {
      ...
      if (global.tech["roid_eject"]) {
        ...
        next =
          0.225 *
            (global.tech["roid_eject"] + 1) *
            (1 + (global.tech["roid_eject"] + 1) / 12) -
          mass;
      }
      return `<div>${loc("arpa_projects_roid_eject_effect1")}</div><div>${loc(
        "arpa_projects_roid_eject_effect2",
        [+mass.toFixed(3), +next.toFixed(3), roid_eject_type()]
      )}</div>`;
    },
    cost: {
      Money(offset, wiki) {
        return costMultiplier("roid_eject", offset, 18750000, 1.075, wiki);
      },
      Deuterium(offset, wiki) {
        return costMultiplier("roid_eject", offset, 375000, 1.075, wiki);
      },
      Bolognium(offset, wiki) {
        return costMultiplier("roid_eject", offset, 15000, 1.075, wiki);
      },
    },
  },
  nexus: {
    ...
    effect() {
      if (global.tech["roguemagic"] && global.tech.roguemagic >= 7) {
        return `<div>${loc("arpa_projects_nexus_effect1", [5])}</div><div>${loc(
          "witch_hunter_nexus",
          [8]
        )}</div>`;
      }
    ...
    cost: {
      Money(offset, wiki) {
        return costMultiplier("nexus", offset, 5000000, 1.12, wiki);
      },
      Crystal(offset, wiki) {
        return costMultiplier("nexus", offset, 60000, 1.12, wiki);
      },
      Iridium(offset, wiki) {
        return costMultiplier("nexus", offset, 35000, 1.12, wiki);
      },
    },
  },
  syphon: {
    ...
    desc() {
      ...
      if (global.tech["syphon"] && global.tech.syphon >= 0) {
        desc = `<div>${loc(
          ...
          "arpa_syphon_desc_warn2"
        )}</div>`;
      } else {
        desc = `<div>${loc(
          "arpa_syphon_desc"
        )}</div><div class="has-text-danger">${loc(
          "arpa_syphon_desc_warn1"
        )}</div>`;
      }
      if (global.race["witch_hunter"]) {
        desc += `<div class="has-text-caution">${loc(
          `witch_hunter_suspicion`
        )}</div>`;
      }
      return desc;
    },
    ...
    effect() {
      ...
      if (global.tech["syphon"] && global.tech.syphon >= 60) {
        ...
        return `<div>${loc("arpa_syphon_effect_main", [
          mana,
        ])}</div><div class="has-text-caution">${loc(
          "arpa_syphon_effect4"
        )}</div><div class="has-text-advanced">${loc(
          "arpa_syphon_effect_reward",
          [gains.plasmid, gains.phage, gains.dark, plasmidType, 80]
        )}</div>`;
    ...
    cost: {
      Money(offset, wiki) {
        return costMultiplier("syphon", offset, 7500000, 1.025, wiki);
      },
      Mana(offset, wiki) {
        return costMultiplier("syphon", offset, 5000, 1.025, wiki);
      },
      Crystal(offset, wiki) {
        return costMultiplier("syphon", offset, 100000, 1.025, wiki);
      },
      Infernite(offset, wiki) {
        return costMultiplier("syphon", offset, 10000, 1.025, wiki);
      },
    },
  },
};
...
export const bloodPool = {
  ...
  lust: {
    ...
    effect() {
      return `<span class="has-text-caution">${loc(
        "arpa_blood_repeat"
      )}</span>`;
    },
    action() {
  ...
  illuminate: {
    ...
    cost: {
      ...
      Artifact(wiki) {
        return ((wiki || 0) + (global.blood["illuminate"] || 0)) % 5 === 0
          ? 1
          : 0;
      },
    },
...
export function checkGeneRequirements(gene) {
  ...
  Object.keys(actions.genes[gene].reqs).forEach(function (req) {
    if (
      !global.genes[req] ||
      global.genes[req] < actions.genes[gene].reqs[req]
    ) {
      isMet = false;
    }
  });
  if (
    ...
    (!global.genes[actions.genes[gene].grant[0]] ||
      global.genes[actions.genes[gene].grant[0]] < actions.genes[gene].grant[1])
  ) {
    return true;
  }
  return false;
...
export function checkBloodRequirements(trait) {
  ...
  Object.keys(actions.blood[trait].reqs).forEach(function (req) {
    if (
      !global.blood[req] ||
      global.blood[req] < actions.blood[trait].reqs[req]
    ) {
      isMet = false;
    }
  });
  if (
    isMet &&
    (!global.blood[actions.blood[trait].grant[0]] ||
      actions.blood[trait].grant[1] === "*" ||
      global.blood[actions.blood[trait].grant[0]] <
        actions.blood[trait].grant[1])
  ) {
    return true;
...
function monument_costs(res, offset, wiki) {
  ...
  switch (type) {
    case "Obelisk":
      return res === "Stone"
        ? costMultiplier("monument", offset, 1000000, 1.1, wiki)
        : 0;
    case "Statue":
      return res === "Aluminium"
        ? costMultiplier("monument", offset, 350000, 1.1, wiki)
        : 0;
    case "Sculpture":
      return res === "Steel"
        ? costMultiplier("monument", offset, 300000, 1.1, wiki)
        : 0;
    case "Monolith":
      return res === "Cement"
        ? costMultiplier("monument", offset, 300000, 1.1, wiki)
    ...
    case "Megalith":
      return res === "Crystal"
        ? costMultiplier("monument", offset, 55000, 1.1, wiki)
        : 0;
  }
}
...
function checkRequirements(tech) {
  ...
  if (
    arpaProjects[tech].hasOwnProperty("path") &&
    !arpaProjects[tech].path.includes(c_path)
  ) {
    return false;
  }
  var isMet = true;
...
function costMultiplier(project, offset, base, multiplier, wiki) {
  ...
  if (
    ((wiki && wiki.creative) || (!wiki && global.race["creative"])) &&
    project !== "syphon"
  ) {
...
function genetics() {
  ...
  if (global.tech["genetics"] > 1) {
    ...
    let label =
      global.tech.genetics > 2
        ...
        : loc("arpa_sequence_genome");
    if (global.race["artifical"]) {
      label =
        global.tech.genetics > 2
          ? loc("arpa_code_modification")
          : loc("arpa_decompile_source");
    }
    let sequence = $(
      `<div><span class="seqlbl has-text-warning">${label}</span> - ${loc(
        "arpa_to_complete"
      )} <span v-html="$options.filters.timer(time)"></span></div>`
    );
    genome.append(sequence);
    let progress = $(
      `<progress class="progress" :value="progress" max="${global.arpa.sequence.max}">{{ progress }}%</progress>`
    );
    genome.append(progress);
    let b_label =
      global.tech.genetics > 2 ? loc("arpa_mutate") : loc("arpa_sequence");
    if (global.race["artifical"]) {
      b_label =
        global.tech.genetics > 2 ? loc("arpa_modify") : loc("arpa_decompile");
    }
    let button = $(
      `<button class="button seq" @click="toggle">${b_label}</button>`
    );
    genome.append(button);

    if (global.tech["genetics"] >= 5) {
      let boost = $(
        `<b-tooltip :label="boostLabel(false)" position="is-bottom" animated multilined><button class="button boost" @click="booster" :aria-label="boostLabel(true)">${loc(
          "arpa_boost"
        )}</button></b-tooltip>`
      );
      genome.append(boost);
    ...
    if (global.tech["genetics"] >= 6) {
      let boost = $(
        `<b-tooltip :label="novoLabel()" position="is-bottom" animated multilined><button class="button" @click="novo" :aria-label="novoLabel()">${loc(
          global.race["artifical"] ? "arpa_novo_artifical" : "arpa_novo"
        )}</button></b-tooltip>`
      );
      genome.append(boost);
    }
    ...
    if (global.tech["genetics"] >= 7) {
      let boost = $(
        `<b-tooltip :label="autoLabel(false)" position="is-bottom" animated multilined><button class="button auto" @click="auto_seq" :aria-label="autoLabel(true)">${loc(
          global.race["artifical"] ? "arpa_auto_compile" : "arpa_auto_sequence"
        )}</button></b-tooltip>`
      );
      genome.append(boost);
    }
          ...
          return (
            loc(
              global.race["artifical"]
                ? "arpa_boost_artifical_label"
                : "arpa_boost_label"
            ) +
            (sr
              ? global.arpa.sequence.boost
                ? loc("city_on")
                : loc("city_off")
              : "")
          );
      ...
      function () {
        if (global.tech.genetics > 2) {
          return global.race["artifical"]
            ? loc("arpa_modify_desc")
            : loc("arpa_mutate_desc");
        } else {
          return global.race["artifical"]
            ? loc("arpa_decompile_desc")
            : loc("arpa_sequence_desc");
        }
      },
      {
  ...
  if (global.tech["genetics"] > 2) {
    let breakdown = $(
      '<div id="geneticBreakdown" class="geneticTraits"></div>'
    );
    ...
    global.settings.mtorder.forEach(function (trait) {
      if (
        (traits[trait] && traits[trait].type === "minor") ||
        trait === "mastery" ||
        trait === "fortify"
      ) {
        if (
          trait !== "fortify" ||
          (global.tech["decay"] && global.tech["decay"] >= 2)
        ) {
          if (
            (![
              "promiscuous",
    ...
    breakdown.append(
      `<div class="trait major has-text-success">${loc(
        "arpa_race_genetic_traids",
        [flib("name")]
      )}</div>`
    );
    ...
    Object.keys(trait_listing).forEach(function (trait) {
      if (
        traits[trait] &&
        traits[trait].type !== "minor" &&
        traits[trait].type !== "special" &&
        trait !== "evil" &&
        trait !== "soul_eater" &&
        trait !== "artifical"
      ) {
        let readOnly = false;
        if (
          (global.race["ss_traits"] && global.race.ss_traits.includes(trait)) ||
          (global.race["iTraits"] && global.race.iTraits.hasOwnProperty(trait))
        ) {
          readOnly = true;
        } else if (
          ["sludge", "ultra_sludge"].includes(global.race.species) &&
          (trait === "ooze" || global.race["modified"])
        ) {
          readOnly = true;
        ...
        if (
          !readOnly &&
          ((traits[trait].type === "major" && global.genes["mutation"]) ||
            (traits[trait].type === "genus" &&
              global.genes["mutation"] &&
              global.genes["mutation"] >= 2))
        ) {
          let major = $(`<div class="traitRow"></div>`);
          let purge = $(
            `<span class="remove${trait} basic-button has-text-danger" role="button" :aria-label="removeCost('${trait}')" @click="purge('${trait}')">${loc(
              "arpa_remove_button"
            )}</span>`
          );
          ...
          major.append(
            $(
              `<span class="trait has-text-warning" id="raceTrait${trait}">${
                traitName[trait] ? traitName[trait] : traits[trait].name
              } (${loc(`arpa_genepool_rank`, [traitRank(trait)])})</span>`
            )
          );
          ...
          traitListing.append(
            `<div class="traitRow trait${trait}"><div class="trait has-text-warning${
              global.genes["mutation"] ? " indent" : ""
            }">${
              traitName[trait] ? traitName[trait] : traits[trait].name
            } (${loc(`arpa_genepool_rank`, [traitRank(trait)])})</div></div>`
          );
        }
      }
    });
      ...
      if (
        ...
        Object.keys(races).forEach(function (race) {
          if (
            ...
            race !== "ultra_sludge" &&
            race !== "custom" &&
            (speciesTypes.includes(races[race].type) ||
              (races[race].type === "hybrid" && race === global.race.species))
          ) {
            Object.keys(races[race].traits).forEach(function (trait) {
              if (!global.race[trait] && trait !== "soul_eater") {
                ...
                if (conflict_pos === -1) {
                  ...
                  if (
                    races[race].type !== mainType &&
                    race !== global.race.species
                  ) {
        ...
        for (let i = 0; i < trait_list.length; i++) {
          ...
          let major = $(`<div class="traitRow"></div>`);
          let add = $(
            `<span class="add${trait} basic-button has-text-success" role="button" :aria-label="addCost('${trait}')" @click="gain('${trait}')">${loc(
              "arpa_gain_button"
            )}</span>`
          );
          ...
          major.append(
            $(
              `<span class="trait has-text-warning" id="raceTrait${trait}">${
                traitName[trait] ? traitName[trait] : traits[trait].name
              } (${loc(`arpa_genepool_rank`, [
                offspec_traits[trait] ? 0.5 : 1,
              ])})</span>`
            )
          );
    ...
    if (minor) {
      breakdown.prepend(
        `<div class="trait minor has-text-success">${loc(
          "arpa_race_genetic_minor_traits",
          [flib("name")]
        )}</div>`
      );
    }
    ...
    let rmCost = function (t) {
      ...
      if (
        ["custom", "hybrid", "sludge", "ultra_sludge"].includes(
          global.race.species
        )
      ) {
        cost *= 10;
    ...
    let mGeneCost = function (t) {
      ...
      return loc("arpa_gene_buy", [
        traitSkin("name", t),
        sizeApproximation(cost),
        global.resource.Genes.name,
      ]);
    };

    let mPhageCost = function (t) {
      let cost = fibonacci(
        global.genes.minor[t] ? global.genes.minor[t] + 4 : 4
      );
      if (t === "mastery") {
        cost *= 2;
      }
      return loc("arpa_phage_buy", [
        traitSkin("name", t),
        sizeApproximation(cost),
      ...
      methods: {
        gene(t) {
          ...
          while (curr_iteration < iterations && can_purchase) {
            let cost = fibonacci(
              global.race.minor[t] ? global.race.minor[t] + 4 : 4
            );
            if (t === "mastery") {
              cost *= 5;
            }
        ...
        phage(t) {
          ...
          while (curr_iteration < iterations && can_purchase) {
            ...
            if (global.prestige.Phage.count >= cost) {
              ...
              global.genes.minor[t]
                ? global.genes.minor[t]++
                : (global.genes.minor[t] = 1);
              global.race[t] ? global.race[t]++ : (global.race[t] = 1);
              redraw = true;
            } else {
              can_purchase = false;
      ...
      popover(
        ...
        function () {
          if (
            ...
            return `<div>${traitSkin("desc", t)}</div><div>${loc(
              `trait_${t}_effect`
            )}</div>`;
          } else {
...
function bindTrait(breakdown, trait) {
  ...
  let gene = $(
    `<span v-bind:class="['basic-button', 'gene', 'gbuy', genePurchasable('${trait}') ? '' : 'has-text-fade']" role="button" :aria-label="geneCost('${trait}')" @click="gene('${trait}')">${
      global.resource.Genes.name
    } (${global.race.minor[trait] || 0})</span>`
  );
  m_trait.append(gene);
  if (global.prestige.Phage.count > 0) {
    let phage = $(
      `<span v-bind:class="['basic-button', 'gene', 'pbuy', phagePurchasable('${trait}') ? '' : 'has-text-fade']" role="button" :aria-label="phageCost('${trait}')" @click="phage('${trait}')">${loc(
        "resource_Phage_name"
      )} (${global.genes.minor[trait] || 0})</span>`
    );
  ...
  m_trait.append(
    `<span class="has-text-warning name">${total}${traitSkin(
      "name",
      trait
    )}</span>`
  );
...
function crispr() {
  if (
    (global.tech["genetics"] && global.tech["genetics"] > 3) ||
    global["sim"]
  ) {
    clearElement($("#arpaCrispr"));
    $("#arpaCrispr").append(
      `<div class="has-text-warning">${loc("arpa_crispr_desc")}</div>`
    );
...
function blood() {
  if (global.tech["b_stone"] && global.tech["b_stone"] >= 2) {
    ...
    $("#arpaBlood").append(
      `<div class="has-text-warning">${loc("arpa_blood_desc")}</div>`
    );
...
function addProject(parent, project) {
  if (checkRequirements(project)) {
    ...
    if (
      arpaProjects[project]["rank"] &&
      global.arpa[project].rank >= arpaProjects[project].rank
    ) {
      return;
    }
    ...
    let title =
      typeof arpaProjects[project].title === "string"
        ? arpaProjects[project].title
        : arpaProjects[project].title();
    let head = $(
      `<div class="head"><span aria-hidden="true" class="desc has-text-warning">${title}</span><a v-on:click="srDesc" class="is-sr-only">${title}</a><span aria-hidden="true" v-show="rank" class="rank">{{ rank | level }}</span><a v-on:click="srLevel" class="is-sr-only">{{ rank | level }}</a></div>`
    );
    current.append(head);

    let progress = $(
      `<div class="pbar"><progress class="progress" :value="complete" max="100"></progress><span class="progress-value has-text-danger">{{ complete }}%</span></div>`
    );
    ...
    buy.append(
      $(
        `<button aria-label="${loc(
          "queue"
        )} ${project}" class="button" @click="queue('${project}')">${loc(
          "queue"
        )}</button>`
      )
    );
    buy.append(
      $(
        `<button :aria-label="arpaProjectSRCosts('1','${project}')" class="button x1" @click="build('${project}',1)">1%</button>`
      )
    );
    buy.append(
      $(
        `<button :aria-label="arpaProjectSRCosts('10','${project}')" class="button x10" @click="build('${project}',10)">10%</button>`
      )
    );
    buy.append(
      $(
        `<button :aria-label="arpaProjectSRCosts('25','${project}')" class="button x25" @click="build('${project}',25)">25%</button>`
      )
    );
    buy.append(
      $(
        `<button :aria-label="arpaProjectSRCosts('100','${project}')" class="button x100" @click="build('${project}',100)">{{ complete | remain }}%</button>`
      )
    );
    ...
    vBind({
      ...
      methods: {
        queue(pro) {
          if (global.tech["queue"]) {
            ...
            for (let i = 0; i < keyMult; i++) {
              let arpaId = `arpa${pro}`;
              let used = 0;
              let buid_max = arpaProjects[pro]["queue_complete"]
                ? arpaProjects[pro].queue_complete()
              ...
              if (used < global.queue.max && buid_max > 0) {
                if (
                  global.settings.q_merge !== "merge_never" &&
                  ...
                  let title =
                    typeof arpaProjects[pro].title === "string"
                      ? arpaProjects[pro].title
                      : arpaProjects[pro].title();
        ...
        srDesc() {
          return srSpeak(
            typeof arpaProjects[project].desc === "string"
              ? arpaProjects[project].desc
              : arpaProjects[project].desc()
          );
        },
        srLevel() {
        ...
        arpaProjectSRCosts(id, project) {
          ...
          Object.keys(costs).forEach(function (res) {
            ...
            if (res_cost > 0) {
              var label =
                res === "Money" ? "$" : global.resource[res].name + ": ";
              var afford =
                global.resource[res].amount >= res_cost
                  ? ""
                  : ` ${loc("insufficient")} ${global.resource[res].name}.`;
              cost =
                cost + ` ${label} ${sizeApproximation(res_cost, 2)}.${afford}`;
            }
          });
          return cost;
        },
    ...
    if (payArpaCosts(arpaProjects[pro].cost)) {
      ...
      if (global.arpa[pro].complete >= 100) {
        ...
        if (pro === "launch_facility") {
          ...
          renderSpace();
          messageQueue(
            loc("arpa_projects_launch_facility_msg"),
            "info",
            false,
            ["progress"]
          );
...
export function arpaProjectCosts(id, project) {
  ...
  Object.keys(costs).forEach(function (res) {
    ...
    if (res_cost > 0) {
      ...
      cost.append(
        $(
          `<div class="${color}" data-${res}="${res_cost}">${label}${sizeApproximation(
            res_cost,
            2
          )}</div>`
        )
